...
import { C as BrowserTabNotFoundError, V as DEFAULT_BROWSER_DOWNLOAD_TIMEOUT_MS, Z as withNoProxyForCdpUrl, c as isWebSocketUrl, d as scopeCdpPolicyToConfiguredEndpoint, f as withCdpSocket, i as fetchJson, l as normalizeCdpHttpBaseForJsonEndpoints, n as assertCdpEndpointAllowed, o as getHeadersWithAuth, t as appendCdpPath } from "./cdp.helpers-B9jipAGQ.js";
import { a as DEFAULT_DOWNLOAD_DIR, l as resolveStrictExistingUploadPaths, o as DEFAULT_TRACE_DIR } from "./config-DpWXcVmn.js";
import "./tmp-openclaw-dir-DRHs_iAK.js";
import "./errors-BSZ3n2MU.js";
import { c as getRoleSnapshotStats, i as planAnnotations, l as parseRoleRef, m as normalizeBrowserEvaluateFunctionSource, n as buildOverlayClearScript, o as buildRoleSnapshotFromAiSnapshot, p as matchBrowserUrlPattern, r as buildOverlayInjectionScript, s as buildRoleSnapshotFromAriaSnapshot, t as appendSnapshotUrls } from "./snapshot-urls-CSy_q5ul.js";
import { C as assertBrowserNavigationRedirectChainAllowed, E as withBrowserNavigationPolicy, S as assertBrowserNavigationAllowed, f as formatAriaSnapshot, l as AX_REF_PATTERN, p as normalizeCdpWsUrl, t as getChromeWebSocketUrl, w as assertBrowserNavigationResultAllowed, x as InvalidBrowserNavigationUrlError, y as ensureOutputDirectory } from "./chrome-DDq_K3xu.js";
...
function actionNeedsStandaloneDownloadGrace(action, ssrfPolicy) {
	switch (action.kind) {
		case "close":
		case "resize":
		...
		case "batch": return action.actions.some((nested) => actionNeedsStandaloneDownloadGrace(nested, ssrfPolicy));
		default: return !ssrfPolicy;
	}
}
...
async function executeActViaPlaywright(opts) {
	...
	const downloadGraceMs = actionNeedsStandaloneDownloadGrace(opts.action, opts.ssrfPolicy) ? INTERACTION_NAVIGATION_GRACE_MS : 0;
	const drainDownloads = async () => await downloadCapture.drain({
	...
	try {
		...
		if (isPolicyDenyNavigationError(failure)) await quarantineBlockedNavigationTarget({
			cdpUrl: opts.cdpUrl,
			page,
			targetId: opts.targetId
		});
