...
import { i as redactSecrets, p as isSecretValueRegisteredForRedaction } from "./redact-B9QQ4Wyz.js";
import { i as asOptionalRecord, o as isRecord, r as asOptionalObjectRecord } from "./record-coerce-DHZ4bFlT.js";
import { A as consumeRootOptionToken } from "./argv-APLDYHWW.js";
...
import { t as writeSiblingTempFile } from "./sibling-temp-B46XkYIp.js";
import { t as assertNoSymlinkParents } from "./symlink-parents-D3bl9xr3.js";
import { i as readRegularFileSync, t as appendRegularFile } from "./regular-file-CuvhUtZS.js";
import { m as resolveUserPath } from "./utils-CRO4LGEB.js";
import { n as VERSION } from "./version-CeFj_iGk.js";
import { u as readResponseWithLimit } from "./http-body-CHWaxK2e.js";
import { E as getActiveDiagnosticTraceContext, S as createDiagnosticTraceContext, T as freezeDiagnosticTraceContext, j as runWithDiagnosticTraceContext, o as emitTrustedDiagnosticEvent, s as emitTrustedDiagnosticEventWithPrivateData, x as createChildDiagnosticTraceContext } from "./diagnostic-events-JZsXee1S.js";
...
import { a as isSubagentSessionKey, r as isCronRunSessionKey } from "./session-key-utils-A-JGvyXu.js";
...
import { n as ensureGlobalUndiciDispatcherStreamTimeouts, r as ensureGlobalUndiciEnvProxyDispatcher, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-DeobtFo9.js";
import "./defaults-mDjiWzE5.js";
import { M as hasTopLevelShellControlOperator, N as splitShellArgs } from "./shell-wrapper-resolution-Cy6xKD1y.js";
import "./config-DbyjySSE.js";
import { a as createStreamIteratorWrapper, i as wrapStreamFnTextTransforms } from "./text-transforms.runtime-Dihiya_w.js";
import { p as resolveProviderRefOwnership } from "./providers-y2Lns8fh.js";
import { i as listRegisteredAgentHarnesses, r as getRegisteredAgentHarness } from "./registry-DtLZ3rba.js";
import { w as listRegisteredPluginAgentPromptGuidance } from "./command-registration-tKF3dsKu.js";
import { c as getActivePluginRegistry, m as listImportedRuntimePluginIds } from "./runtime-D0xGMZdc.js";
import { a as emitAgentApprovalEvent, c as emitAgentEvent, l as emitAgentItemEvent, s as emitAgentCommandOutputEvent, u as emitAgentPatchSummaryEvent } from "./agent-events-CRggPZCM.js";
import { s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-BmIrGlLG.js";
import { a as getReplyPayloadMetadata, h as setReplyPayloadMetadata } from "./reply-payload-BK_jICQ3.js";
...
import { Z as resolveQuotaSuspensionEntryMaintenance, et as parseSessionThreadInfoFast } from "./store-BJJhlPrk.js";
import { d as resolveStorePath } from "./paths-C2C4lJH6.js";
import { a as resolveSessionLockMaxHoldFromTimeout, s as resolveSessionWriteLockOptions, t as acquireSessionWriteLock } from "./session-write-lock-BZ_4P1vk.js";
...
import { a as resolveTrajectoryPointerFilePath, i as resolveTrajectoryFilePath, n as TRAJECTORY_RUNTIME_EVENT_MAX_BYTES, o as resolveTrajectoryPointerOpenFlags, r as TRAJECTORY_RUNTIME_FILE_MAX_BYTES } from "./paths-B4qcz6gV.js";
...
import { W as updateSessionEntry, _ as listSessionEntries, rt as isTranscriptOnlyOpenClawAssistantMessage$1, y as loadSessionEntry } from "./session-accessor-D7yi6P1i.js";
import { a as withOwnedSessionTranscriptWrites, d as serializeJsonlLine, m as writeJsonlLines, t as bindOwnedSessionTranscriptWrites } from "./transcript-write-context-CoTZvex2.js";
import { d as resolveProviderRuntimePluginHandle } from "./provider-hook-runtime-yfrzDCD-.js";
import { M as resolveProviderSystemPromptContribution, N as resolveProviderTextTransforms, W as transformProviderSystemPrompt } from "./provider-runtime-CLQOjLJ6.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-ClnBK9_9.js";
...
import { d as stripHistoricalRuntimeContextCustomMessages, u as relocateCurrentRuntimeContextCarrierToTail } from "./internal-runtime-context-BW7WOTKc.js";
import { a as sanitizeToolCallIdsForCloudCodeAssist, r as extractToolResultIds, t as extractToolCallsFromAssistant } from "./tool-call-id-CtDzcfGi.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing } from "./session-transcript-repair-BUFGXxrq.js";
import { a as buildGuardedModelFetch, i as streamSimple } from "./stream-BcRkg2P0.js";
import { i as resolveSecretSentinel, n as looksLikeSecretSentinel, r as mintSecretSentinel } from "./sentinel-zNFsFsCB.js";
...
import { o as createAgentSession, tt as wrapToolDefinition } from "./sessions-D8qGY7uC.js";
import { I as BRANCH_SUMMARY_PREFIX, L as BRANCH_SUMMARY_SUFFIX, R as COMPACTION_SUMMARY_PREFIX, V as bashExecutionToText, z as COMPACTION_SUMMARY_SUFFIX } from "./proxy-BzhBz8iM.js";
import { t as event_stream_exports } from "./event-stream-MHM-_qcK.js";
import { l as invalidateSessionFileRepairCache, t as SessionManager, u as repairSessionFileIfNeeded } from "./session-manager-BC-U4J87.js";
import { t as detectRuntimeShell } from "./shell-utils-D5xjUWUG.js";
...
import { T as parseExecApprovalResultText, f as coerceChatContentText, p as extractTextFromChatContent } from "./sanitize-user-facing-text-D-sR-1VY.js";
import { i as classifyFailoverReason, m as isCloudCodeAssistFormatError, u as formatUserFacingAssistantErrorText } from "./errors-XbAR6hS3.js";
import { c as mergeAlsoAllowPolicy, d as couldNormalizeToolNamePrefixToAllowedTool, f as expandToolGroups, m as normalizeToolName, p as normalizeToolList } from "./tool-policy-BHUGxE3p.js";
...
import { I as extractStandalonePlainTextToolCallText, L as promoteStandalonePlainTextToolCallMessage, N as streamWithPayloadPatch, R as normalizePlainTextToolCallStreamEvents, z as scrubOverCapPlainTextToolCallMessage } from "./provider-stream-shared-B4Hm1tKd.js";
import { r as stripInboundMetadata } from "./strip-inbound-meta-DMvJPx9F.js";
import { d as hasOrphanReasoningCloseBoundary, p as findFinalTagMatches, s as stripDowngradedToolCallText } from "./assistant-visible-text-oprKkPEf.js";
import { c as isSignalTimeoutReason } from "./failover-error-B2zFYEnG.js";
import { i as createAgentRunRestartAbortError, n as AGENT_RUN_RESTART_ABORT_STOP_REASON, s as isAgentRunRestartAbortReason } from "./run-termination-DjANsN9j.js";
import { U as isTerminalTaskStatus } from "./task-registry-Cws4vLl0.js";
import { i as listTasksForOwnerOrRequesterSessionKeyForStatus, t as findTaskByRunIdForStatus } from "./task-status-access-BN8QpAb1.js";
...
import { C as updateActiveEmbeddedRunSnapshot, E as resolveEmbeddedSessionFileKey, S as updateActiveEmbeddedRunSessionFile, p as markActiveEmbeddedRunAbandoned, r as clearActiveEmbeddedRun, x as setActiveEmbeddedRun } from "./runs-B0SQhu92.js";
...
import { a as parseAssistantTextSignature, s as resolveAssistantMessagePhase, t as extractAssistantTextForPhase } from "./chat-message-content-CeBHi_A4.js";
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, o as normalizeUsage, t as deriveContextPromptTokens } from "./usage-BJjt0RVM.js";
...
import { a as compareHarnessSupport, i as buildAgentHarnessSupportContext } from "./thinking-runtime-rftFo2fO.js";
import { a as getOrCreateSessionMcpRuntime } from "./agent-bundle-mcp-runtime--G82BMQs.js";
import { i as getPluginToolMeta } from "./tools-V54L2wjJ.js";
import { r as materializeBundleMcpToolsForRun } from "./agent-bundle-mcp-materialize-D9l-gQ5S.js";
...
import { a as finalizeHarnessContextEngineTurn, c as runContextEngineMaintenance, d as runAgentEndSideEffects, f as buildContextEngineRuntimeSettings, n as bootstrapHarnessContextEngine, t as assembleHarnessContextEngine } from "./context-engine-lifecycle-Bv52xohg.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-oFdXQWLa.js";
import { n as normalizeGoogleApiBaseUrl } from "./google-api-base-url-UBNiBOzj.js";
import { i as resolveGroupToolPolicy } from "./agent-tools.policy-YD9HuYgO.js";
import { t as resolveConversationCapabilityProfile } from "./conversation-capability-profile-1DyyogtK.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-B3_LYAnc.js";
import { o as normalizeHeartbeatToolResponse } from "./heartbeat-tool-response-DeOnAqhX.js";
import { t as filterHeartbeatTranscriptArtifacts } from "./heartbeat-filter-D5izsPiV.js";
import { r as diagnosticErrorMessage, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-yrw7ASmg.js";
import { n as resolveDiagnosticModelContentCapturePolicy } from "./diagnostic-llm-content-CU_-DTjY.js";
import { C as consumeStructuredReplaySafeToolCall, O as isEmbeddedMode, S as consumePreExecutionBlockedToolCall, h as CODE_MODE_WAIT_TOOL_NAME, l as recordStructuredReplayTrustForToolCall, m as CODE_MODE_EXEC_TOOL_NAME, x as consumeAdjustedParamsForToolCall } from "./agent-tools.before-tool-call-C95DXQXZ.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-DTfvdWN-.js";
import { t as getMachineDisplayName } from "./machine-name-DaF-eeRE.js";
import { n as resolveRuntimeOsLabel, t as resolveOsSummary } from "./os-summary-CVk_nSu8.js";
import { _ as supportsModelTools, d as mergeTransportHeaders, h as hasOnlyAssistantReasoningContent, p as sanitizeTransportPayloadText } from "./openai-transport-stream-B0WkSqXp.js";
import { t as log$2 } from "./logger-rC_P-huq.js";
import { u as createCodexNativeWebSearchWrapper } from "./proxy-ndumgUwZ.js";
import { n as buildAgentHookContextIdentityFields, t as buildAgentHookContextChannelFields } from "./hook-agent-context-DPPRzCBU.js";
import { s as resolveSkillsPromptForRun } from "./workspace-BgZV1_od.js";
import { i as resolveEmbeddedRunSkillEntries, n as mapSandboxSkillUsagePaths, r as resolveSandboxSkillRuntimeInputs, t as mapSandboxSkillEntriesForPrompt } from "./sandbox-skills-Cc765-ge.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-K88qrVfF.js";
import { n as redactConfigObject } from "./redact-snapshot-C_BFfSrJ.js";
import { t as resolveCommitHash } from "./git-commit-5O2wyffX.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-CoIT5wwp.js";
import { t as sanitizeDiagnosticPayload } from "./payload-redaction-BU7N7gsY.js";
import { t as safeJsonStringify } from "./safe-json-CY5cd4H1.js";
import { t as isReasoningTagProvider } from "./provider-utils-BuEi1iF_.js";
import { t as createBundleLspToolRuntime } from "./agent-bundle-lsp-runtime-BHqxGSMJ.js";
import { B as stripStaleAssistantUsageBeforeLatestCompaction, C as buildEmbeddedMessageActionDiscoveryInput, E as buildEmbeddedExtensionFactories, G as wrapAnthropicStreamWithRecovery, H as dropReasoningFromHistory, I as isCacheTtlEligibleProvider, J as createPreparedEmbeddedAgentSettingsManager, K as isZeroUsageEmptyStopAssistantTurn, L as readLastCacheTtlTimestamp, M as rotateTranscriptAfterCompaction, P as shouldRotateCompactionTranscript, R as logRuntimeToolSchemaQuarantine, S as validateReplayTurns, T as limitHistoryTurns, U as dropThinkingBlocks, V as assessLastAssistantMessage, W as stripThinkingBlocksFromMessage, _ as prewarmSessionFile, b as normalizeAssistantReplayContent, c as collectCoreBuiltinToolNames, d as applySystemPromptToSession, f as buildEmbeddedSystemPrompt, g as resolveEmbeddedAgentStreamFn, h as resolveEmbeddedAgentBaseStreamFn, i as mapThinkingLevelForProvider, l as collectRegisteredToolNames, m as resolveEmbeddedAgentApiKey, n as flushPendingToolResultsAfterIdle, o as AGENT_RESERVED_TOOL_NAMES, p as describeEmbeddedAgentStreamStrategy, q as consumeEmbeddedToolSendReceipt, r as mapThinkingLevel, s as collectAllowedToolNames, t as wrapStreamFnWithDiagnosticModelCallEvents, u as toSessionToolAllowlist, v as trackSessionManagerAccess, w as getHistoryLimitFromSessionKey, x as sanitizeSessionHistory, y as createEmbeddedAgentResourceLoader, z as guardSessionManager } from "./attempt.model-diagnostic-events-CfZQM0hs.js";
import { a as resolveEffectiveCompactionMode, i as isSilentOverflowProneModel, n as applyAgentAutoCompactionGuard, r as applyAgentCompactionSettingsFromConfig } from "./agent-settings-axYuScuh.js";
import { d as listChannelSupportedActions, f as resolveChannelMessageToolHints, g as getChannelAgentToolMeta, m as resolveChannelReactionGuidance, w as REQUIRED_PARAM_GROUPS } from "./gateway-CvsJ0gY0.js";
import { n as isToolResultError, r as readToolResultDetails } from "./tool-result-error-Bz7hBpM1.js";
import { a as toClientToolDefinitions, n as createClientToolNameConflictError, o as toToolDefinitions, r as findClientToolNameConflicts, t as splitSdkTools } from "./tool-split-BONVLU1k.js";
import { n as resolveProcessToolScopeKey, t as createOpenClawCodingTools } from "./agent-tools-BD8WL7ny.js";
import { f as isStrictAgenticSupportedProviderModel, p as stripProviderPrefix } from "./openclaw-tools-KulZ1cdH.js";
import { C as isLocalModelLeanEnabled, S as filterLocalModelLeanTools, T as shouldCatalogToolForLocalModelLean, _ as projectToolSearchTargetTranscriptMessages, b as resolveToolSearchConfig, d as buildToolSchemaDirectoryPrompt, f as clearToolSearchCatalog, g as estimateToolSchemaDirectoryToolNames, i as TOOL_SEARCH_RAW_TOOL_NAME, l as applyToolSchemaDirectoryCatalog, m as createToolSearchCatalogRef, n as TOOL_DESCRIBE_RAW_TOOL_NAME, p as collectUniqueCatalogToolNames, r as TOOL_SEARCH_CODE_MODE_TOOL_NAME, s as addClientToolsToToolSearchCatalog, t as TOOL_CALL_RAW_TOOL_NAME, u as applyToolSearchCatalog, w as resolveLocalModelLeanPreserveToolNames, x as applyLocalModelLeanToolSearchDefaults, y as resolveToolSearchCatalogTool } from "./tool-search-B8B4Spes.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-CmS_1rXy.js";
import { c as resolveMainSessionAlias, s as resolveInternalSessionKey } from "./sessions-helpers-CsMNowOZ.js";
import { n as replaceWithEffectiveCronCreatorToolAllowlist } from "./cron-tool-C9qaFGtt.js";
import { m as mediaUrlsFromGeneratedAttachments } from "./subagent-announce-origin-DPSebzOW.js";
import { t as sanitizeForPromptLiteral } from "./sanitize-for-prompt-DSJzLJDI.js";
import { a as hasCommittedMessagingToolDeliveryEvidence, c as hasMessagingToolDeliveryEvidence, m as normalizeAcceptedSessionSpawnResult, p as hasAcceptedSessionSpawn } from "./delivery-evidence-Du4oIHR6.js";
import { a as hasReplyPayloadContent } from "./payload-C0zJd_02.js";
import { b as resolveBootstrapTotalMaxChars, d as normalizeOpenAIResponsesToolCallIds, l as downgradeOpenAIFunctionCallReasoningPairs, n as validateAnthropicTurns, o as isMessagingToolDuplicateNormalized, r as validateGeminiTurns, s as normalizeTextForComparison, u as downgradeOpenAIReasoningBlocks, v as resolveBootstrapMaxChars, y as resolveBootstrapPromptTruncationWarningMode } from "./embedded-agent-helpers-DZZ4Y-Tw.js";
...
import { d as buildTextObservationFields, f as shouldSuppressRawErrorConsoleSuffix, g as abortable, m as MissingAgentHarnessError, u as buildApiErrorObservationFields } from "./model-fallback-BPQMpbqN.js";
import { a as extractAssistantVisibleText, d as promoteThinkingTagsToBlocks, f as sanitizeAssistantVisibleStreamText, i as extractAssistantThinking, l as inferToolMetaFromArgs, n as extractAssistantCommentaryText, o as extractThinkingFromTaggedStream, r as extractAssistantText, s as extractThinkingFromTaggedText, t as THINKING_TAG_SCAN_RE, u as isAssistantMessage } from "./embedded-agent-utils-CjKqpAOm.js";
import { o as parseInteractiveParam, s as parseJsonMessageParam } from "./message-action-dispatch-CZZYL7XG.js";
import { t as registerProviderStreamForModel } from "./provider-stream-CqSx37Uy.js";
import { S as prependAgentSteeringPrompt, g as releasePendingAgentSteeringItems, t as ackPendingAgentSteeringItems, u as leasePendingAgentSteeringItems } from "./subagent-registry-DexSZ4w1.js";
import { n as buildSubagentList } from "./subagent-list-DS5VECFa.js";
import { a as listControlledSubagentRuns } from "./subagent-control-CXT-voKm.js";
import { o as resolveSandboxContext } from "./sandbox-DtTssSMH.js";
import { r as listActiveProcessSessionReferences } from "./compaction-runtime-context--DEAWi6X.js";
...
import { i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-CUlAj8PH.js";
...
import { i as resolveCodeModeConfig, n as applyCodeModeCatalog, r as createCodeModeTools, t as addClientToolsToCodeModeCatalog } from "./code-mode-D5mNEiYV.js";
...
import { a as isMessagingToolSendAction, o as isMessagingToolTargetEvidenceAction, r as isMessagingTool } from "./embedded-agent-messaging-AJZX3UxO.js";
import { t as collectTextContentBlocks } from "./content-blocks-DRK0dze4.js";
import { a as extractMessagingToolSendResult, c as extractToolErrorMessage, d as filterToolResultMediaUrls, h as sanitizeToolResult, i as extractMessagingToolSend, l as extractToolResultMediaArtifact, m as sanitizeToolArgs, n as collectMessagingMediaUrlsFromRecord, o as extractMessagingToolSourceReplyPayload, p as isToolResultTimedOut, r as collectMessagingMediaUrlsFromToolResult, s as extractToolErrorCode, t as buildToolLifecycleErrorResult, u as extractToolResultText$1 } from "./embedded-agent-subscribe.tools-CfJXhZwg.js";
...
import { a as isSameToolMutationAction, t as buildToolMutationState } from "./tool-mutation-BfXv6cQw.js";
import { t as EmbeddedBlockChunker } from "./embedded-agent-block-chunker-C6r0hPGr.js";
import { i as runAgentHarnessBeforeAgentFinalizeHook } from "./lifecycle-hook-helpers-BwL6869q.js";
import { i as resolveAgentPromptSurfaceForSessionKey, n as appendModelIdentitySystemPrompt, r as buildModelIdentityPromptLine } from "./system-prompt-config-DmMYFhnb.js";
...
import { n as normalizeAgentRuntimeTools, t as logAgentRuntimeToolDiagnostics } from "./tools-CNtLHh2f.js";
import { a as resolveLiveToolResultAggregateMaxChars, c as truncateOversizedToolResultsInMessages, f as formatContextLimitTruncationNotice, o as resolveLiveToolResultMaxChars, u as truncateOversizedToolResultsInSessionManager } from "./tool-result-truncation-rzMcqvvu.js";
import { n as rewriteTranscriptEntriesInSessionManager } from "./transcript-rewrite-BHL7q_3D.js";
import { t as buildSystemPromptParams } from "./system-prompt-params-CGngRDsr.js";
import { a as estimateLlmBoundaryTokenPressure, c as shouldPreemptivelyCompactBeforePrompt, i as buildPrePromptContextBudgetStatus, l as collectReplaySafeToolNames, n as runAgentCleanupStep, o as estimateRenderedLlmBoundaryTokenPressure, r as PREEMPTIVE_OVERFLOW_ERROR_TEXT, s as formatPrePromptPrecheckLog, t as buildEmbeddedAttemptToolRunContext, u as isAgentToolReplaySafe } from "./attempt.tool-run-context-CuQsIXnb.js";
import { c as shouldAllowProviderOwnedThinkingReplay, s as resolveTranscriptPolicy } from "./tool-result-middleware-D2HOtSKh.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-cce1g0up.js";
...
import { r as resolveEmbeddedSandboxInfoExecPolicy, t as buildEmbeddedSandboxInfo } from "./sandbox-info-DMlJwv6b.js";
...
import { a as shouldCreateBundleMcpRuntimeForAttempt, i as shouldCreateBundleLspRuntimeForAttempt, n as mergeForcedEmbeddedAttemptToolsAllow, r as resolveEmbeddedAttemptToolConstructionPlan, t as applyEmbeddedAttemptToolsAllow } from "./attempt-tool-construction-plan-B_ioY5W5.js";
import { n as formatZonedTimestamp } from "./format-datetime-DO2rqkXr.js";
import "./tool-loop-detection-QRwz_WH8.js";
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-3p-FPxbh.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-cZHIw6Jd.js";
import { t as detectAndLoadPromptImages } from "./images-N3-JCBA2.js";
...
* telemetry.
*/
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-C3pcOjUm.js"));
...
async function handleToolExecutionEnd(ctx, evt) {
	...
	if (isToolError) {
		...
		const validationErrorSummary = evt.executionStarted === false && evt.errorKind === "argument-validation" ? createToolValidationErrorSummary(toolName) : void 0;
...
function handleMessageUpdate(ctx, evt) {
	...
	if (deliveryPhase === "commentary") {
		const commentaryText = chunk ? void 0 : coerceChatContentText(extractAssistantCommentaryText(partialAssistant));
...
function handleMessageEnd(ctx, evt) {
	...
	if (suppressVisibleAssistantOutput) {
		...
		if (commentaryText) ctx.emitAssistantStreamData(buildAssistantStreamData({
			text: commentaryText,
			replace: true,
			phase: "commentary"
		}));
...
function subscribeEmbeddedAgentSession(params) {
	...
	const emitReasoningStream = (text) => {
		...
		if (state.streamReasoning && !hasMessageToolOnlySourceDelivery() && params.onReasoningStream) params.onReasoningStream({
			text: trimmed,
...
*/
async function steerAndWaitForTranscriptCommit(activeSession, text, timeoutMs, userTurnTranscriptRecorder) {
	await new Promise((resolve, reject) => {
		let settled = false;
		let terminalTimer;
		const finish = (err) => {
		...
		(userTurnTranscriptRecorder ? activeSession.steer(text, void 0, userTurnTranscriptRecorder) : activeSession.steer(text)).catch((err) => {
			finish(err);
		});
	});
}
...
async function steerActiveSessionWithOptionalDeliveryWait(activeSession, text, options) {
	if (options?.waitForTranscriptCommit !== true) {
		if (options?.userTurnTranscriptRecorder) await activeSession.steer(text, void 0, options.userTurnTranscriptRecorder);
		else await activeSession.steer(text);
		return;
	}
	await steerAndWaitForTranscriptCommit(activeSession, text, options.deliveryTimeoutMs ?? DEFAULT_QUEUE_TRANSCRIPT_COMMIT_TIMEOUT_MS, options.userTurnTranscriptRecorder);
}
//#endregion
...
function decodeHtmlEntities(value) {
	const decodeNumericEntity = (raw, radix) => {
		...
		return Number.isInteger(codePoint) && codePoint >= 0 && codePoint <= 1114111 && (codePoint < 55296 || codePoint > 57343) ? String.fromCodePoint(codePoint) : `&#${radix === 16 ? "x" : ""}${raw};`;
	};
...
const STANDALONE_TEXT_TOOL_CALL_PROMOTION_STOP_REASONS = /* @__PURE__ */ new Set(["stop"]);
const STANDALONE_TEXT_TOOL_CALL_SCRUB_STOP_REASONS = /* @__PURE__ */ new Set(["stop", "length"]);
...
function buildUsageAgentMetaFields(params) {
	...
	return {
		usage,
		lastCallUsage: hasNonzeroUsage(lastAssistantUsage) ? lastAssistantUsage : hasNonzeroUsage(params.lastRunPromptUsage) ? params.lastRunPromptUsage : toLastCallUsage(params.usageAccumulator),
...
function resolveLlmFirstEventTimeoutMs(params) {
	...
	const modelRequestTimeoutMs = params?.modelRequestTimeoutMs;
	if (typeof modelRequestTimeoutMs === "number" && Number.isFinite(modelRequestTimeoutMs) && modelRequestTimeoutMs > 0) return clampTimeoutMs(Math.min(modelRequestTimeoutMs, ...timeoutBounds));
	return clampTimeoutMs(Math.min(isLocalRuntimeModel || isExplicitLocalHostnameRuntimeModel || isSelfHostedHostnameRuntimeModel ? LOCAL_LLM_FIRST_EVENT_TIMEOUT_MS : CLOUD_LLM_FIRST_EVENT_TIMEOUT_MS, ...timeoutBounds));
}
/**
...
const aggregateToolResultPressureWarnings = /* @__PURE__ */ new Set();
	...
	try {
		...
		const toolsRaw = !shouldConstructTools ? [] : (() => {
			const allTools = createOpenClawCodingTools({
				...
				...params.replyOperation ? { hasCurrentInboundAudio: () => params.currentInboundAudio === true || params.replyOperation?.acceptedSteeredInboundAudio === true } : {},
		...
		const shouldProbeContinuationSkip = !isRawModelRun && contextInjectionMode === "continuation-skip" && !isHeartbeatLifecycleRunKind(params.bootstrapContextRunKind) && await hasCompletedBootstrapTurnForAttempt(params.sessionFile);
		...
		const promptContributionTrigger = params.bootstrapContextRunKind === "commitment-only" ? void 0 : params.trigger;
		...
		try {
			...
			if (providerTextTransforms?.input?.length) activeSession.agent.streamFn = wrapStreamFnTextTransforms({
			...
			applyExtraParamsToAgent(activeSession.agent, params.config, params.provider, params.modelId, streamExtraParamsOverride, providerThinkingLevel, sessionAgentId, effectiveWorkspace, params.model, agentDir, resolvedTransport, {
			...
			if (providerTextTransforms?.output?.length) activeSession.agent.streamFn = wrapStreamFnTextTransforms({
				streamFn: activeSession.agent.streamFn,
			...
			try {
				...
				if (activeContextEngine) try {
					...
					const contextEngineAssembleReserveTokens = Math.max(0, Math.floor(settingsManager.getCompactionReserveTokens()));
					const contextEngineAssembleContextTokenBudget = Math.max(1, Math.floor(params.contextTokenBudget ?? params.model.contextWindow ?? params.model.maxTokens ?? 2e5));
					const contextEngineAssemblePromptBudget = Math.max(1, contextEngineAssembleContextTokenBudget - contextEngineAssembleReserveTokens);
					const contextEngineAssembleRenderedPromptTokens = estimateRenderedLlmBoundaryTokenPressure({
						systemPrompt: systemPromptText,
						prompt: params.prompt ?? ""
					});
					const contextEngineAssembleMessageBudget = Math.max(1, contextEngineAssemblePromptBudget - contextEngineAssembleRenderedPromptTokens);
			...
			try {
				...
				if (params.sessionKey && !isRawModelRun && params.bootstrapContextRunKind !== "commitment-only") {
				...
				try {
					...
					const promptToolResultTruncation = truncateOversizedToolResultsInMessages(activeSession.messages, contextTokenBudget, promptToolResultMaxChars, promptToolResultAggregateMaxChars, cloneToolResultPromptProjectionState(toolResultPromptProjectionState));
					const promptHistoryChanged = promptToolResultTruncation.messages !== activeSession.messages;
					...
					const promptSubmission = resolveRuntimeContextPromptParts({
						...
						modelPromptBuildContext: hasPromptBuildContext && effectiveTranscriptPrompt !== void 0 ? {
					...
					const currentInboundContextText = isRuntimeOnlyTurn ? void 0 : params.currentInboundContext?.text?.trim() || void 0;
					...
					const runtimeContextForHook = isRuntimeOnlyTurn ? void 0 : [currentInboundContextText, promptSubmission.runtimeContext?.trim()].filter((value) => Boolean(value)).join("\n\n") || void 0;
					...
					const shouldSkipPrecheck = skipPromptSubmission || contextEngineAssemblySucceeded && activeContextEngine?.info.ownsCompaction && contextEnginePromptAuthority !== "preassembly_may_overflow";
					if (shouldSkipPrecheck && !skipPromptSubmission) log$2.info(`[context-overflow-precheck] skipped: context engine "${activeContextEngine.info.id}" owns compaction`);
					...
					if (!skipPromptSubmission) {
						...
						const installProviderPromptHistoryTransform = () => {
							...
							const providerPromptStreamFn = wrapStreamFnWithMessageTransform(baseStreamFn, (messages) => {
								...
								if (recorder && hasSessionUserTurnBeenSent(sessionPromptState, recorder.message) !== false) recorder.markSentToProvider?.();
								return providerMessages;
							});
				...
				try {
					if (onBlockReplyFlush) {
						...
						await onBlockReplyFlush({
							...
							attemptAccepted: !promptError && !aborted && !timedOut && !yieldAborted && currentAssistant?.stopReason === "stop"
						});
					}
				...
				await withOwnedSessionWriteLock(async () => {
					...
					if (timedOutDuringCompaction) {
						...
						if (removedEntries > 0 && !isProbeSession) log$2.warn(`normalized compaction timeout transcript tail: removedEntries=${removedEntries} runId=${params.runId} sessionId=${params.sessionId}`);
					}
					...
					if (activeContextEngine && !beforeAgentFinalizeRevisionReason) flushSessionManagerFile(activeSessionManager);
				});
...
//#endregion
export { EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE as A, resolveRunLivenessState as B, resolveReportedModelRef as C, mergeUsageIntoAccumulator as D, createUsageAccumulator as E, resolveAttemptReplayMetadata as F, createEmbeddedRunReplayState as G, shouldRetryMissingAssistantTurn as H, resolveEmptyResponseRetryInstruction as I, observeReplayMetadata as K, resolveIncompleteTurnPayloadText as L, formatEmbeddedRunStageSummary as M, shouldWarnEmbeddedRunStageSummary as N, injectTimestamp as O, hasAttemptTerminalState as P, resolveReasoningOnlyRetryInstruction as R, resolveRateLimitProfileRotationLimit as S, scrubAnthropicRefusalMagic as T, shouldRetrySilentErrorAssistantTurn as U, resolveSilentToolResultReplyPayload as V, shouldTreatEmptyAssistantReplyAsSilent as W, resolveLatestCallUsage as _, runAgentHarnessAttempt as a, resolveOverloadFailoverBackoffMs as b, RUNTIME_AUTH_REFRESH_MIN_DELAY_MS as c, buildUsageAgentMetaFields as d, createCompactionDiagId as f, resolveFinalAssistantVisibleText as g, resolveFinalAssistantRawText as h, resolvePluginHarnessPolicyToolsAllow as i, createEmbeddedRunStageTracker as j, timestampOptsFromConfig as k, RUNTIME_AUTH_REFRESH_RETRY_MS as l, resolveActiveErrorContext as m, agentHarnessExposesOpenClawTools as n, selectAgentHarness as o, isAssistantForModelRef as p, createTrajectoryRuntimeRecorder as q, resolveAvailableAgentHarnessPolicy as r, RUNTIME_AUTH_REFRESH_MARGIN_MS as s, agentHarnessBuildsOpenClawTools as t, buildErrorAgentMeta as u, resolveMaxRunRetryIterations as v, resolveSameModelRateLimitRetryDelayMs as w, resolveOverloadProfileRotationLimit as x, resolveNextSameModelRateLimitRetryCount as y, resolveReplayInvalidFlag as z };
