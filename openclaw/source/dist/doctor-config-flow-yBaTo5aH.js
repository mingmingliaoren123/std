...
import { t as CONFIG_PATH } from "./paths-BMBAvkNf.js";
import { t as formatCliCommand } from "./command-format-H_Arqann.js";
import { c as isRecord$1 } from "./utils-CRO4LGEB.js";
import { h as parseLegacySecretRefEnvMarker, i as LEGACY_SECRETREF_ENV_MARKER_PREFIX } from "./types.secrets-OocW4TQ1.js";
...
import { i as setPathExistingStrict } from "./path-utils-CvA6hCf7.js";
import { n as discoverConfigSecretTargets } from "./target-registry-CXQ2ov4X.js";
import { z as resolveNormalizedProviderModelMaxTokens } from "./io-By0s-a_s.js";
import { d as collectConfiguredModelRefs } from "./gateway-startup-speech-providers-tDMeTcRJ.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-BIKs-96s.js";
import { r as getBundledChannelPlugin, s as hasBundledChannelPackageSetupFeature } from "./bundled-ClxzUaje.js";
import { n as formatConfigIssueLines } from "./issue-format-fzg0yJxc.js";
import { r as normalizeTalkSection } from "./talk-CIVZmHe8.js";
import { c as callGateway } from "./call-Bj6Erfmh.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-C5GsPAV1.js";
...
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-B6uOMJG0.js";
import { a as legacyRuntimeModelAliasRequiresRuntimePolicy, i as migrateLegacyXSearchConfig, o as listLegacyRuntimeModelProviderAliases, r as migrateLegacyWebSearchConfig, s as migrateLegacyRuntimeModelRef } from "./legacy-config-migrations--PhUdsg4.js";
import { c as mergeMissing, r as isLegacyModelsAddCodexMetadataModel } from "./legacy-config-migrations.runtime.models-Cb7Zufjp.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-GfJGfTQs.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-BKxjSKdd.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-ByAn6Wxa.js";
...
function seedMissingDefaultAccountsFromSingleAccountBase(cfg, changes) {
	...
	for (const [channelId, rawChannel] of Object.entries(channels)) {
		...
		if (inheritedPolicyKeys.length > 0) for (const [accountId, rawAccount] of Object.entries(rawAccounts)) {
			if (!isRecord$1(rawAccount)) continue;
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-B6hAFy56.js");
	...
	const { collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-DrV_jgRM.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-IFftPDvh.js");
	...
	const { repairHooksTokenReuseGatewayAuth } = await import("./hooks-token-reuse-repair-DvLlUR1e.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-CKEoK0eu.js");
		...
		const { collectDoctorPreviewNotes } = await import("./preview-warnings-DmRxAWjg.js");
