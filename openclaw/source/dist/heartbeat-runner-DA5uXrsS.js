...
import { D as resolveIntegerOption, P as timestampMsToIsoString } from "./number-coercion-CJQ8TR--.js";
import { i as formatErrorMessage, o as hasErrnoCode } from "./errors-sMD712F3.js";
...
import { S as loadSessionStore, v as updateSessionStore } from "./store-BJJhlPrk.js";
import { d as resolveStorePath } from "./paths-C2C4lJH6.js";
import { t as getChannelPlugin } from "./registry-CCU9J1Ai.js";
import { t as normalizeChatType } from "./chat-type-BARlA53h.js";
import "./plugins-CWbO0qGI.js";
import { i as applySessionEntryLifecycleMutation } from "./session-accessor-D7yi6P1i.js";
...
import { r as DEFAULT_HEARTBEAT_FILENAME } from "./workspace-DkQ7irPD.js";
import { a as isRetryableHeartbeatBusySkipReason, i as areHeartbeatsEnabled, n as HEARTBEAT_SKIP_LANES_BUSY, o as requestHeartbeat, r as HEARTBEAT_SKIP_REQUESTS_IN_FLIGHT, s as setHeartbeatWakeHandler, t as HEARTBEAT_SKIP_CRON_IN_PROGRESS } from "./heartbeat-wake-DibZKDF_.js";
import { f as resolveSystemEventDeliveryContext, l as peekSystemEventEntries, t as consumeSelectedSystemEventEntries } from "./system-events-BfmWSF2P.js";
import { A as replyRunRegistry, O as listActiveReplyRunSessionKeys, p as listActiveEmbeddedRunSessionKeys } from "./run-state-BteeOQT8.js";
...
import { c as getCommandLaneSnapshots, l as getQueueSize } from "./command-queue-DqzpsN4m.js";
import { a as getHeartbeatToolNotificationText, s as resolveHeartbeatToolResponseFromReplyResult } from "./heartbeat-tool-response-DeOnAqhX.js";
import { c as parseHeartbeatTasks, d as stripHeartbeatToken, l as resolveHeartbeatPrompt$1, o as isHeartbeatContentEffectivelyEmpty, s as isTaskDue, u as resolveHeartbeatPromptForResponseTool } from "./heartbeat-Butmf3AR.js";
import { n as resolveHeartbeatIntervalMs, t as isHeartbeatEnabledForAgent } from "./heartbeat-summary-DTfvdWN-.js";
...
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent, u as isReasoningReplyPayload } from "./reply-payload-C3J477-H.js";
import { t as sendDurableMessageBatch } from "./send-CwUe7TNf.js";
import "./runtime-CkzezCbc.js";
import { n as resolveHeartbeatDeliveryTargetWithSessionRoute, r as resolveHeartbeatSenderContext } from "./targets-BZzHMxJ5.js";
...
import { n as resolveCronSession } from "./session-unZCiGt9.js";
...
import { n as listDueCommitmentSessionKeys, o as markCommitmentsAttempted, r as listDueCommitmentsForSession, s as markCommitmentsStatus } from "./store-aWOQg0VH.js";
import { a as isRelayableExecCompletionEvent, i as isExecCompletionEvent, n as buildExecEventPrompt, r as isCronSystemEvent, t as buildCronEventPrompt } from "./heartbeat-events-filter-ByAn4Uce.js";
...
async function runHeartbeatOnce(opts) {
	...
	const clearSatisfiedPendingFinalDelivery = async () => {
		await updateSessionStore(storePath, (store) => {
			...
			if (current?.pendingFinalDelivery !== true && !current?.pendingFinalDeliveryText) return false;
			if (!heartbeatRunOwnsPendingFinalDelivery(current, startedAt)) return false;
			store[sessionKey] = {
				...current,
...
const testing = { truncateHeartbeatPreview };
