...
import "./accounts-C-ZPmqpb.js";
import "./runtime-api-Ci6bRByD.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-C5KVPMKV.js";
import { t as sendMessageZalo } from "./send-BA-SkdT-.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-Dx70Q1Um.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-ETuRoqFV.js");
