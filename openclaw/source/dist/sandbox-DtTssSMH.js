...
import { f as isSameSsrFPolicy } from "./ssrf-BayeDjCv.js";
import { c as splitSandboxBindSpec, s as resolveSandboxHostPathViaExistingAncestor } from "./network-mode-IZZOKBNF.js";
import "./config-DbyjySSE.js";
import { a as resolveSandboxPath, i as resolveSandboxInputPath } from "./sandbox-paths-BM7tDEKD.js";
import { c as DEFAULT_USER_FILENAME, d as ensureAgentWorkspace, i as DEFAULT_IDENTITY_FILENAME, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-DkQ7irPD.js";
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT, x as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, y as SANDBOX_BROWSER_IMAGE_CONTRACT_EPOCH } from "./constants-5yTHqBiK.js";
import { n as isToolAllowed } from "./tool-policy-Bx6D7Inl.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-Dy4vED5-.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BRnZ3ffr.js";
import "./sanitize-env-vars-CequRb6L.js";
...
import { a as DEFAULT_OPENCLAW_BROWSER_COLOR, d as ensureBrowserControlAuth, f as resolveBrowserControlAuth, l as resolveBrowserConfig, n as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, s as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as resolveProfile } from "./browser-profiles-C5D6O6Wc.js";
import { A as updateRegistry, D as removeBrowserRegistryEntry, E as readRegistry, O as removeRegistryEntry, S as resolveReadOnlyWorkspaceSkillMounts, T as readBrowserRegistry, _ as appendReadOnlyWorkspaceSkillMountArgs, a as execDocker, c as isDockerDaemonUnavailable, d as readDockerPort, f as resolveDockerEnvPolicyEpoch, g as slugifySessionKey, h as resolveSandboxWorkspaceLayoutPaths, j as computeSandboxBrowserConfigHash, k as updateBrowserRegistry, l as readDockerContainerEnvVar, m as resolveSandboxAgentId, n as dockerContainerState, s as formatDockerDaemonUnavailableError, t as buildSandboxCreateArgs, u as readDockerContainerLabel, v as appendWorkspaceMountArgs, y as formatReadOnlyWorkspaceSkillMountHashState } from "./docker-Hq4HIYYD.js";
import { n as validateNetworkMode } from "./validate-sandbox-security-DQe7hw6K.js";
import { A as dockerSandboxBackendManager, D as buildPinnedRemovePlan, E as buildPinnedMkdirpPlan, O as buildPinnedRenamePlan, S as parseSandboxStatSize, a as getSandboxBackendManager, c as requireSandboxBackendFactory, j as runDockerSandboxShellCommand, k as buildPinnedWritePlan, n as startBrowserBridgeServer, o as getSandboxBackendWorkdirResolver, r as stopBrowserBridgeServer, t as BROWSER_BRIDGES, x as parseSandboxStatMtimeMs } from "./browser-bridges-DdlAaIG3.js";
...
async function syncSandboxSkillsToWorkspace(params) {
	try {
		const [{ syncSkillsToWorkspace }, { getRemoteSkillEligibility }, { canExecRequestNode }] = await Promise.all([
			import("./workspace-CUPwB-16.js"),
			import("./remote-zVeM1Y-k.js"),
			import("./exec-defaults-CUNyJvmD.js")
		]);
...
async function resolveSandboxContext(params) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-CPRBOo-N.js")).maybePruneSandboxes(cfg);
...
//#endregion
export { ensureSandboxWorkspaceForSession as a, hasSandboxBindContainerPathAliases as c, removeSandboxContainer as i, hasSandboxBindReadonlyHostShadows as l, listSandboxContainers as n, resolveSandboxContext as o, removeSandboxBrowserContainer as r, buildSandboxFsMounts as s, listSandboxBrowsers as t, resolveWritableSandboxBindHostRoots as u };
