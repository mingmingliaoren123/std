...
import { u as pathExists$1 } from "./utils-CRO4LGEB.js";
import { i as resolveGatewayInstallEntrypoint } from "./gateway-entrypoint-AW9TlIzZ.js";
import { s as parseSemver } from "./runtime-guard-CcN7oTJc.js";
import { t as movePathWithCopyFallback } from "./replace-file-CaPU6XwS.js";
...
import { a as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-kBlcxcew.js";
import { a as channelToNpmTag, c as isStableTag, n as DEV_BRANCH, r as EXTENDED_STABLE_TAG_UNSUPPORTED_REASON, s as isBetaTag } from "./update-channels-CIHQjIuI.js";
import { n as readPackageName, r as readPackageVersion } from "./package-json-D62iRsOj.js";
import { c as detectPackageManager, n as compareSemverStrings, o as resolveExtendedStablePackage } from "./update-check-BZM1fqQO.js";
import { t as PACKAGE_POST_INSTALL_DOCTOR_ADVISORY } from "./update-doctor-result-BDmbyXXJ.js";
...
const OMITTED_PRIVATE_QA_BUNDLED_PLUGIN_ROOTS = /* @__PURE__ */ new Set([
...
async function resolveGlobalInstallTarget(params) {
	...
	const targetGlobalRoot = (command.manager === "bun" ? bunPackageRootGlobalRoot : null) ?? pkgRootGlobalRoot ?? (command.manager === "npm" ? honoredPackageRootGlobalRoot : null) ?? npmPackageRootGlobalRoot ?? globalRoot;
	return {
		...command,
		globalRoot: targetGlobalRoot,
		packageRoot: targetGlobalRoot ? resolvePackageRootFromGlobalRoot({
			globalRoot: targetGlobalRoot,
...
function resolveUpdateDoctorExecutionPolicy(params) {
	...
	const externalPolicySupport = compareSemverStrings(params.targetVersion, EXTERNAL_SERVICE_REPAIR_POLICY_MIN_VERSION);
...
//#endregion
export { runGlobalPackageUpdateSteps as a, createGlobalInstallEnv as c, globalInstallArgs as d, resolveGlobalInstallSpec as f, normalizePackageTagInput as h, markPackagePostInstallDoctorAdvisory as i, detectGlobalInstallManagerByPresence as l, resolvePnpmGlobalDirFromGlobalRoot as m, resolveUpdateInstallSurface as n, canResolveRegistryVersionForPackageTarget as o, resolveGlobalInstallTarget as p, runGatewayUpdate as r, cleanupGlobalRenameDirs as s, resolveUpdateDoctorExecutionPolicy as t, detectGlobalInstallManagerForRoot as u };
