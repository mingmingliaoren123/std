...
import { m as redactRegisteredSecretValues } from "./redact-B9QQ4Wyz.js";
...
import { d as runSqliteImmediateTransactionSync, f as resolveSqliteDatabaseFilePaths, i as openOpenClawStateDatabase, m as requireNodeSqlite, p as applyPrivateModeSync } from "./openclaw-state-db-DzSsA9Ji.js";
import { r as registerSqliteCacheExitClose, t as configureSqliteConnectionPragmas } from "./sqlite-wal-Bhk2Ro-u.js";
...
function captureHttpExchange(params, resolved, deps = {}) {
	...
	const declaredLength = Number(typeof params.response.headers?.get === "function" ? params.response.headers.get("content-length") : void 0);
