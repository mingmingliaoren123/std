...
import { d as resolveGatewayPort, f as resolveIncludeRoots, s as resolveConfigPath, v as resolveStateDir } from "./paths-BMBAvkNf.js";
...
import { t as applyConfigEnvVars } from "./config-env-vars-DlUfO5Q_.js";
...
import { a as readConfigIncludeFileWithGuards, s as resolveConfigIncludes } from "./includes-wKrczBrO.js";
import { i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES } from "./client-info-CcqJJIan.js";
import "./version-CwNT1gaY.js";
import { n as loadDeviceAuthToken, t as GatewayClient } from "./client-CE2rtDfj.js";
import { r as loadOrCreateDeviceIdentity } from "./device-identity-UW4cZXf5.js";
import { t as loadGatewayTlsRuntime } from "./gateway-D7pGc7Ge.js";
...
import { a as isGatewayConnectAssemblyError } from "./src-DZzKBMa7.js";
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-BBobR8Xp.js";
import { n as resolveGatewayCredentialsWithSecretInputs } from "./credentials-secret-inputs-CEJkZi_S.js";
import { t as canSkipGatewayConfigLoad } from "./explicit-connection-policy-B7ZadC4K.js";
import { a as isGatewayMethodClassified, s as resolveLeastPrivilegeOperatorScopesForMethod, t as CLI_DEFAULT_OPERATOR_SCOPES } from "./method-scopes-CwW_Szsp.js";
...
async function readGatewayDispatchConfigWithShellEnvFallback(options = {}) {
	...
	const { loadShellEnvFallback, resolveShellEnvFallbackTimeoutMs, shouldDeferShellEnvFallback, shouldEnableShellEnvFallback } = await import("./shell-env-CQbFDviS.js");
...
const defaultGetRuntimeConfig = async () => (await import("./io-CXugYKHV.js")).getRuntimeConfig();
