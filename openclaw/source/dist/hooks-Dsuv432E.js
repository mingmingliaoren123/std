...
import { i as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, l as createAuthRateLimiter, u as normalizeRateLimitClientIp } from "./auth-rate-limit-DczU2XgX.js";
...
import { a as sendJson } from "./http-common-DGvb9gWN.js";
	...
	const dispatchAgentHook = (value) => {
		...
		(async () => {
			try {
				...
				const { runCronIsolatedAgentTurn } = await import("./isolated-agent-B-dO0UDA.js");
