...
function claimAgentRunContext(runId, context, options = {}) {
	...
	if (options.trackOwner) {
		...
		if (existingOwners?.lifecycleGeneration === lifecycleGeneration) {
			...
			lifecycleGeneration,
			ownerTokens: /* @__PURE__ */ new Set([ownerToken]),
...
function enrichAgentEvent(event) {
	const state = getAgentEventState();
...
//#endregion
export { withAgentRunLifecycleGeneration as S, releaseAgentRunContext as _, emitAgentApprovalEvent as a, rotateAgentEventLifecycleGeneration as b, emitAgentEvent as c, getAgentEventLifecycleGeneration as d, getAgentRunContext as f, registerAgentRunContext as g, onAgentEvent as h, clearAgentRunContext as i, emitAgentItemEvent as l, onAgentAuditEvent as m, captureAgentRunLifecycleGeneration as n, emitAgentAuditEvent as o, listAgentRunsForSession as p, claimAgentRunContext as r, emitAgentCommandOutputEvent as s, assertAgentRunLifecycleGenerationCurrent as t, emitAgentPatchSummaryEvent as u, resetAgentEventsForTest as v, sweepStaleRunContexts as x, resetAgentRunContextForTest as y };
