...
import { d as resolveAgentModelFallbacksOverride, o as resolveAgentEffectiveModelPrimary } from "./agent-scope-B2Pk_xhT.js";
import { c as parseAgentSessionKey, n as isAcpSessionKey, r as isCronRunSessionKey } from "./session-key-utils-A-JGvyXu.js";
import { d as normalizeMainKey, u as normalizeAgentId } from "./session-key-VWT_xzM9.js";
import { c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-BxAUeF6t.js";
...
import { i as listThinkingLevelOptions, o as resolveSupportedThinkingLevel } from "./thinking-CSA4xwds.js";
import { d as resolveEffectiveResponseUsage, s as normalizeThinkLevel } from "./thinking.shared-BWnbgBUO.js";
import { d as resolveAvatarMime, i as isAvatarHttpUrl, l as isWorkspaceRelativeAvatarPath, o as isPathWithinRoot, r as isAvatarDataUrl, t as AVATAR_MAX_BYTES } from "./avatar-policy-3iKUCXyV.js";
import { n as withPinnedActivePluginRegistryWorkspaceDir } from "./runtime-workspace-state-DrrmEIfK.js";
import { _ as projectPluginSessionExtensionsSync } from "./registry-B8eQDFB4.js";
import { r as resolveAgentMainSessionKey } from "./main-session-D7Jmp9DO.js";
import { B as buildGroupDisplayName, I as getSessionStoreCacheVersion, ct as resolveSessionStoreAgentId, lt as resolveSessionStoreKey, ut as resolveStoredSessionKeyForAgentStore } from "./store-BJJhlPrk.js";
import { s as normalizeSessionDeliveryFields } from "./delivery-context.shared-3o3tBaCD.js";
...
import { C as modelSupportsInput, _ as resolveConfiguredModelRef, u as inferUniqueProviderFromConfiguredModels, x as findModelCatalogEntry } from "./model-selection-shared-iHJcI8fT.js";
...
import "./model-catalog-BfvH9gPq.js";
import { a as repairAcpSessionMetaKeyForMigration, i as readAcpSessionMetaForEntry, r as readAcpSessionMeta } from "./session-meta-e1OOAdtW.js";
import "./session-utils.fs-CR-Ydxz0.js";
import "./combined-store-gateway-C6EATQjH.js";
import { f as resolveSessionGoalDisplayState } from "./sessions-oDygYVdy.js";
import { d as readSessionTitleFieldsFromTranscriptAsync, r as readRecentSessionUsageFromTranscript, u as readSessionTitleFieldsFromTranscript } from "./session-transcript-readers-BMjfbAlq.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-5EIDxuLP.js";
import { i as lookupContextTokens, o as resolveContextTokensForModel } from "./context-_zWLdTOu.js";
...
import { A as getSubagentSessionRuntimeMs, M as resolveSubagentSessionStatus, j as getSubagentSessionStartedAt, k as shouldKeepSubagentRunChildLink } from "./subagent-registry-state-CP7kKu69.js";
import { a as isSubagentRunLive, i as getSessionDisplaySubagentRunByChildSessionKey, n as countActiveDescendantRuns, s as listSubagentRunsForController, t as buildSubagentRunReadIndex } from "./subagent-registry-read-D6cH9moi.js";
...
import { t as listGatewayAgentIds } from "./agent-list-KAcp_MAp.js";
...
function listAgentsForGateway(cfg, modelCatalog) {
	...
	return {
		...
		agents: agentIds.map((id) => {
			...
			const thinkingLevels = listThinkingLevelOptions(resolvedModel.provider, resolvedModel.model, modelCatalog, thinkingRuntime);
...
function buildGatewaySessionRow(params) {
	...
	const displayName = entry?.label ?? entry?.displayName ?? (isGroupSession && channel ? buildGroupDisplayName({
		provider: channel,
		subject,
		groupChannel,
		space,
...
function compareSessionEntryPairs(a, b) {
...
function selectNewestLimitedEntries(entries, limit) {
	...
	for (const entry of entries) {
		const insertAt = selected.findIndex((candidate) => compareSessionEntryPairs(entry, candidate) < 0);
		if (insertAt >= 0) {
...
//#endregion
export { resolveGatewaySessionStoreTargetWithStore as _, getSessionDefaults as a, resolveSessionModelIdentityRef as b, listSessionsFromStoreAsync as c, migrateAndPruneGatewaySessionStoreKey as d, pruneLegacyStoreKeys as f, resolveGatewaySessionStoreTarget as g, resolveGatewayModelSupportsImages as h, filterAndSortSessionEntries as i, loadGatewaySessionRow as l, resolveFreshestSessionEntryFromStoreKeys as m, buildGatewaySessionRow as n, listAgentsForGateway as o, resolveDeletedAgentIdFromSessionKey as p, deriveSessionTitle as r, listSessionsFromStore as s, buildGatewaySessionInfo as t, loadSessionEntry as u, resolveGatewaySessionThinkingProjection as v, resolveSessionModelRef as x, resolveSessionDisplayModelIdentityRef as y };
