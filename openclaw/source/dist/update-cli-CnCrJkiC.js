...
import { d as resolveGatewayPort, f as resolveIncludeRoots, n as DEFAULT_GATEWAY_PORT, t as CONFIG_PATH } from "./paths-BMBAvkNf.js";
...
import "./daemon-cli-BHALdvGL.js";
import { v as pathExists } from "./fs-safe-RNq3oO57.js";
import { m as resolveUserPath, u as pathExists$1 } from "./utils-CRO4LGEB.js";
import { r as resolveConfigEnvVars } from "./env-substitution-CATXLg7n.js";
...
import { a as nodeVersionSatisfiesEngine, s as parseSemver } from "./runtime-guard-CcN7oTJc.js";
import { l as writeJson } from "./json-CI_xQ2Rw.js";
import { a as readJsonIfExists } from "./json-files-Ce1pXdh3.js";
...
import { I as asResolvedSourceConfig, L as asRuntimeConfig, X as createPreUpdateConfigSnapshot, o as parseConfigJson5, p as readSourceConfigBestEffort, u as readConfigFileSnapshot } from "./io-By0s-a_s.js";
import { a as withPluginInstallRecords, o as withoutPluginInstallRecords, s as writePersistedInstalledPluginIndexInstallRecords } from "./installed-plugin-index-records-C_n191FN.js";
import { s as resolveConfigIncludes } from "./includes-wKrczBrO.js";
...
import { n as mutateConfigFileWithRetry } from "./config-DbyjySSE.js";
import { n as quoteCmdScriptArg } from "./cmd-argv-DYSpLFnE.js";
import { r as getSelfAndAncestorPidsSync } from "./restart-stale-pids-D2_NAEqM.js";
import { t as disableCurrentOpenClawUpdateLaunchdJob } from "./launchd-CnFX3Ewj.js";
...
import { c as resumeScheduledTaskAutoStartAfterUpdate, d as suspendScheduledTaskAutoStartForUpdate } from "./schtasks-CgPnYTMr.js";
import { n as runDaemonInstall } from "./install-DuSOXSoQ.js";
import { a as recoverInstalledLaunchAgent, t as runDaemonRestart } from "./lifecycle-yIOsvBfe.js";
import { a as renderRestartDiagnostics, c as waitForGatewayHealthyRestart, o as terminateStaleGatewayPids } from "./restart-health-NuCLe-Ry.js";
...
import { u as trimLogTail } from "./restart-sentinel-CEN_sCi1.js";
...
import { a as installCompletion, n as COMPLETION_SKIP_PLUGIN_COMMANDS_ENV } from "./completion-runtime-BiTWM9fd.js";
import { r as ensureCompletionCacheExists, t as checkShellCompletionStatus } from "./doctor-completion-Rjotot4C.js";
import { r as commitPluginInstallRecordsWithConfig } from "./plugins-install-record-commit-C0KU6nk2.js";
import { n as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-Cg8GOXVg.js";
import { a as channelToNpmTag, d as resolveRegistryUpdateChannel, f as resolveUpdateChannelDisplay, i as UPDATE_EFFECTIVE_CHANNEL_ENV, l as normalizeUpdateChannel, o as formatUpdateChannelLabel, r as EXTENDED_STABLE_TAG_UNSUPPORTED_REASON, u as resolveEffectiveUpdateChannel } from "./update-channels-CIHQjIuI.js";
import { t as listPersistedBundledPluginLocationBridges } from "./plugins-location-bridges-BRoG0t8h.js";
import { a as updateNpmInstalledPlugins, i as syncPluginsForUpdateChannel, t as isClawHubTrustSkippedOutcome } from "./update-DhHun9WV.js";
import { n as readPackageName, r as readPackageVersion } from "./package-json-D62iRsOj.js";
import { i as fetchNpmTagVersion, n as compareSemverStrings, o as resolveExtendedStablePackage, r as fetchNpmPackageTargetStatus, s as resolveNpmChannelTag, t as checkUpdateStatus } from "./update-check-BZM1fqQO.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-Bs-qsPmC.js";
import { a as runGlobalPackageUpdateSteps, c as createGlobalInstallEnv, d as globalInstallArgs, f as resolveGlobalInstallSpec, h as normalizePackageTagInput, i as markPackagePostInstallDoctorAdvisory, l as detectGlobalInstallManagerByPresence, m as resolvePnpmGlobalDirFromGlobalRoot, o as canResolveRegistryVersionForPackageTarget, p as resolveGlobalInstallTarget, r as runGatewayUpdate, s as cleanupGlobalRenameDirs, t as resolveUpdateDoctorExecutionPolicy, u as detectGlobalInstallManagerForRoot } from "./update-runner-C5NKm7Lc.js";
import { t as doctorCommand } from "./doctor-CZZ_7dPi.js";
import { a as UPDATE_PARENT_SUPPORTS_DOCTOR_CONFIG_WRITE_ENV, i as UPDATE_PARENT_ALLOWS_GATEWAY_SERVICE_REPAIR_ENV, o as UPDATE_PARENT_SUPPORTS_GATEWAY_RESTART_ENV, r as UPDATE_PARENT_ALLOWS_GATEWAY_ACTIVATION_ENV, t as UPDATE_DEFER_CONFIGURED_PLUGIN_INSTALL_REPAIR_ENV } from "./update-phase-DNlGDAAE.js";
...
import { i as consumeUpdatePostInstallDoctorResult, o as createUpdatePostInstallDoctorResultPath, r as UPDATE_POST_INSTALL_DOCTOR_RESULT_PATH_ENV } from "./update-doctor-result-BDmbyXXJ.js";
import { c as writeControlPlaneUpdateRestartSentinel, i as buildControlPlaneUpdateRestartHealthPendingResult, o as markControlPlaneUpdateRestartSentinelFailure, s as readControlPlaneUpdateSentinelMeta } from "./update-control-plane-sentinel-D20TCpV7.js";
...
import { a as resolveBundleInstallRecordPayload, i as hasNativePackageInstallPayload, o as validateBundleInstallRecordPayload, r as runPostCorePluginConvergence, t as convergenceWarningsToOutcomes } from "./post-core-plugin-convergence-CESuUYrC.js";
import { n as printResult, t as createUpdateProgress } from "./progress-xENEh0z7.js";
...
async function tryInstallShellCompletion(opts) {
	...
	if (status.usesSlowPattern) {
		...
		if (await ensureCompletionCacheExists(CLI_NAME, generationOptions)) await installShellCompletionForUpdate(status.shell, true);
		return;
	}
...
async function maybeRepairLegacyConfigForUpdateChannel(params) {
	...
	const { repairLegacyConfigForUpdateChannel } = await import("./legacy-config-repair-DHmvv_uK.js");
...
async function updateCommandInternal(opts, recoveryState) {
	...
	if (postCoreUpdateResume) {
		if (postCoreUpdateChannel !== "stable" && postCoreUpdateChannel !== "extended-stable" && postCoreUpdateChannel !== "beta" && postCoreUpdateChannel !== "dev") {
	...
	const stopManagedServiceBeforeMutableUpdate = async (mutationRoots = [root]) => {
		...
		try {
			...
			for (const mutationRoot of uniqueMutationRoots) {
				...
				if (preManagedServiceStop.windowsTaskAutoStartRecovery) recoveryState.windowsTaskAutoStartRecovery = preManagedServiceStop.windowsTaskAutoStartRecovery;
	...
	try {
		result = updateInstallKind === "package" ? await runPackageInstallUpdate({
			...
			installKind,
			tag,
			installSpec: packageInstallSpec ?? void 0,
			timeoutMs: updateStepTimeoutMs,
			startedAt,
			progress,
			jsonMode: Boolean(opts.json),
			allowGatewayServiceRepair: preManagedServiceStop?.serviceMatchesMutationRoot === true,
			allowGatewayActivation: shouldRestart && preManagedServiceStop?.stopped === true && preManagedServiceStop.serviceMatchesMutationRoot === true,
			...
			stop,
			devTargetRef,
			beforeGitMutation: updateInstallKind === "git" ? async () => {
		...
		try {
			...
			recoveryState.windowsTaskAutoStartRecovery?.complete();
			recoveryState.windowsTaskAutoStartRecovery = void 0;
	...
	if (result.status === "error") {
		if (!await restoreWindowsTaskAutoStartOrExit(preManagedServiceStop)) return;
		await writeControlPlaneUpdateRestartSentinelBestEffort({
	...
	if (shouldRestart) try {
		...
		const serviceOwnershipConfirmed = preManagedServiceStop?.serviceMatchesMutationRoot === true || serviceMatchesUpdateRoot === true;
		const knownForeignService = preManagedServiceStop?.serviceMatchesMutationRoot === false && serviceMatchesUpdateRoot !== true;
		skipLegacyServiceRestart = knownForeignService || resultWithPostUpdate.mode === "git" && serviceState.installed && serviceState.loaded && preManagedServiceStop?.stopped !== true && serviceMatchesUpdateRoot === false;
		if (!knownForeignService && shouldPrepareUpdatedInstallRestart({
			...
			serviceMatchesMutationRoot: serviceOwnershipConfirmed ? true : preManagedServiceStop?.serviceMatchesMutationRoot,
