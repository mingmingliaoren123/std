import { t as collectErrorGraphCandidates } from "./errors-sMD712F3.js";
import { l as registerUnhandledRejectionHandler } from "./unhandled-rejections-CXDw1wVg.js";
...
import { n as sweepTrackedBrowserTabs } from "./session-tab-registry-B1SHveNU.js";
import { i as getPwAiModule } from "./cdp-reachability-policy-BLdT5iz3.js";
import { n as listKnownProfileNames, r as getExtensionRelayModule, t as createBrowserRouteContext } from "./server-context-CHfAdCP1.js";
import { o as stopOpenClawChrome } from "./chrome-DDq_K3xu.js";
...
async function stopBrowserRuntime(params) {
	...
	try {
		...
		if (params.current.extensionRelays?.size) {
			...
			const { disposeGatewayExtensionRelay } = await import("./gateway-relay-route-C2oncSya.js");
