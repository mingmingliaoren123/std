import { p as isSecretValueRegisteredForRedaction } from "./redact-B9QQ4Wyz.js";
...
import { n as shouldDetachChildForProcessTree, r as signalChildProcessTree, t as forceKillChildProcessTree } from "./child-process-tree-10JBMlVM.js";
...
import { a as swapSecretSentinelsInText, n as looksLikeSecretSentinel, r as mintSecretSentinel } from "./sentinel-zNFsFsCB.js";
...
function protectPreparedProviderRuntimeAuth(params) {
	...
	if (!looksLikeSecretSentinel(params.sourceApiKey) && !isSecretValueRegisteredForRedaction(params.sourceApiKey)) return preparedAuth;
	const protect = (value, label) => protectRuntimeAuthValue({
		value,
...
//#endregion
export { unwrapHeaderSentinelsForProviderEgress as a, protectPreparedProviderRuntimeAuth as i, ensureModelProviderLocalService as n, unwrapModelHeaderSentinelsForProviderEgress as o, getModelProviderLocalService as r, unwrapSecretSentinelsForProviderEgress as s, attachModelProviderLocalService as t };
