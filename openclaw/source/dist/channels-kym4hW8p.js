...
import { a as getBundledChannelSetupPlugin } from "./bundled-ClxzUaje.js";
import { r as replaceConfigFile } from "./config-DbyjySSE.js";
import { c as formatUnknownChannelMessage, l as formatUnsupportedChannelActionMessage } from "./error-format-CcGxQmmN.js";
...
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-CCU9J1Ai.js";
import "./plugins-CWbO0qGI.js";
import "./message-channel-CB9y2CYk.js";
import "./logging-DBHEcFUB.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-DYcj5Btl.js";
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-9wjcXNyC.js";
import { r as resolveMessageChannelSelection } from "./channel-selection-Cwt1Az-g.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-rVe8gK8B.js";
...
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-CsYJ9GnD.js";
import { t as WizardCancelledError } from "./prompts-B0iOB1_a.js";
import { t as createClackPrompter } from "./clack-prompter-DAUcB50S.js";
import { t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit-C0KU6nk2.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-VlGtsFrm.js";
import { n as resolveLogFile } from "./log-tail-D7TizVcP.js";
...
import { t as applyAgentBindings } from "./agents.bindings-CuKZZ2hw.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-DFLSmL5n.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-CdT6aHkk.js";
import { t as channelsListCommand } from "./list-CuyLBnJE.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-C6B9x3W8.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-CT3fcJAd.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-mYCHCgs9.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-YnVO5Xpt.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-D6pOdng0.js").then(({ listRawChannelPluginCatalogEntries }) => listRawChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-Cu1vLW72.js"), loadOnboardChannels()]);
	...
	if (catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-C4pjsnud.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-sc9M5CzL.js");
