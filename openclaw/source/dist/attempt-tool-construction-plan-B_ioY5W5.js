import { f as expandToolGroups, m as normalizeToolName, o as expandPolicyWithPluginGroups, p as normalizeToolList, r as buildPluginToolGroups } from "./tool-policy-BHUGxE3p.js";
...
*/
const BASE_CODING_TOOL_FACTORY_NAMES = /* @__PURE__ */ new Set([
	"edit",
	"read",
	"write"
]);
const SHELL_CODING_TOOL_FACTORY_NAMES = /* @__PURE__ */ new Set([
	"apply_patch",
	"exec",
	"process"
]);
const OPENCLAW_TOOL_FACTORY_NAMES = /* @__PURE__ */ new Set([
	"agents_list",
	"crestodian",
	"canvas",
	"cron",
