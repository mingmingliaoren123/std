...
import { i as detectCommandCarrierArgv, o as detectInlineEvalInSegments } from "./risks-CnLHDNUX.js";
import { I as resolveExecApprovalRequestAllowedDecisions, r as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, v as normalizeExecApprovalUnavailableDecisions } from "./exec-approvals-BIKWP8_V.js";
import { t as resolveExecCommandHighlighting } from "./exec-command-highlighting-BvX6IkW5.js";
import { ct as validateExecApprovalResolveParams, ot as validateExecApprovalGetParams, st as validateExecApprovalRequestParams, t as formatValidationErrors } from "./src-CToKmqGn.js";
import { Gn as errorShape, Wn as ErrorCodes } from "./schema-BuOFpc7K.js";
import { i as sanitizeExecApprovalWarningText, n as sanitizeExecApprovalDisplayText, r as sanitizeExecApprovalDisplayTextWithStatus, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-BpZj7eqi.js";
...
async function explainCommandForDisplay(command) {
	try {
		const { explainShellCommand } = await import("./extract-BhWbhGiG.js");
