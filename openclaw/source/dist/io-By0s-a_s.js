...
import { f as resolveIncludeRoots, s as resolveConfigPath, v as resolveStateDir } from "./paths-BMBAvkNf.js";
...
import { c as isRecord$1, m as resolveUserPath, v as isPlainObject } from "./utils-CRO4LGEB.js";
import { t as sleep } from "./sleep-DZm1epyW.js";
import { n as containsEnvVarReference, r as resolveConfigEnvVars } from "./env-substitution-CATXLg7n.js";
import { n as VERSION } from "./version-CeFj_iGk.js";
import { r as shouldWarnOnTouchedVersion } from "./version-NKzkBmMs.js";
import { n as cloneEnvWithPlatformSemantics, t as applyConfigEnvVars } from "./config-env-vars-DlUfO5Q_.js";
...
import { n as resolveManifestCommandAliasOwnerInRegistry } from "./manifest-command-aliases-CuH3RHcw.js";
import { i as GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA } from "./ids-DDdMGkAj.js";
...
import { o as getOfficialExternalPluginCatalogEntry, y as resolveOfficialExternalPluginInstall } from "./official-external-plugin-catalog-ph3rbXr3.js";
import { d as resolveMemorySlotDecision, l as resolveEffectivePluginActivationState, o as normalizePluginId, s as normalizePluginsConfig } from "./config-state-CtMlHVRM.js";
import { n as normalizeAgentModelRefForConfig, t as normalizeAgentModelMapForConfig } from "./model-input-B5RmygIK.js";
...
import { L as evaluateDmPolicyAllowFromDependency, R as isBuiltInModelProviderOverlayId } from "./zod-schema.core-DviqqtPj.js";
import { t as sanitizeTerminalText } from "./safe-text-Bkz4mOfI.js";
import { n as appendAllowedValuesHint, r as summarizeAllowedValues, t as validateJsonSchemaValue } from "./schema-validator-BRkrm3P2.js";
import { t as parseConfigPathArrayIndex } from "./path-array-index-CvEcUJa-.js";
import { _ as normalizeConfiguredProviderCatalogModelId, h as collectManifestModelIdNormalizationPolicies } from "./current-plugin-metadata-snapshot-CmOpmveB.js";
import { a as resolvePluginMetadataSnapshot } from "./plugin-metadata-snapshot-rpSrEgGf.js";
import { f as isLoopbackIpAddress, i as isCanonicalDottedDecimalIPv4 } from "./ip-BvvIlSgO.js";
...
import { t as loadDotEnv } from "./dotenv-eb21SB3p.js";
import { c as shouldEnableShellEnvFallback, i as loadShellEnvFallback, o as resolveShellEnvFallbackTimeoutMs, s as shouldDeferShellEnvFallback } from "./shell-env-DaE9Xx3-.js";
import { d as collectConfiguredModelRefs } from "./gateway-startup-speech-providers-tDMeTcRJ.js";
import { n as planManifestModelCatalogSuppressions } from "./manifest-planner-C4tynx2j.js";
import { a as createConfigValidationMetadataPluginIdScope } from "./gateway-startup-plugin-ids-COmsQTCi.js";
import { c as writePersistedInstalledPluginIndexInstallRecordsSync } from "./installed-plugin-index-records-C_n191FN.js";
import "./env-vars-BcrpQK0x.js";
import { a as readConfigIncludeFileWithGuards, i as hashConfigIncludeRaw, n as ConfigIncludeError, o as resolveConfigIncludeWritePath, s as resolveConfigIncludes } from "./includes-wKrczBrO.js";
import { a as formatConfigOverwriteLogMessage, c as snapshotConfigAuditProcessInfo, i as finalizeConfigWriteAuditRecord, n as appendConfigAuditRecordSync, r as createConfigWriteAuditRecordBase, t as appendConfigAuditRecord } from "./io.audit-Dfj9UbCq.js";
import { i as throwInvalidConfig } from "./io.invalid-config-ClW3wocf.js";
import { r as formatConfigIssueSummary } from "./issue-format-fzg0yJxc.js";
...
import { l as resolveBundledProviderPolicySurface } from "./thinking-CSA4xwds.js";
import { n as normalizeTalkConfig } from "./talk-CIVZmHe8.js";
import { i as normalizeTrustedSafeBinDirs, u as normalizeSafeBinProfileFixtures } from "./exec-safe-bin-trust-BiuDT-_9.js";
import { n as assertConfigWriteAllowedInCurrentMode } from "./nix-mode-write-guard-B42VmySw.js";
import { n as stripShippedPluginInstallConfigRecords, t as extractShippedPluginInstallConfigRecords } from "./plugin-install-config-migration-Ba4BJKHA.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath } from "./config-paths-CM5BdW2k.js";
import { d as preflightRuntimeSnapshotWrite, f as registerRuntimeConfigWriteListener, i as getRuntimeConfigSnapshot, l as loadPinnedRuntimeConfig, n as createRuntimeConfigWriteNotification, o as getRuntimeConfigSnapshotRefreshHandler, r as finalizeRuntimeSnapshotWrite, s as getRuntimeConfigSourceSnapshot, u as notifyRuntimeConfigWriteListeners } from "./runtime-snapshot-DOvWRYVz.js";
import { t as resolveShellEnvExpectedKeys } from "./shell-env-expected-keys-olzIzAlh.js";
import { a as resolveChannelDmAllowFrom, o as resolveChannelDmPolicy } from "./dm-access-j6yOoNfd.js";
import "./model-catalog-jXJgQvtY.js";
import { t as resolveWebSearchInstallCatalogEntries } from "./web-search-install-catalog-Cp_1AMaI.js";
import { c as isWindowsAbsolutePath, i as isAvatarHttpUrl, n as hasAvatarUriScheme, o as isPathWithinRoot, r as isAvatarDataUrl } from "./avatar-policy-3iKUCXyV.js";
import { t as shouldSuppressMissingCodexPluginDiagnostics } from "./codex-plugin-diagnostics-Ds0svRgM.js";
import { t as OpenClawSchema } from "./zod-schema-O9ml_nmo.js";
...
function resolveCronTriggerMinIntervalMs(cronConfig) {
...
function logConfigWarningsOnce(params) {
	...
	if (loggedConfigWarningFingerprints.get(params.configPath) === fingerprint) return;
...
function resolveConfigSizeBaselineBytes(params) {
	...
	if (!parsed.ok || !isRecord$1(parsed.parsed)) return rawBytes;
...
function warnOnConfigPermissionHardeningFailure(params) {
	const detail = params.error instanceof Error ? params.error.message : String(params.error);
	params.deps.logger.warn(`Config permission hardening failed (${params.context}): ${params.configPath}: ${detail}`);
}
async function persistPrefixedConfigRecovery(params) {
	...
	await params.deps.fs.promises.chmod?.(params.configPath, 384).catch((error) => {
...
async function collectInvalidConfigLegacyIssues(raw, sourceRaw) {
	if (!raw || typeof raw !== "object") return [];
	const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-Cv_fC37r.js");
...
function createConfigIO(overrides = {}) {
	...
	function resolveSuspiciousRecoveryBackupCandidate(parsed) {
		try {
			...
			const installMigration = migrateAndStripShippedPluginInstallConfigRecords(resolveConfigForRead(resolveConfigIncludesForRead(parsed, configPath, candidateDeps), candidateEnv, deps.lowerPrecedenceEnv).resolvedConfigRaw, {
				persist: false,
	...
	function loadConfigLocal(options = {}) {
		try {
			...
			if (overrides.pluginValidation !== "skip") logConfigWarningsOnce({
				configPath,
				warnings: validated.warnings,
				logger: deps.logger
			});
	...
	async function writeConfigFileLocal(cfg, options = {}) {
		...
		try {
			...
			return {
				...
				...pluginInstallConfigMigration.migrated || !options.skipPluginValidation ? { [configWritePostCommitRollback]: () => {
					rollbackShippedPluginInstallConfigWriteMigration(pluginInstallConfigMigration);
					if (previousWarningFingerprint === void 0) loggedConfigWarningFingerprints.delete(configPath);
					else loggedConfigWarningFingerprints.set(configPath, previousWarningFingerprint);
				} } : {}
			};
		} catch (err) {
...
//#endregion
export { applyConfigOverrides as A, normalizeProviderConfigForConfigDefaults as B, validateConfigObject as C, collectChannelSchemaMetadata as D, validateConfigObjectWithPlugins as E, ConfigMutationConflictError as F, projectSourceOntoRuntimeShape as G, resolveCronTriggerMinIntervalMs as H, asResolvedSourceConfig as I, AUTO_MANAGED_CONFIG_META_PATHS as J, resolveManagedUnsetPathsForWrite as K, asRuntimeConfig as L, resetConfigOverrides as M, setConfigOverride as N, collectPluginSchemaMetadata as O, unsetConfigOverride as P, resolveOwnerDisplaySetting as Q, DEFAULT_MODEL_ALIASES as R, collectUnsupportedSecretRefPolicyIssues as S, validateConfigObjectRawWithPlugins as T, applyUnsetPathsForWrite as U, resolveCronMaxConcurrentRuns as V, createMergePatch as W, createPreUpdateConfigSnapshot as X, restoreEnvVarRefs as Y, maintainConfigBackups as Z, recoverConfigFromLastKnownGood as _, loadConfig as a, restoreEnvChangesIfUnchanged as b, readBestEffortConfig as c, readConfigFileSnapshotForWrite as d, readConfigFileSnapshotWithPluginMetadata as f, recoverConfigFromJsonRootSuffix as g, readSourceConfigSnapshotForWrite as h, getRuntimeConfig as i, getConfigOverrides as j, projectConfigOntoRuntimeSourceSnapshot as k, readBestEffortConfigSnapshot as l, readSourceConfigSnapshot as m, clearConfigCache as n, parseConfigJson5 as o, readSourceConfigBestEffort as p, resolveWriteEnvSnapshotForPath as q, createConfigIO as r, promoteConfigSnapshotToLastKnownGood as s, ConfigRuntimeRefreshError as t, readConfigFileSnapshot as u, registerConfigWriteListener as v, validateConfigObjectRaw as w, writeConfigFile as x, resolveConfigSnapshotHash as y, resolveNormalizedProviderModelMaxTokens as z };
