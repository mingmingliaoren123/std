...
import { i as resolveMatrixAccount } from "./accounts-BmRaB5bV.js";
import { t as formatMatrixErrorMessage } from "./errors-Br49yrzd2.js";
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update-BJec2j3n.js";
import { n as matrixSetupAdapter } from "./setup-core-DU9HLbZy.js";
import { t as withResolvedActionClient } from "./client-BLPSEeal.js";
import { r as resolveMatrixAuthContext } from "./config-DygzEAEa.js";
...
const loadMatrixActionClientModule = createLazyRuntimeModule(() => import("./client-CitFNK0P.js"));
const loadMatrixDirectManagementModule = createLazyRuntimeModule(() => import("./direct-management-CU4fGTeC.js"));
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-D4LYsa8Q.js");
