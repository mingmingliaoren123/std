...
import { B as normalizeProviderConfigForConfigDefaults } from "./io-By0s-a_s.js";
...
function applyProviderAuthConfigPatch(cfg, patch, options) {
	...
	if (!options?.replaceDefaultModels || !isRecord(patch)) return ensureConfiguredDefaultModelsAllowed(merged);
