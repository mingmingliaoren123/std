...
import { h as resolveCompactionSessionFile } from "./sessions-oDygYVdy.js";
import { o as resolveStableSessionEndTranscript } from "./session-transcript-files.fs-Cj46Z9Oy.js";
...
import "./session-system-events-DypErYvT.js";
import { n as resolveReusableWorkspaceSkillSnapshot } from "./session-snapshot-D1eOq_QP.js";
...
async function persistSessionEntryUpdate(params) {
	if (!params.sessionEntryHandle && (!params.sessionStore || !params.sessionKey)) return params.nextEntry;
	...
	persistedEntry = await patchSessionEntry({
		storePath: params.storePath,
		sessionKey: params.sessionKey
	}, () => params.updates, { fallbackEntry: params.nextEntry }) ?? persistedEntry;
	if (params.sessionEntryHandle) params.sessionEntryHandle.replaceCurrent(persistedEntry);
	else if (params.sessionStore) params.sessionStore[params.sessionKey] = persistedEntry;
	return persistedEntry;
}
