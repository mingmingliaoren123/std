...
type QueuedReplyLifecycle = {
  /** Stable cancellation owner used to keep collect-mode batches authorization-safe. */ownerKey?: string; /** Return false when the external owner rejects this queue identity. */
  onEnqueued?: () => boolean | void; /** Retires this source's cancellation ownership while retaining its live identity. */
  onCancellationRetired?: () => void; /** Called after the queued turn owns the reply lane, before model/tool execution. */
...
type GetReplyOptions = {
   ...
   */
  onTurnAdopted?: () => void | Promise<void>; /** Shared lifecycle owner for the current user-turn transcript append. */
  ...
  commentaryProgressEnabled?: boolean; /** Deliver durable reasoning payloads to channels that own a separate reasoning lane. */
...
//#endregion
export { markReplyPayloadAsTtsSupplement as _, SourceReplyDeliveryMode as a, FAST_MODE_AUTO_PROGRESS_KIND as c, ReplyPayloadTtsSupplement as d, buildTtsSupplementMediaPayload as f, isReplyPayloadTtsSupplement as g, isReplyPayloadNonTerminalToolErrorWarning as h, ReplyThreadingPolicy as i, ReplyDeliveryContext as l, isFastModeAutoProgressPayload as m, GetReplyOptions as n, TypingController as o, getReplyPayloadTtsSupplement as p, PartialReplyPayload as r, PromptImageOrderEntry as s, BlockReplyContext as t, ReplyPayload as u };