...
type CronJobPatch = Partial<Omit<CronJob, "id" | "createdAtMs" | "state" | "payload" | "delivery" | "declarationKey" | "displayName" | "owner">> & {
...
//#endregion
export { CronJobCreate as a, CronRunStatus as c, CronJob as i, EmbeddedAgentExecutionPhase as l, resolveCronStorePath as n, CronJobPatch as o, saveCronStore as r, CronPayload as s, loadCronStore as t };