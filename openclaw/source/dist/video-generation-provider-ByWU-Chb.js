...
async function downloadVideoFromFileId(params) {
	...
	const metadata = await readProviderJsonResponse(await fetchProviderOperationResponse({
		stage: "download",
		url: url.toString(),
		init: {
			method: "GET",
