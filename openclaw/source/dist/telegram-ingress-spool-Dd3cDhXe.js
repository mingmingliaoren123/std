...
import { n as truncateUtf16Safe$1, t as sliceUtf16Safe } from "./utf16-slice-fWbEI5Oy.js";
...
import { a as formatUncaughtError, c as readErrorName, i as formatErrorMessage, t as collectErrorGraphCandidates } from "./errors-sMD712F3.js";
import { _ as uniqueStrings, l as normalizeStringEntries } from "./string-normalization-CRyoFBPt.js";
import { n as createNonExitingRuntime } from "./runtime-Bz6o617W.js";
import { r as getChildLogger } from "./logger-DPps3u8A.js";
...
import { a as resolveAgentDir, c as resolveDefaultAgentId, r as resolveAgentConfig } from "./agent-scope-config-BxAUeF6t.js";
import { a as shouldLogVerbose, r as logVerbose, s as warn, t as danger } from "./globals-0FRK183t.js";
...
import { t as mutateConfigFile } from "./config-DbyjySSE.js";
import { u as fireAndForgetHook } from "./hook-runner-global-BmIrGlLG.js";
import { c as isReplyPayloadNonTerminalToolErrorWarning, o as getReplyPayloadTtsSupplement, r as buildTtsSupplementMediaPayload, s as isFastModeAutoProgressPayload } from "./reply-payload-BK_jICQ3.js";
...
import { n as resolveThinkingDefaultWithRuntimeCatalog } from "./model-thinking-default-Bjh5mzPy.js";
...
import { _ as isInsideCode, f as stripReasoningTagsFromText, g as findCodeRegions } from "./assistant-visible-text-oprKkPEf.js";
...
import { i as readRecentUserAssistantTextForSession } from "./transcript-uom_ZjhV.js";
import { r as stripInlineDirectiveTagsForDelivery } from "./directive-tags-Dwm0c6MB.js";
...
import { i as resolveAgentRoute, n as deriveLastRoutePolicy } from "./resolve-route-EO7BJcsf.js";
...
import { t as resolveAckReaction } from "./identity-BfKoTsep.js";
...
import { A as resolveTranscriptBackedChannelFinalText, D as resolveChannelStreamingPreviewToolProgress, S as resolveChannelStreamingBlockEnabled, d as isPotentialTruncatedFinal, i as buildChannelProgressDraftLineForEntry, j as selectLongerFinalText, r as buildChannelProgressDraftLine, u as isChannelProgressDraftWorkToolName } from "./streaming-CfpqgwBH.js";
import { c as resolveTextChunkLimit, s as resolveChunkMode } from "./chunk-eqDomQ-g.js";
import { i as toInternalMessageReceivedContext } from "./message-hook-mappers-CLWKm8aG.js";
...
import { h as resolveChannelConfigWrites } from "./channel-config-helpers-BH5RG2Ab.js";
import { c as formatReasoningMessage } from "./embedded-agent-utils-CjKqpAOm.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-BfccGJ_e.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-ZPTJOYzU.js";
...
import "./runtime-config-snapshot-CdR6q5KB.js";
...
import { c as parseCommandArgs, i as formatCommandArgMenuTitle, n as buildCommandTextFromArgs, o as listNativeCommandSpecs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "./commands-registry-DNV4RD24.js";
import { i as matchesMentionWithExplicit, n as buildMentionRegexes, t as CURRENT_MESSAGE_MARKER } from "./mentions-BJW-vfhG.js";
...
import { a as isRecoverableTelegramNetworkError, g as readTelegramRetryAfterMs, h as isTelegramServerError, l as isTelegramEditTargetMissingError, m as isTelegramRateLimitError, u as isTelegramMessageHasNoTextError } from "./request-timeouts-B3dsnJN5.js";
import "./routing-D8zbLWGc.js";
import { a as resolveEnvelopeFormatOptions, r as formatInboundEnvelope } from "./envelope-CXHEh-mU.js";
import { n as resolveInboundDebounceMs, t as createInboundDebouncer } from "./inbound-debounce-B16kSCvW.js";
import { i as shouldAckReaction, n as removeAckReactionAfterReply } from "./ack-reactions-Pw4-TsUB.js";
import { n as resolveInboundMentionDecision, t as implicitMentionKindWhen } from "./mention-gating-3P8aSD7o.js";
import "./history-CUIJCHC2.js";
import { t as createChannelReplyPipeline } from "./reply-pipeline-JiXbL-bQ.js";
import { t as createChannelHistoryWindow } from "./history-window-D27McfV4.js";
...
import "./reply-history-DRbdD_CY.js";
import { n as resolveAmbientTranscriptWatermarkKey } from "./ambient-transcript-watermark-pZlMospW.js";
import { a as patchSessionEntry, c as updateSessionStoreEntry, n as getSessionEntry, o as readAmbientTranscriptWatermark, r as listSessionEntries } from "./session-store-runtime-DDagY4fL.js";
import { m as parseExecApprovalCommandText } from "./exec-approval-reply-DiCxsYva.js";
...
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./reply-dispatch-runtime-Bq8vXD2i.js";
import "./reply-chunking-DEg6TUQL.js";
import { f as runChannelInboundEvent } from "./inbound-reply-dispatch-C8SZBmZG.js";
import { a as resolveChannelDraftStreamingChunking, c as createMessageReceiveContext, i as createChannelProgressDraftCompositor } from "./channel-outbound-DkdAAOhG.js";
import { n as logInboundDrop, r as logTypingFailure, t as logAckFailure } from "./logging-gUWPKC5g.js";
import "./dedupe-runtime-Cpo1VwnM.js";
import "./model-session-runtime-DT44Lkb6.js";
import "./conversation-runtime-Dg1MGKiZ.js";
import "./agent-runtime-JUjSgUZE.js";
import { i as createInteractiveConversationBindingHelpers, r as dispatchPluginInteractiveHandler } from "./plugin-runtime-DAKxyCb0.js";
import "./hook-runtime-CgI1ksad.js";
import "./markdown-table-runtime-BCGJTdv-.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders-SSrOyQjA.js";
import { t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-BZpcaBLu.js";
import { n as formatModelsAvailableHeader } from "./commands-models-DS-WQ12R.js";
import "./command-auth-native-TscOJc1_.js";
import "./command-primitives-runtime-Bz1TRqr8.js";
import "./command-status-LXhaIrwN.js";
import "./command-detection-M5Wj9eIk.js";
import "./command-surface-YZTceQRC.js";
import { i as resolveUnmentionedGroupInboundPolicy, l as shouldDebounceTextInbound, o as formatLocationText, r as classifyChannelInboundEvent, s as toLocationContext } from "./channel-inbound-CxUVIreR.js";
import { a as DEFAULT_TIMING, i as DEFAULT_EMOJIS } from "./channel-feedback-ChYFAgPX.js";
import "./channel-inbound-debounce-RGdqar2E.js";
import "./channel-mention-gating-Bs03MctU.js";
import { n as createChannelIngressResolver, o as defineStableChannelIngressIdentity } from "./message-access-DucCKzfO.js";
import "./channel-ingress-runtime-DXYdIXwo.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-3Uf4WD4J.js";
import { i as readLatestAssistantTextByIdentity, s as resolveSessionTranscriptLegacyFileTarget, t as appendAssistantMirrorMessageByIdentity } from "./session-transcript-runtime-CqRUDYiQ.js";
import "./models-provider-runtime-CpwXLPrQ.js";
import "./skill-commands-runtime-CmF33pmE.js";
import "./native-command-config-runtime-Dy3iL4P-.js";
import { t as codexChannelLoginRuntime } from "./provider-auth-login-flow-runtime-Bgx33-w5.js";
import "./state-paths-Cn4X4Avn.js";
import { a as resolveDefaultTelegramAccountId, o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-B2_AQ-Fk.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-_oqBQ1k2.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-Boc7P3w5.js";
import { $ as resolveTelegramRichMessagePlaceholder, A as resolveTelegramBotHasTopicsEnabled, B as shouldUseTelegramDmThreadSession, C as buildTelegramThreadParams, D as isTelegramCommandsAllowFromConfigured, E as extractTelegramForumFlag, F as resolveTelegramGroupAllowFromContext, G as getTelegramTextParts, H as buildSenderLabel, I as resolveTelegramMessageForumFlagHint, K as hasBotMention, L as resolveTelegramReplyId, N as resolveTelegramForumFlag, O as loadTelegramPairingStoreIfNeeded, P as resolveTelegramForumThreadId, Q as resolveTelegramPrimaryMedia, R as resolveTelegramStreamMode, S as buildTelegramRoutingTarget, T as describeReplyTarget, U as buildSenderName, V as withResolvedTelegramForumFlag, W as extractTelegramLocation, X as renderTelegramTextEntities, Y as normalizeForwardedContext, Z as resolveTelegramMediaPlaceholder, _ as buildGroupLabel, b as buildTelegramInboundOriginTarget, c as buildTelegramConversationContext, d as isTelegramSessionBoundaryCommandText, dt as expandTelegramAllowFromWithAccessGroups, et as resolveTelegramRichMessageText, ft as resolveTelegramDmAllow, g as TelegramPairingStoreReadError, gt as resolveTelegramEffectiveDmPolicy, h as resolveTelegramMessageCacheScope, ht as normalizeDmAllowFromWithStore, i as recordSentMessage, j as resolveTelegramCommandAuthorization, l as buildTelegramReplyChain, mt as normalizeAllowFrom, pt as isSenderAllowed, q as hasBotMentionInText, st as renderTelegramHtmlText, u as createTelegramMessageCache, v as buildTelegramGroupFrom, w as buildTypingThreadParams, x as buildTelegramParentPeer, y as buildTelegramGroupPeerId, z as resolveTelegramThreadSpec } from "./sent-message-cache-BGcQC26h.js";
...
import { n as resolveTelegramConversationRoute, t as resolveTelegramConversationBaseSessionKey } from "./conversation-route-C2X1h63l.js";
...
import { i as withTelegramPromptContextTimestampMs, n as registerTelegramOutboundGroupHistoryRecorder, t as recordOutboundMessageForPromptContext } from "./outbound-message-context-JKJeVl-f.js";
import { t as loadTelegramSendModule } from "./send-runtime-Bf9TO2zk.js";
import { t as TELEGRAM_TEXT_CHUNK_LIMIT } from "./outbound-adapter-CF1CXHOf.js";
...
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-2lqRez4i.js";
import { c as commitTelegramMessageDispatchReplay, d as releaseTelegramMessageDispatchReplay, l as createTelegramMessageDispatchReplayGuard, s as claimTelegramMessageDispatchReplay, u as isTelegramMessageDispatchReplayForgetError } from "./message-dispatch-dedupe-IsUYRf5N.js";
import { r as cacheSticker } from "./sticker-cache-store-DC3gW-5Z.js";
import { r as createTelegramThreadBindingManager } from "./thread-bindings-DV5S7o3b.js";
import { n as getTopicName, o as resolveTopicNameCacheScope, s as updateTopicName } from "./topic-name-cache-DRmp4Kbo.js";
import { t as describeStickerImage } from "./sticker-cache-Bc_Bz0g6.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-DergRSC5.js";
import { B as resolveTelegramClientTimeoutMinimumSeconds, C as buildTelegramRichMarkdown, G as getOrCreateAccountThrottler, H as resolveTelegramOutboundClientTimeoutFloorSeconds, J as sequentialize, K as Bot, L as buildInlineKeyboard, R as asTelegramClientFetch, V as resolveTelegramClientTimeoutSeconds, W as withTelegramApiErrorLogging, a as editMessageTelegram, b as TELEGRAM_RICH_TEXT_LIMIT, k as splitTelegramRichMarkdownChunks, q as apiThrottler, x as buildTelegramRichHtml, z as createTelegramClientFetch } from "./send-BgA996pw.js";
import { t as beginTelegramInboundEventDeliveryCorrelation } from "./inbound-event-delivery-CNR-dgbp.js";
import { a as buildPluginTelegramMenuCommands, i as buildCappedTelegramMenuCommands, n as resolveTelegramExecApproval, o as syncTelegramMenuCommands, r as createTelegramDraftStream, t as defaultTelegramBotDeps } from "./bot-deps-BBncur2u.js";
import { a as isMediaSizeLimitError, c as deliverReplies, i as isDurablyRetryableInboundMediaError, l as emitInternalMessageSentHook, n as TelegramBotApiFileTooLargeError, o as isRecoverableMediaGroupError, r as hasInboundMedia, s as resolveInboundMediaFileId, t as resolveMedia } from "./delivery-BzuQz4xo.js";
...
const resolveTelegramUpdateId$1 = (ctx) => ctx.update?.update_id ?? ctx.update_id;
const buildTelegramUpdateKey = (ctx) => {
	const updateId = resolveTelegramUpdateId$1(ctx);
...
function buildTelegramGroupHistorySelfSender(name) {
...
const registerTelegramHandlers = ({ cfg, accountId, bot, opts, telegramTransport, runtime, mediaMaxBytes, telegramCfg, allowFrom, groupAllowFrom, resolveGroupPolicy, resolveTelegramGroupConfig, shouldSkipUpdate, processMessage, logger, telegramDeps, resolveGroupActivation, resolveGroupRequireMention }) => {
	...
	const queueBufferedProcessing = async (queue, key, task) => {
	...
	const latestPromptContextAmbientWatermark = (...watermarks) => {
		return watermarks.findLast((watermark) => watermark !== void 0);
	};
	...
	const commitDispatchDedupeKeys = async (keys, options = {}) => {
	...
	const formatTelegramAmbientTranscriptLine = (msg) => {
		const body = getTelegramTextParts(msg).text.trim() || resolveTelegramMediaPlaceholder(msg) || "[User sent media without caption]";
		...
		onFlush: async (entries) => {
			...
			try {
				...
				if (!combinedText.trim() && combinedMedia.length === 0) {
					releaseDispatchDedupeKeys(mergeDispatchDedupeKeys(...entries.map((entry) => entry.dispatchDedupeKeys)));
				...
				const promptContextAmbientWatermark = latestPromptContextAmbientWatermark(...entries.map((entry) => entry.promptContextAmbientWatermark));
	...
	const processMediaGroup = async (entry) => {
		try {
			...
			const allMedia = [];
			const promptContextMessageSelection = /* @__PURE__ */ new Map();
			let skippedCount = 0;
	...
	const buildPromptContextForMessage = async (ctx, msg, replyChainNodes, options, mediaByMessageId, selectedMessageIds) => {
		const isGroup = msg.chat.type === "group" || msg.chat.type === "supergroup";
		const groupHistoryLimit = Math.max(0, telegramCfg.historyLimit ?? cfg.messages?.groupChat?.historyLimit ?? 50);
		...
		const cachePromptMessages = Array.from(conversationContextById.values()).map((entry) => toPromptContextMessage(entry.node, { replyTarget: entry.isReplyTarget }, entry.node.messageId ? mediaByMessageId?.get(entry.node.messageId) : void 0));
	...
	const processMessageWithReplyChain = async (params) => {
		...
		const spooledReplay = params.options?.spooledReplay === true || isTelegramSpooledReplayUpdate(params.ctx.update) || Boolean(params.spooledReplayParticipants?.length);
		...
		const finalizeSpooledReplayResult = async (result) => {
			...
			const finalization = (async () => {
				...
				if (result.kind === "completed") {
					...
					try {
						await commitDispatchDedupeKeys(params.dispatchDedupeKeys ?? [], { requirePersistent: true });
					} catch (error) {
				...
				} else releaseDispatchDedupeKeys(params.dispatchDedupeKeys ?? [], result.kind === "failed-retryable" ? result.error : void 0);
		...
		try {
			...
			const promptContext = await buildPromptContextForMessage(params.ctx, params.msg, replyChainNodes, params.options, promptContextMediaByMessageId, params.promptContextMessageSelection);
			const result = await processMessage(params.ctx, params.allMedia, params.storeAllowFrom, params.options, replyMedia, replyChain, promptContext, {
	...
	const processPluginCallbackSubmitText = async (params) => {
		const spooledReplayParticipant = isTelegramSpooledReplayUpdate(params.syntheticCtx.update) ? getTelegramSpooledReplayDeferredParticipant() ?? createTelegramSpooledReplayDeferredParticipant(`plugin-callback-submit:${params.callbackId}`) ?? void 0 : void 0;
	...
	const processInboundMessage = async (params) => {
		const { ctx, msg, chatId, isGroup, isForum, resolvedThreadId, dmThreadId, dmPolicy, storeAllowFrom, senderId, effectiveGroupAllow, effectiveDmAllow, groupConfig, topicConfig, sendOversizeWarning, oversizeLogMessage, promptContextMinTimestampMs, promptContextAmbientWatermark, dispatchDedupeKeys } = params;
			...
			if (existing) {
				...
				if (idGap > 0 && idGap <= TELEGRAM_TEXT_FRAGMENT_MAX_ID_GAP && timeGapMs >= 0 && timeGapMs <= TELEGRAM_TEXT_FRAGMENT_MAX_GAP_MS) {
					...
					if (existing.messages.length + 1 <= TELEGRAM_TEXT_FRAGMENT_MAX_PARTS && nextTotalChars <= TELEGRAM_TEXT_FRAGMENT_MAX_TOTAL_CHARS) {
						...
						existing.promptContextAmbientWatermark = latestPromptContextAmbientWatermark(existing.promptContextAmbientWatermark, promptContextAmbientWatermark);
		...
		if (mediaGroupId) {
			...
			if (existing) {
				...
				existing.timer = setTimeout(() => {
					...
					queueBufferedProcessing(mediaGroupProcessingQueue, mediaGroupKey, async () => {
		...
		try {
			...
			if (retryable) recordTelegramMessageProcessingResult({
				kind: "failed-retryable",
				error: mediaErr
			});
			if (!(retryable && isTelegramSpooledReplayUpdate(ctx.update))) await withTelegramApiErrorLogging({
				operation: "sendMessage",
				runtime,
			...
			releaseDispatchDedupeKeys(dispatchDedupeKeys, retryable ? mediaErr : void 0);
			return;
		}
		...
		try {
			...
			if ((await dispatchTelegramPluginInteractiveHandler({
				...
				afterInvoke: async (result) => {
					...
					const { ctx: syntheticCtx, message: syntheticMessage } = buildCallbackSyntheticTextContext({
						ctx,
						callbackMessage,
						callback,
						text: submitText,
					...
					if (await processPluginCallbackSubmitText({
						callbackId: callback.id,
						syntheticCtx,
						syntheticMessage,
						storeAllowFrom
...
async function resolveTelegramInboundBody(params) {
	...
	if (!rawBody) rawBody = richText ?? resolveTelegramRichMessagePlaceholder(msg) ?? placeholder;
...
function createLaneTextDeliverer(params) {
	...
	const streamText = async (laneName, lane, text, payload, useFinalTextRecovery, finalizePreview, buttons) => {
		...
		const deliveredStreamTextAfterStop = stream.lastDeliveredText?.();
		const retainedOriginalActiveChunkAfterStop = activeChunkIndexAfterStop > activeChunkIndex && deliveredStreamTextAfterStop === activeChunk.trimEnd();
		const effectiveActiveChunkIndexAfterStop = retainedOriginalActiveChunkAfterStop ? activeChunkIndex : activeChunkIndexAfterStop;
		...
		if (finalizePreview && deliveredStreamTextAfterStop !== void 0 && deliveredStreamTextAfterStop !== activeChunkTextAfterStop && !retainedOriginalActiveChunkAfterStop) {
...
function shouldSupersedeTelegramReplyFence(ctxPayload) {
	...
	return ctxPayload.CommandAuthorized && (isExplicitCommandTurn(ctxPayload.CommandTurn) || isRecognizedTelegramTextCommand(dispatchText));
}
/**
...
function renderTelegramProgressLine(line) {
	...
	if (!line.icon && line.label === "Commentary") return line.text.split(/\r?\n/u).map(renderTelegramProgressStringLine).filter(Boolean).join("<br>");
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts, retryDispatchErrors = false, suppressFailureFallback = false, onTurnAdopted, onTurnDeferred, onTurnAbandoned, turnAbortSignal }) => {
	const dispatchStartedAt = Date.now();
	const dispatchContext = resolveDispatchTelegramContext({ context });
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-DkGs3q41.js")).defaultTelegramBotDeps;
	const loadFreshSessionEntry = createFreshTelegramSessionEntryLoader({
		cfg,
		telegramDeps
	});
	const { ctxPayload, msg, chatId, isGroup, groupConfig, topicConfig, threadSpec, historyKey, route, skillFilter, sendTyping, sendRecordVoice, ackReactionPromise, reactionApi, removeAckAfterReply, statusReactionController: rawStatusReactionController } = dispatchContext;
	...
	const replyAbortSignal = turnAbortSignal ? AbortSignal.any([replyAbortController.signal, turnAbortSignal]) : replyAbortController.signal;
	let replyAbortControllerQueued = false;
	let queuedTurnAdopted = false;
	let dispatchWasSuperseded;
	const isDispatchSuperseded = () => replyAbortController.signal.aborted || replyFenceGeneration !== void 0 && isTelegramReplyFenceSuperseded({
	...
	const durableReasoningPayloadsEnabled = resolvedReasoningLevel === "on" || Boolean(reasoningLane.stream);
	...
	async function prepareAnswerLaneForToolProgress() {
		...
		if (streamMode !== "progress" && answerLane.hasStreamedMessage) await rotateAnswerLaneForNewMessage();
	...
	const canPushStreamToolProgress = () => Boolean(answerLane.stream && !verboseProgressActive() && !answerLane.finalized && !finalAnswerDeliveryStarted && !finalAnswerDelivered);
	...
	const pushStreamReasoningProgress = async (payload) => {
		if (streamReasoningInProgressDraft && payload.text) progressSummary.noteReasoningActivity();
		return await progressDraft.pushReasoningProgress(payload.text, { snapshot: payload.isReasoningSnapshot === true });
	};
	const pushStreamThinkingTokenProgress = async (progressTokens) => {
		const rendered = await pushStreamToolProgress(buildTelegramThinkingProgressLine(progressTokens), { startImmediately: true });
		if (rendered) progressSummary.noteReasoningActivity();
		return rendered;
	};
	...
	const rotateAnswerLaneAfterToolProgress = async () => {
		...
		if (answerLane.stream?.rotateToNewMessageDeferringDelete) answerLane.stream.rotateToNewMessageDeferringDelete();
		else answerLane.stream?.forceNewMessage();
		resetDraftLaneState(answerLane);
	...
	const prepareAnswerLaneForText = async () => {
		if (streamMode === "progress") return false;
	...
	if (!isRoomEvent) supersedeTelegramReplyFence(replyFenceKey.roomEventKey);
	...
	let currentTurnTranscriptFinal;
	const resolveCurrentTurnTranscriptFinal = async () => {
		if (!sessionKey) return;
		if (currentTurnTranscriptFinal) return currentTurnTranscriptFinal;
		try {
	...
	const resolveCurrentTurnTranscriptFinalText = async () => (await resolveCurrentTurnTranscriptFinal())?.text;
	const normalizePromptContextTimestampText = (text) => stripInlineDirectiveTagsForDelivery(text).text.trim();
	const resolvePromptContextTimestampMs = async (text) => {
		const final = await resolveCurrentTurnTranscriptFinal();
		if (!final || normalizePromptContextTimestampText(final.text) !== normalizePromptContextTimestampText(text)) return;
	...
	try {
		...
		const normalizeDeliveryPayload = (payload) => {
			...
			return projectOutboundPayloadPlanForDelivery(createOutboundPayloadPlan([payloadForPlan], {
				cfg,
				sessionKey: ctxPayload.SessionKey,
				surface: "telegram"
			}))[0];
		...
		const sendPayload = async (payload, options) => {
			...
			const effectivePayload = withTelegramPromptContextTimestampMs(deliverablePayload, options?.durable && deliverablePayload.text ? await resolvePromptContextTimestampMs(deliverablePayload.text) : void 0);
			...
			if (options?.durable && durableDelivery) {
				const durable = await durableDelivery({
					...
					requiredCapabilities: deriveDurableFinalDeliveryRequirements({
						...
						extraCapabilities: { nativeQuote: usesNativeTelegramQuote(effectivePayload) }
					})
				});
			...
			const result = await (telegramDeps.deliverReplies ?? deliverReplies)({
				...deliveryBaseOptions,
				transcriptMirror: options?.durable && options?.mirrorTranscript !== false ? deliveryBaseOptions.transcriptMirror : void 0,
		...
		const emitPreviewFinalizedHook = async (result) => {
			...
			try {
				const promptContextContent = result.delivery.promptContextContent ?? result.delivery.content;
				const promptContextTimestampMs = await resolvePromptContextTimestampMs(promptContextContent);
				await (telegramDeps.recordOutboundMessageForPromptContext ?? recordOutboundMessageForPromptContext)({
					...
					...promptContextTimestampMs !== void 0 ? { promptContextTimestampMs } : {},
		...
		const resolveProgressCollapseSummaryLine = () => {
			if (progressSummaryDelivered) return;
			progressSummaryDelivered = true;
			if (!progressDraftEverRendered) return;
			return formatTelegramProgressSummaryLine(progressSummary.counts(), Date.now() - progressSummaryStartedAt) || void 0;
		};
		...
		const applyProgressCollapseSummary = async (line) => {
			if (typeof await answerLane.stream?.finalizeToPreview(renderStreamText(line)) === "number") return "edited";
			await postCosmeticSummaryBar(line);
			return "posted";
		};
		...
		const deliverProgressModeFinalAnswer = async (payload, text) => {
			...
			} else await teardownProgressWindow();
			if (!delivered) return { kind: "skipped" };
			answerLane.finalized = true;
			markProgressFinalDelivered();
			return { kind: "sent" };
		};
		const resolveTranscriptBackedFinalText = async (text) => {
		...
		try {
						...
						runDispatch: () => {
							...
							return telegramDeps.dispatchReplyWithBufferedBlockDispatcher({
								...
								dispatcherOptions: {
									...
									deliver: async (payload, info) => {
										...
										for (const segment of segments) {
											...
											const skipTextOnlyBlock = streamMode === "partial" && info.kind === "block" && segment.lane === "answer" && !reply.hasMedia && !hasExecApprovalPayload(effectivePayload) && telegramButtons === void 0 && answerLane.hasStreamedMessage && !activeAnswerDraftIsToolProgressOnly && !ownedByQueuedAnswerBlockRotation && segment.update.text.trimEnd() === answerLane.lastPartialText.trimEnd();
											const suppressProgressAnswerBlock = streamMode === "progress" && info.kind === "block" && segment.lane === "answer" && !reply.hasMedia && !hasExecApprovalPayload(effectivePayload) && telegramButtons === void 0;
											...
											if (segment.lane === "answer" && info.kind === "block") {
												...
												const shouldRotateQueuedBlock = takeQueuedAnswerBlockRotation(lanePayload, info.assistantMessageIndex);
												if (streamMode !== "progress" && shouldRotateQueuedBlock && !preparedAnswerLane) {
													await rotateAnswerLaneForNewMessage();
													rotateAnswerLaneWhenQueuedBlocksSettle = false;
												}
												resetAnswerToolProgressDraft();
										...
										if (split.suppressedReasoningOnly) {
											...
											if (reply.hasMedia) {
												...
												delivered = await sendPayload(payloadWithoutSuppressedReasoning, { durable: info.kind === "final" });
											}
								...
								replyOptions: {
									...
									queuedFollowupLifecycle: isRoomEvent || onTurnAdopted || onTurnDeferred || onTurnAbandoned ? {
										onEnqueued: () => {
										...
										onComplete: () => {
											...
											releaseTelegramReplyFenceAbortController(activeReplyFenceKey, replyAbortController);
											if (!queuedTurnAdopted) onTurnAbandoned?.();
										}
									} : void 0,
									...
									onReasoningProgress: answerLane.stream ? (payload) => enqueueDraftLaneEvent(async () => {
									...
									onToolStart: async (payload) => {
										...
										if (payload.phase === "start") if (canPushStreamToolProgress() && streamToolProgressEnabled && isChannelProgressDraftWorkToolName(toolName)) progressSummary.noteToolCall();
										else {
											progressSummary.closeReasoningBurst();
			...
			if ((turnResult.dispatchResult.counts?.final ?? 0) > 0) sawProgressFinal = true;
			...
			if (streamMode === "progress" && sawProgressFinal && !dispatchError && !hadErrorReplyFailureOrSkip && !isDispatchSuperseded()) await deliverProgressCollapseSummary();
		}
	} finally {
	...
	const hasFinalResponse = finalAnswerDelivered || sentFallback || suppressSilentReplyFallback || queuedFinal;
	const hasVisibleResponse = deliverySummary.delivered || sentFallback || suppressSilentReplyFallback || queuedFinal;
	...
	if (statusReactionController && !hasVisibleResponse) finalizeTelegramStatusReaction({
		outcome: "error",
	...
	if (statusReactionController) finalizeTelegramStatusReaction({
		outcome: !finalAnswerDelivered && (dispatchError != null || sentFallback) ? "error" : "done",
		hasFinalResponse: true
	}).catch((err) => {
		logVerbose(`telegram: status reaction finalize failed: ${String(err)}`);
	});
...
const TELEGRAM_SPOOLED_RETRY_BASE_MS = 1e3;
const TELEGRAM_SPOOLED_RETRY_MAX_MS = 3 * 6e4;
...
function resolveSpooledUpdateRetryDelayMs(update, now = Date.now()) {
	...
	if (!update.lastError || update.lastAttemptAt === void 0 || attempts <= 0) return 0;
	const exponent = Math.min(attempts - 1, 8);
	const delayMs = Math.min(TELEGRAM_SPOOLED_RETRY_MAX_MS, TELEGRAM_SPOOLED_RETRY_BASE_MS * 2 ** exponent);
	return Math.max(0, update.lastAttemptAt + delayMs - now);
}
function resolveSpooledUpdateAttemptNumber(update) {
...
function shouldDeadLetterRetryableSpooledUpdate(update, attempt, now = Date.now()) {
	return attempt >= 8 && now - update.receivedAt >= 864e5;
}
//#endregion
...
const createTelegramMessageProcessor = (deps) => {
	...
	return async (primaryCtx, allMedia, storeAllowFrom, options, replyMedia, replyChain, promptContext, lifecycle) => {
		...
		if (!spooledReplay) await lifecycle?.onDispatchStart?.();
		...
		if (spooledReplay) {
			...
			const settle = async (result, phase) => {
				...
				settlement = (async () => {
					let finalized;
					try {
						finalized = lifecycle?.finalizeSpooledReplayResult ? await lifecycle.finalizeSpooledReplayResult(result, phase) : result;
					} catch (error) {
						finalized = {
							kind: "failed-retryable",
							error
			...
			const run = async () => {
				const turnAbortSignal = lifecycle?.spooledReplayAbortSignal ? AbortSignal.any([participant.abortSignal, lifecycle.spooledReplayAbortSignal]) : participant.abortSignal;
				...
				if (adoptionAttempted && !deferred && result.kind === "completed") {
					...
					while (!turnAbortSignal.aborted) {
						retryAttempt += 1;
						try {
							const completed = await lifecycle?.completeSpooledReplayAfterIrrevocableAdoption?.(retryError) ?? { kind: "completed" };
...
function createTelegramBotCore(opts) {
	...
	const botHistorySender = buildTelegramGroupHistorySelfSender(account.name ?? opts.botInfo?.first_name ?? opts.botInfo?.username ?? "OpenClaw");
...
const TELEGRAM_SPOOLED_UPDATE_CLAIM_LEASE_MS = 1800 * 1e3;
...
var TelegramSpooledUpdateCompletionOwnershipError = class extends Error {
...
function isFreshClaimOwner(claim, options) {
	...
	const maxAgeMs = options?.maxAgeMs ?? 216e5;
...
function spooledUpdateLaneKey(update, botInfo) {
...
function isTelegramSpooledUpdateClaimOwnedByOtherLiveProcess(claim, options) {
	return Boolean(claim.claim && claim.claim.processId !== TELEGRAM_SPOOLED_UPDATE_PROCESS_ID && claim.claim.processPid !== process.pid && isFreshClaimOwner(claim.claim, options) && processExists(claim.claim.processPid));
}
...
async function completeTelegramSpooledUpdate(update) {
	return await createTelegramIngressQueue(path.dirname(update.path)).complete(queueMutationTarget(update));
}
async function completeTelegramSpooledUpdateWithRetry(params) {
	if (!params.update.claim?.claimToken) throw new TelegramSpooledUpdateCompletionOwnershipError(params.update.updateId);
	let attempt = 0;
	while (true) try {
		if (!await completeTelegramSpooledUpdate(params.update)) throw new TelegramSpooledUpdateCompletionOwnershipError(params.update.updateId);
		return;
	} catch (err) {
		if (err instanceof TelegramSpooledUpdateCompletionOwnershipError || params.abortSignal?.aborted) throw err;
		attempt += 1;
...
async function claimNextTelegramSpooledUpdate(params) {
	const queue = createTelegramIngressQueue(params.spoolDir);
	const claimed = await queue.claimNext({
		ownerId: TELEGRAM_SPOOLED_UPDATE_PROCESS_ID,
		blockedLaneKeys: params.blockedLaneKeys,
		...params.candidateUpdateIds === void 0 ? {} : { candidateIds: [...params.candidateUpdateIds].map(queueEventId) },
		orderBy: "id",
...
//#endregion
export { shouldDeadLetterRetryableSpooledUpdate as _, isTelegramSpooledUpdateClaimOwnedByOtherLiveProcess as a, getTelegramSequentialKey as b, recoverStaleTelegramSpooledUpdateClaims as c, resolveTelegramIngressSpoolDir as d, writeTelegramSpooledUpdate as f, resolveSpooledUpdateRetryDelayMs as g, resolveSpooledUpdateAttemptNumber as h, failTelegramSpooledUpdateClaim as i, refreshTelegramSpooledUpdateClaim as l, resolveNonRetryableSpooledUpdateFailure as m, claimNextTelegramSpooledUpdate as n, listTelegramSpooledUpdateClaims as o, createTelegramBot as p, completeTelegramSpooledUpdateWithRetry as r, listTelegramSpooledUpdates as s, TELEGRAM_SPOOLED_UPDATE_CLAIM_LEASE_MS as t, releaseTelegramSpooledUpdateClaim as u, buildTelegramReplyFenceLaneKey as v, runWithTelegramSpooledReplayUpdate as x, supersedeTelegramReplyFenceLane as y };
