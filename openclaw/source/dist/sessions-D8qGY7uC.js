...
import { D as resolveIntegerOption, j as resolveTimerTimeoutMs, y as parseStrictNonNegativeInteger } from "./number-coercion-CJQ8TR--.js";
...
import { t as extractArchive } from "./archive-CR1500gV.js";
...
import { a as installOpenClawInternalCorePackageNativeResolver } from "./plugin-module-loader-cache-uqaaAPup.js";
import { n as buildPluginLoaderJitiOptions, t as buildPluginLoaderAliasMap } from "./sdk-alias-BJSUcD8n.js";
...
import { a as resetOAuthProviders, i as registerOAuthProvider, n as getOAuthProvider, r as getOAuthProviders, t as getOAuthApiKey } from "./oauth-BcZS_BvC.js";
import { t as resolveModelPluginMetadataSnapshot } from "./model-discovery-context-CGsvD_zb.js";
...
import { t as attachRuntimeUserTurnTranscriptContext } from "./user-turn-transcript-runtime-context-SnEnlher.js";
import { A as getLastAssistantUsage, C as calculateContextTokens, D as findCutPoint, E as estimateTokens, H as convertToLlm, M as shouldCompact, N as serializeConversation, O as findTurnStartIndex, S as DEFAULT_COMPACTION_SETTINGS, T as estimateContextTokens, _ as substituteArgs, a as formatSize, b as generateBranchSummary$1, c as truncateTail, g as parseCommandArgs, j as prepareCompaction$1, k as generateSummary$1, n as DEFAULT_MAX_BYTES, o as truncateHead, r as DEFAULT_MAX_LINES, s as truncateLine, w as compact$1, x as prepareBranchEntries, y as collectEntriesForBranchSummaryFromBranches } from "./proxy-BzhBz8iM.js";
import { l as llm_exports } from "./llm-CjsEPovZ.js";
import { a as getLatestCompactionEntry, c as parseSessionEntries, d as Agent, f as openClawAgentCoreRuntime, i as getDefaultSessionDir, n as buildSessionContext, o as loadEntriesFromFile, p as runtime_exports, r as findMostRecentSession, s as migrateSessionEntries, t as SessionManager } from "./session-manager-BC-U4J87.js";
import { t as extractFrontmatterBlock } from "./frontmatter-WnMmgZSx.js";
import { a as killProcessTree$1, i as getShellEnv, n as getBashShellConfig, o as sanitizeBinaryOutput } from "./shell-utils-D5xjUWUG.js";
import { G as isLocalPath, U as canonicalizePath, W as formatPathRelativeToCwdOrAbsolute, o as getArchivedSkillFiles } from "./curator-pEgKwBNc.js";
import { i as createSyntheticSourceInfo, n as formatSkillsForPrompt$1, r as createSourceInfo, t as computeSkillPromptVersion } from "./skill-version-YDIGwQgq.js";
import { t as decodeHtmlEntityAt } from "./html-EjwcqQaW.js";
import "./common-DWyiui3y.js";
import { c as convertImageToPng, f as isImageProcessorUnavailableError, l as createImageProcessor } from "./media-services-n09-22kU.js";
...
import { n as appendBoundedTextTail, r as normalizePositiveLimit } from "./limits-BHHfzS4A.js";
import { n as classifyMediaReferenceSource, o as resolveMediaReferenceLocalPath, r as normalizeMediaReferenceSource } from "./media-reference-Cswh9n78.js";
...
import { clampThinkingLevel, cleanupSessionResources, defaultApiRegistry, findEnvKeys, getEnvApiKey, getSupportedThinkingLevels, isContextOverflow, modelsAreEqual, registerApiProvider } from "@openclaw/ai/internal/runtime";
...
async function executeBashWithOperations(command, cwd, operations, options) {
	...
	const onData = (data) => {
		...
		const text = sanitizeBinaryOutput(stripAnsiSequences(decoder.decode(data, { stream: true }))).replace(/\r/g, "");
...
function matchesAnyPattern(filePath, patterns, baseDir) {
	...
	const parentRel = isSkillFile ? toPosixPath(relative(baseDir, parentDir)) : void 0;
...
function getTextOutput(result, showImages) {
	...
	let output = textBlocks.map((c) => sanitizeBinaryOutput(stripAnsiSequences(c.text || "")).replace(/\r/g, "")).join("\n");
	...
	return { exec: (command, cwd, { onData, signal, timeout, env }) => {
		return new Promise((resolve, reject) => {
			...
			if (timeoutMs !== void 0) timeoutHandle = setTimeout(() => {
				timedOut = true;
				if (child.pid) killProcessTree$1(child.pid);
			}, timeoutMs);
			child.stdout?.on("data", onData);
			child.stderr?.on("data", onData);
			const onAbort = () => {
...
function truncateCandidateText(text, maxChars) {
	...
	const cut = maxChars > 0 && /[\uD800-\uDBFF]/.test(text[maxChars - 1]) && /[\uDC00-\uDFFF]/.test(text[maxChars]) ? maxChars - 1 : maxChars;
...
function firstDifferenceIndex(left, right) {
	...
	for (let index = 0; index < sharedLength; index++) if (left[index] !== right[index]) return index;
				...
				(async () => {
					try {
						...
						const onStreamError = (stream, error) => {
							...
							stopChild();
							cleanup();
							settle(() => reject(/* @__PURE__ */ new Error(`ripgrep ${stream} error: ${error.message}`)));
						};
						rl.on("error", (error) => onStreamError("stdout", error));
						child.stdout?.on("error", (error) => onStreamError("stdout", error));
						child.stderr?.on("error", (error) => onStreamError("stderr", error));
...
async function resizeImage(img, options) {
	...
	try {
		...
		const qualitySteps = Array.from(/* @__PURE__ */ new Set([
			opts.jpegQuality,
			85,
			70,
			55,
