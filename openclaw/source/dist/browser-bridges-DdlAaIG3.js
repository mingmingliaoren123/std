...
import { o as PATH_ALIAS_POLICIES } from "./secure-temp-dir-DMUMnweR.js";
...
import { r as loadActivatedBundledPluginPublicSurfaceModuleSync } from "./facade-runtime-Dce8fe3v.js";
import { i as resolveSandboxConfigForAgent } from "./config-Dy4vED5-.js";
import { t as sanitizeEnvVars } from "./sanitize-env-vars-CequRb6L.js";
...
import { t as buildDockerExecArgs } from "./bash-tools.shared-B6kKIpaT.js";
import { a as execDocker, b as isExistingWorkspaceSkillMountSource, i as ensureSandboxContainer, n as dockerContainerState, o as execDockerRaw, x as resolveMaterializedSandboxSkillsWorkspaceDir } from "./docker-Hq4HIYYD.js";
import { t as parseSshTarget } from "./ssh-tunnel-VTqdtZU2.js";
...
async function runSshSandboxCommand(params) {
	...
	return await new Promise((resolve, reject) => {
		...
		const stderrChunks = [];
		let settled = false;
		const finish = (complete, terminate = false) => {
			if (settled) return;
			settled = true;
			if (terminate) try {
				child.kill("SIGKILL");
