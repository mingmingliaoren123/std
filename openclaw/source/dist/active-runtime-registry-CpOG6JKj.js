...
import { c as resolveCompatibleRuntimePluginRegistry } from "./loader-D8d2EvVh.js";
import { c as getActivePluginRegistry, d as getActivePluginRegistryWorkspaceDir, n as getActivePluginChannelRegistry, o as getActivePluginHttpRouteRegistry, t as collectLivePluginRegistries } from "./runtime-D0xGMZdc.js";
...
function listLoadedRuntimePluginIdsAcrossSurfaces() {
	const loaded = [];
	for (const registry of collectLivePluginRegistries()) for (const plugin of registry.plugins ?? []) if (plugin.status === "loaded") loaded.push(plugin.id);
