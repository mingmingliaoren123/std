...
import { l as sanitizeSystemRunEnvOverrides, s as sanitizeHostExecEnv, t as inspectHostExecEnvOverrides } from "./host-env-security-CWC2ZCy4.js";
...
import { r as resolveNodeProgramArguments } from "./program-args-CIpsLD1g.js";
import { u as buildNodeServiceEnvironment } from "./runtime-paths-C6MOwQ_j.js";
...
import { n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-DqkY2Emy.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CHOL1Kuf.js";
import { c as decodeWindowsOutputBuffer, u as resolveWindowsConsoleEncoding } from "./windows-command-C7JEh9zV.js";
import { a as logWarn } from "./logger-D7QYAmug.js";
import { i as getRuntimeConfig } from "./io-By0s-a_s.js";
import { _ as resolveExecutableFromPathEnv, a as resolveApprovalAuditTrustPath, s as resolveCommandResolutionFromArgv } from "./exec-command-resolution-C_2dHW1t.js";
import { N as splitShellArgs, T as unwrapKnownDispatchWrapperInvocation, d as unwrapKnownShellMultiplexerInvocation, f as POSIX_INLINE_COMMAND_FLAGS, i as extractShellWrapperCommand, j as normalizeExecutableToken, l as isShellWrapperInvocation, p as advancePosixInlineOptionScan, s as isBlockedShellWrapperCommand, t as POSIX_SHELL_WRAPPERS, u as resolveShellWrapperTransportArgv, x as extractEnvAssignmentKeysFromDispatchWrappers, y as resolveInlineCommandMatch } from "./shell-wrapper-resolution-Cy6xKD1y.js";
import "./config-DbyjySSE.js";
import { n as formatInvalidConfigPort, r as formatInvalidPortOption } from "./error-format-CcGxQmmN.js";
import { n as buildPlatformServiceStartHints, r as formatRuntimeStatus, t as buildPlatformRuntimeLogHints } from "./runtime-hints-DSBgVfIl.js";
import { d as resolveRuntimeStatusColor, g as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-Kqh8mCNa.js";
...
import { r as loadOrCreateDeviceIdentity } from "./device-identity-UW4cZXf5.js";
...
import { i as runServiceUninstall, n as runServiceStart, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-CHGbLltq.js";
...
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-BXwdBwWP.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-DeftfIPV.js";
import { t as formatHelpExamples } from "./help-format-CAcwboTs.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-DLqs95m8.js";
...
import { c as normalizeSystemRunApprovalPlan, n as formatExecCommand, r as resolveSystemRunCommandRequest } from "./system-run-command-Bd_agqvl.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-jZ1Rj9dH.js";
...
async function resolveSystemRunAutoReviewer(params) {
	...
	const { createModelExecAutoReviewer } = await import("./exec-auto-reviewer-CrLlhaa2.js");
...
const loadPluginRegistryLoaderModule = createLazyRuntimeModule(() => import("./runtime-registry-loader-d7xui8oD.js"));
...
const STREAM_ERROR_KILL_GRACE_MS = 1e3;
...
async function runCommand(argv, cwd, env, timeoutMs) {
	return await new Promise((resolve) => {
		...
		const finalize = (exitCode, error) => {
			...
			if (streamKillTimer) clearTimeout(streamKillTimer);
		...
		child.on("error", (err) => {
			if (!streamError) finalize(void 0, err.message);
		});
		child.on("exit", (code) => {
			finalize(code === null ? void 0 : code, streamError?.message ?? null);
		});
	});
}
...
async function runNodeHost(opts) {
	...
	const url = `${gateway.tls ? "wss" : "ws"}://${host}:${port}${gateway.contextPath ? gateway.contextPath.startsWith("/") ? gateway.contextPath : `/${gateway.contextPath}` : ""}`;
