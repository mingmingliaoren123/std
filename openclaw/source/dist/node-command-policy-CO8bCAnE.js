...
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, r as NODE_SYSTEM_NOTIFY_COMMAND, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-SnI8Vs7F.js";
...
function filterLegacyNodeProtocolFeatures(params) {
	...
	const pluginCommands = /* @__PURE__ */ new Set([...registry.nodeHostCommands.map((entry) => entry.command.command), ...registry.nodeInvokePolicies.flatMap((entry) => entry.policy.commands)]);
	return {
...
//#endregion
export { listDangerousPluginNodeCommands as a, resolveNodePairingCommandAllowlist as c, isNodeCommandAllowed as i, filterLegacyNodeProtocolFeatures as n, normalizeDeclaredNodeCommands as o, isForegroundRestrictedPluginNodeCommand as r, resolveNodeCommandAllowlist as s, DEFAULT_DANGEROUS_NODE_COMMANDS as t };
