...
import { c as tryReadJsonSync } from "./json-CI_xQ2Rw.js";
...
import { l as listManagedPluginNpmRootsSync, r as hasRetainedManagedNpmInstallMarker } from "./managed-npm-retention-BTuFzcN9.js";
...
import { n as saveJsonFile } from "./json-file-BDBAJUrO.js";
import { i as preflightPluginRegistryInstallMigration, r as migratePluginRegistryForInstall, t as DISABLE_PLUGIN_REGISTRY_MIGRATION_ENV } from "./plugin-registry-migration-dr1xeVEY.js";
import { t as note } from "./note-w8AYQ4sA.js";
import { i as relinkOpenClawPeerDependenciesInManagedNpmRoot, t as auditOpenClawPeerDependenciesInManagedNpmRoot } from "./plugin-peer-link-Bhv-93F0.js";
import { t as listStaleLocalBundledPluginInstallRecords } from "./stale-local-bundled-plugin-install-records-13UglGrv.js";
...
async function listManagedNpmOpenClawPeerLinkIssues(params) {
	return (await Promise.all(listManagedPluginNpmRoots(params).map((npmRoot) => auditOpenClawPeerDependenciesInManagedNpmRoot({ npmRoot })))).flatMap((audit) => audit.issues);
}
async function detectPluginRegistryHealthIssues(params) {
	...
	for (const issue of await listManagedNpmOpenClawPeerLinkIssues(params)) issues.push({
