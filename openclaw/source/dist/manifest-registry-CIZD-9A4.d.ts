...
type PluginManifest = {
   ...
   */
  providerAuthEnvVars?: Record<string, string[]>; /** Usage/billing credentials excluded from inference auth but included in secret scrubbing. */
...
type PluginManifestContracts = {
  ...
  webSearchProviders?: string[]; /** Provider ids whose plugin owns usage auth and snapshot hooks. */
