...
import { r as readTrimmedStringAlias } from "./string-readers-CSYBg7vj.js";
import { a as shouldAttemptTtsPayload } from "./gateway-startup-speech-providers-tDMeTcRJ.js";
import { a as actionHasTarget, c as hasPotentialPluginActionParam, o as actionRequiresTarget, r as applyTargetToParams, s as resolveActionDeliveryTargetAlias } from "./channel-target-BBHWW9s4.js";
...
import { C as readSnakeCaseParamRaw, _ as readStringArrayParam, h as readPositiveIntegerParam, y as readStringParam } from "./common-DWyiui3y.js";
...
import { n as resolveAgentIdentity, s as resolveResponsePrefix } from "./identity-BfKoTsep.js";
import { a as hasReplyPayloadContent, c as normalizeInteractiveReply, l as normalizeMessagePresentation, n as hasMessagePresentationBlocks, t as hasInteractiveReplyBlocks } from "./payload-C0zJd_02.js";
import { n as resolveResponsePrefixTemplate } from "./response-prefix-template-8HUl4fLP.js";
import { i as throwIfAborted } from "./deliver-BdKtkX_b.js";
import { t as resolveAgentScopedOutboundMediaAccess } from "./read-capability-Dlt50S9s.js";
...
import { u as stripUnsupportedCitationControlMarkers } from "./payloads-DYHv5qoG.js";
import { r as resolvePollMaxSelections } from "./polls-C-v11_tu.js";
import { n as listConfiguredMessageChannels, r as resolveMessageChannelSelection } from "./channel-selection-Cwt1Az-g.js";
import { n as sendPoll, r as resolveOutboundMessageGatewayOptions, t as sendMessage } from "./message-CL9AKxEF.js";
import { n as resolveOutboundSessionRoute, t as ensureOutboundSessionEntry } from "./outbound-session-O8lUNz7d.js";
import { a as normalizeSandboxMediaParams, c as readBooleanParam, i as normalizeSandboxMediaList, l as resolveAttachmentMediaPolicy, n as collectActionMediaSourceHints, o as parseInteractiveParam, r as hydrateAttachmentParamsForAction, s as parseJsonMessageParam, t as dispatchChannelMessageAction, u as resolveExtraActionMediaSourceParamKeys } from "./message-action-dispatch-CZZYL7XG.js";
...
import { t as shouldUseInternalSourceReplySink } from "./internal-source-reply-5W96dkUY.js";
import { i as enforceMessageActionAllowlist, n as buildCrossContextDecoration, o as resolveEffectiveMessageToolsConfig, r as enforceCrossContextPolicy, s as shouldApplyCrossContextMarker, t as applyCrossContextDecoration } from "./outbound-policy-CfXcSEaQ.js";
...
function normalizeMessageActionInput(params) {
	...
	if (!explicitTarget && !hasLegacyTarget && !deliveryAliasTarget && actionRequiresTarget(action) && !actionHasTarget(action, normalizedArgs, { channel: inferredChannel })) {
...
async function callGatewayMessageAction(params) {
	...
	if (!(isTrustedBackendBridge && (requesterAccountId !== void 0 || requesterSenderId !== void 0 || params.actionParams.senderIsOwner !== void 0))) return await callGatewayLeastPrivilege(callParams);
