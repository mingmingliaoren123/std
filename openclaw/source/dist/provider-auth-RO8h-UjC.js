...
import "./ref-contract-oqYbBqsB.js";
...
import { n as saveJsonFile, t as loadJsonFile } from "./json-file-BDBAJUrO.js";
import "./cli-credentials-B074Y7I_.js";
import "./credential-state-BY-oz-QV.js";
import { l as loadAuthProfileStoreForSecretsRuntime, n as ensureAuthProfileStore, u as loadAuthProfileStoreWithoutExternalProfiles } from "./store-DH33UrUj.js";
...
import "./model-auth-markers-BY1lCZu4.js";
import { t as resolveEnvApiKey } from "./model-auth-env-DcJ_tp8n.js";
import "./models-config.providers.secrets-BAADHA8z.js";
import "./provider-model-shared-BK8T_tBM.js";
import "./provider-auth-input-D7tUZxiJ.js";
import "./provider-auth-helpers-BsZMtsg2.js";
import "./provider-api-key-auth-C_L0bVjH.js";
import "./agent-dir-compat-B8IvuFr4.js";
import "./provider-auth-result-oIDRHfCs.js";
...
async function resolveCopilotApiToken(params) {
	...
	const json = parseCopilotTokenResponse(await readProviderJsonResponse(res, "github-copilot.token"));
	const payload = {
		token: json.token,
