...
import { r as stripAnsi$1, s as visibleWidth } from "./ansi-D1GK_odF.js";
...
import { c as registerUncaughtExceptionHandler } from "./unhandled-rejections-CXDw1wVg.js";
...
import { s as setConsoleSubsystemFilter } from "./console-DDSYsaep.js";
import { t as modelKey } from "./model-key-BaNhQShd.js";
import { l as resolveAgentIdByWorkspacePath } from "./agent-scope-B2Pk_xhT.js";
import { c as parseAgentSessionKey } from "./session-key-utils-A-JGvyXu.js";
import { d as normalizeMainKey, i as buildAgentMainSessionKey, r as agentSessionKeysMatchByRequestKey, u as normalizeAgentId } from "./session-key-VWT_xzM9.js";
...
import { n as isWindowsBatchCommand, r as resolveTrustedWindowsCmdExe, t as buildWindowsCmdExeCommandLine } from "./windows-command-C7JEh9zV.js";
import { i as isLoopbackHost } from "./net-BOKtNTf8.js";
import { i as getRuntimeConfig } from "./io-By0s-a_s.js";
import { r as listThinkingLevelLabels, t as formatThinkingLevels } from "./thinking-CSA4xwds.js";
...
import { m as isAuthErrorMessage } from "./sanitize-user-facing-text-D-sR-1VY.js";
import { i as classifyFailoverReason } from "./errors-XbAR6hS3.js";
import { i as stripLeadingInboundMetadata } from "./strip-inbound-meta-DMvJPx9F.js";
import { n as shouldForwardModelCommandToServer } from "./commands-registry.data-BKgJ3WoC.js";
import { n as listChatCommands, r as listChatCommandsForConfig } from "./commands-registry-list-BkGxvhVW.js";
import { i as resolveTextCommand } from "./commands-registry-normalize-BqAsVMiS.js";
...
import "./usage-format-DmMxCR4E.js";
...
import { a as parseGoalCommand, n as formatGoalResumeContinuationPrompt, t as formatGoalContinuationPrompt } from "./commands-goal-Fg-ONVEj.js";
...
const COMMAND_ALIASES = { gwstatus: "gateway-status" };
...
function extractUrls(markdown) {
	...
	let m;
	while ((m = mdLinkRe.exec(markdown)) !== null) if (hasUrlContent(m[1])) urls.add(m[1]);
...
function createEventHandlers(context) {
	...
	const drainHistoryReloadQueue = () => {
		...
		loadHistory().then(finishReload, () => finishReload({ loaded: false })).finally(() => {
	...
	const collectTrackedSessionRunIds = () => {
		...
		if (state.pendingChatRunId) runIds.add(state.pendingChatRunId);
	...
	const handleSessionsChangedEvent = (payload) => {
		...
		else if (loadHistory) loadHistory();
		else refreshSessionInfo?.();
		tui.requestRender();
	};
...
async function runTui(opts) {
	...
	if (opts.backend) client = opts.backend;
		...
		const { EmbeddedTuiBackend } = await import("./embedded-backend-DungnrvS.js");
		client = new EmbeddedTuiBackend();
	} else {
		const { GatewayChatClient } = await import("./gateway-chat-BW6uyvQL.js");
