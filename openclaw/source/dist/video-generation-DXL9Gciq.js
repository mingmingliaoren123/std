...
import { a as fetchProviderOperationResponse, c as postJsonRequest, g as waitProviderOperationPollInterval, h as resolveProviderOperationTimeoutMs, i as fetchProviderDownloadResponse, n as createProviderOperationDeadline, r as createProviderOperationTimeoutResolver } from "./shared-CFpa8hBG.js";
...
async function pollDashscopeVideoTaskUntilComplete(params) {
	...
	for (let attempt = 0; attempt < DEFAULT_VIDEO_GENERATION_MAX_POLL_ATTEMPTS; attempt += 1) {
		const payload = await readProviderJsonResponse(await fetchProviderOperationResponse({
			stage: "poll",
