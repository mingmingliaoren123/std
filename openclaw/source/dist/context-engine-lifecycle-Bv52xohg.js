...
import { a as failTaskRunByRunId, d as startTaskRunByRunId, l as recordTaskRunProgressByRunId, n as completeTaskRunByRunId, r as createQueuedTaskRun, u as setDetachedTaskDeliveryStatusByRunId } from "./detached-task-runtime-B93mVzDV.js";
import { f as isGatewayDraining, i as enqueueCommandInLane, n as GatewayDrainingError } from "./command-queue-DqzpsN4m.js";
import { n as OPENCLAW_EMBEDDED_CONTEXT_ENGINE_HOST } from "./host-compat-BibWlia2.js";
import { t as log$1 } from "./logger-rC_P-huq.js";
import { u as findActiveSessionTask } from "./openclaw-tools-KulZ1cdH.js";
import { c as updateTaskNotifyPolicyForOwner, i as findTaskByRunIdForOwner, n as cancelTaskByIdForOwner } from "./task-owner-access-BwV5KyRM.js";
import { r as runAgentHarnessAgentEndHook, t as awaitAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-BwL6869q.js";
import { n as rewriteTranscriptEntriesInSessionManager, t as rewriteTranscriptEntriesInRuntimeTranscript } from "./transcript-rewrite-BHL7q_3D.js";
import { m as resolveContextEngineCapabilities, n as buildAfterTurnRuntimeContextFromUsage, t as buildAfterTurnRuntimeContext } from "./attempt.prompt-helpers-kaS3UZwL.js";
...
async function runCoreAgentEndSideEffects(params) {
	try {
		const { runSkillResearchAutoCapture } = await import("./autocapture-DNUmJzcK.js");
