...
function listDirectoryUserEntriesFromAllowFrom(params) {
	return toDirectoryEntries("user", applyDirectoryQueryAndLimit(uniqueStrings(collectDirectoryIdsFromEntries({
...
function listDirectoryGroupEntriesFromMapKeys(params) {
	return toDirectoryEntries("group", applyDirectoryQueryAndLimit(uniqueStrings(collectDirectoryIdsFromMapKeys({
