...
const providerIndexCatalogLoader = createLazyImportLoader(() => import("./list.provider-index-catalog-LabuY3uI.js"));
...
async function planAllModelListSources(params) {
	...
	const manifestCatalog = await import("./list.manifest-catalog-BhiN5qM_.js");
	...
	const providerCatalog = await import("./list.provider-catalog-CdKn3htw.js");
