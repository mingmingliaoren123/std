...
import { f as normalizeResolvedSecretInputString, s as coerceSecretRef } from "./types.secrets-OocW4TQ1.js";
...
import { o as isPrivateNetworkOptInEnabled, u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-DKsCBaFj.js";
import "./ssrf-runtime-DBG77fRY.js";
import "./retry-runtime-CJkaTZLp.js";
import "./secret-input-runtime-xkRVB7Yb.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-DRNO1z0M.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-DG7lxLuT.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-63kzmTw0.js";
...
import { s as repairCurrentTokenStorageMetaDeviceId } from "./storage-BJVR5fTf.js";
//#region extensions/matrix/src/matrix/client/config.ts
const loadDefaultMatrixAuthClientDeps = createLazyRuntimeModule(() => Promise.all([import("./sdk-DuxEPAIQ.js"), import("./logging-DoZa7r7a.js")]).then(([sdkModule, loggingModule]) => ({
...
const loadMatrixCredentialsReadDeps = createLazyRuntimeModule(() => import("./credentials-read-C2Rnycqb.js").then((credentialsReadModule) => ({
