...
import { a as oauthErrorHtml, c as resolveOAuthTokenExpiresAt, d as withOAuthLoginAbort, i as generatePKCE, l as resolveOAuthTokenLifetimeMs, n as createOAuthLoginCancelledError, o as oauthSuccessHtml, s as parseOAuthAuthorizationInput, u as throwIfOAuthLoginAborted } from "./provider-oauth-runtime-Bl5CxvHn.js";
...
const loadNodeOAuthModules = createLazyRuntimeModule(() => Promise.all([import("node:crypto"), import("node:http")]).then(([cryptoModule, httpModule]) => ({
