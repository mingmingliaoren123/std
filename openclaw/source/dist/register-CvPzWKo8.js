...
import { c as isRecord$2 } from "./utils-CRO4LGEB.js";
...
function pushNestedRequireMentionIngress(entries, params, containerKey, groupId, config, parentSourceBase) {
	...
	for (const nestedKey of ["channels", "topics"]) {
		...
		for (const [nestedId, nestedConfig] of Object.entries(nested)) if (isRecord$2(nestedConfig)) pushNestedRequireMentionIngress(entries, params, `${containerKey}/${ocPathSegment$1(groupId)}/${nestedKey}`, nestedId, nestedConfig, parentSourceBase);
	}
}
...
//#endregion
export { createPolicyAttestation as a, POLICY_RULE_METADATA as c, isPolicyValueAtLeastAsStrict as i, policyContainerShapeFindings as n, POLICY_FIX_METADATA_BY_CHECK_ID as o, registerPolicyDoctorChecks as r, POLICY_CHECK_IDS as s, evaluatePolicy as t };
