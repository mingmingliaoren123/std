...
import { f as saveMediaStream } from "./store-VcV5Hs9C.js";
import { i as shouldComputeCommandAuthorized } from "./command-detection-DeOEqON9.js";
...
import { r as chunkMarkdownText } from "./chunk-eqDomQ-g.js";
...
import { r as formatInboundEnvelope } from "./envelope-CXHEh-mU.js";
import { T as formatInboundMediaUnavailableText, h as hasFinalChannelTurnDispatch } from "./kernel-BMsNZe7F.js";
...
import { c as createMessageReceiveContext } from "./channel-outbound-DkdAAOhG.js";
...
import { t as resolvePairingIdLabel } from "./pairing-labels-BwfwTVGY.js";
import "./command-auth-native-TscOJc1_.js";
import { a as resolveInboundSessionEnvelopeContext, o as formatLocationText, s as toLocationContext } from "./channel-inbound-CxUVIreR.js";
...
import { a as createWebhookInFlightLimiter, i as beginWebhookRequestPipelineOrReject } from "./webhook-request-guards-6tg5xzrX.js";
import "./webhook-ingress-D6RzsqkF.js";
import { t as normalizeWebhookPath } from "./webhook-path-CaYfbDPb.js";
import { i as resolveSingleWebhookTarget, n as registerWebhookTargetWithPluginRoute } from "./webhook-targets-Cf7M1LLA.js";
import { i as resolveLineAccount, r as resolveDefaultLineAccountId } from "./accounts-BvFifmQq.js";
import { a as resolveLineGroupConfigEntry, n as getLineRuntime, t as buildLineQuickReplyFallbackText } from "./quick-reply-fallback-VCZ5100X.js";
import { a as buildPath, i as mergeHeaders, n as HTTPFetchClient, r as convertResponseToReadable } from "./messagingApiClient-BSDrulNf.js";
import { D as showLoadingAnimation, S as pushMessagesLine, T as replyMessageLine, c as processLineMessage, d as createImageMessage, f as createLocationMessage, g as getUserDisplayName, k as buildTemplateMessageFromPayload, m as createTextMessageWithQuickReplies, p as createQuickReplyItems, u as createFlexMessage, w as pushTextMessageWithQuickReplies, x as pushMessageLine } from "./markdown-to-line-D9CFAu-p.js";
...
async function downloadLineMedia(messageId, channelAccessToken, maxBytes = 10 * 1024 * 1024, options) {
	const saved = await saveMediaStream(await new MessagingApiBlobClient({ channelAccessToken }).getMessageContent(messageId), void 0, "inbound", maxBytes, options?.originalFilename);
...
async function buildLineMessageContext(params) {
	...
	if (!agentBody && allMedia.length === 0) return null;
	let locationContext;
	if (message.type === "location") {
		const loc = message;
