...
import { t as MarkdownIt } from "./markdown-it-B522lOVW.js";
...
import { t as require_src } from "./src-CjxQVw_v.js";
...
import { r as normalizeMatrixResolvableTarget, t as isMatrixQualifiedUserId } from "./target-ids-DCrsDJYP.js";
import { r as buildMatrixReactionContent } from "./reaction-common-D0UmhOpL.js";
import { a as EventType, c as MsgType, l as RelationType, n as persistMatrixDirectRoomMapping, s as MSC4357_LIVE_KEY, t as inspectMatrixDirectRooms } from "./direct-management-DLELJZi1.js";
...
import { t as APEv2Parser } from "./APEv2Parser-D_lAUbMN.js";
import { r as hasID3v1Header } from "./ID3v1Parser-rlttYuy2.js";
...
const loadMatrixSendClientRuntime = createLazyRuntimeModule(() => import("./client-bootstrap-B2kps71F.js"));
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-fj18iVR5.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-Bg0yoiat.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-U6yxNhCE.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-zTA_TCS-.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser--y65K5IO.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-BvEjQ9HE.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-DsfWVAcY.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-DQh7nRsd.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-B6GBa6bh.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-D6J89FEX.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-CIR_BF7m.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-B-PbOsNX.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-Bq6pkr2t.js")).WaveParser;
	}
};
//#endregion
