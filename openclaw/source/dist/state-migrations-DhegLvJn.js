...
import { o as resolveRequiredHomeDir, t as expandHomePrefix } from "./home-dir-CJKEsOtx.js";
import { g as resolveOAuthDir, h as resolveNewStateDir, m as resolveLegacyStateDirs, v as resolveStateDir } from "./paths-BMBAvkNf.js";
import { c as isWithinDir } from "./path-DILYn_gk.js";
import { t as sameFileIdentity } from "./file-identity-C0fBiekR.js";
import { n as assertNoSymlinkParentsSync } from "./symlink-parents-D3bl9xr3.js";
...
import { _ as executeSqliteQueryTakeFirstSync, a as repairOpenClawStateDatabaseSchema, g as executeSqliteQuerySync, l as resolveOpenClawStateSqlitePath, m as requireNodeSqlite, o as runOpenClawStateWriteTransaction, r as detectOpenClawStateDatabaseSchemaMigrations, v as getNodeSqliteKysely } from "./openclaw-state-db-DzSsA9Ji.js";
import { s as resolveLegacyInstalledPluginIndexStorePath } from "./installed-plugin-index-record-reader-Dd35fnKn.js";
import "./agent-scope-B2Pk_xhT.js";
import { c as parseAgentSessionKey, o as normalizeSessionKeyPreservingOpaquePeerIds } from "./session-key-utils-A-JGvyXu.js";
import { d as normalizeMainKey, i as buildAgentMainSessionKey, l as isValidAgentId, n as DEFAULT_MAIN_KEY, p as resolveAgentIdFromSessionKey, t as DEFAULT_AGENT_ID, u as normalizeAgentId } from "./session-key-VWT_xzM9.js";
import { c as resolveDefaultAgentId } from "./agent-scope-config-BxAUeF6t.js";
import "./installed-plugin-index-N4jxqS0-.js";
import { c as writePersistedInstalledPluginIndexSync, i as readPersistedInstalledPluginIndexSync, n as parseInstalledPluginIndex } from "./installed-plugin-index-store-CWgFGnm0.js";
import "./fs-safe-advanced-CBe_wA_B.js";
import { c as listBundledChannelLegacySessionSurfaces, l as listBundledChannelLegacyStateMigrationDetectors } from "./bundled-ClxzUaje.js";
import { i as MAX_PLUGIN_STATE_ENTRIES_PER_PLUGIN, n as createPluginStateKeyedStore, o as countPluginStateLiveEntries } from "./plugin-state-store-i0oVFZ17.js";
import { n as canonicalizeMainSessionAlias } from "./main-session-D7Jmp9DO.js";
import { g as saveSessionStore, k as normalizePersistedSessionEntryShape } from "./store-BJJhlPrk.js";
import { r as resolveAllAgentSessionStoreTargetsSync, t as listConfiguredSessionStoreAgentIds } from "./targets-ChErRWTQ.js";
import { n as normalizeConversationRef } from "./session-binding-normalization-sQL-8bRz.js";
import { s as writeAcpSessionMetaForMigration } from "./session-meta-e1OOAdtW.js";
import "./sessions-oDygYVdy.js";
import { n as collectRelevantDoctorPluginIds, o as listPluginDoctorSessionStoreAgentIds, s as listPluginDoctorStateMigrationEntries } from "./doctor-contract-registry-BPAi19gj.js";
import { n as normalizeVoiceWakeRoutingConfig } from "./voicewake-routing-D1sSmmLl.js";
...
async function migrateLegacyInstalledPluginIndex(params) {
	...
	if (current && !legacyInstalledPluginIndexMatches(current, legacy)) {
		...
		if (merged.conflicts.length > 0) return {
			changes,
			warnings: [],
			notices: [`Left plugin install index in place because shared SQLite state has conflicting plugin install metadata for: ${merged.conflicts.join(", ")}`]
		};
	}
	if (!current) try {
...
async function runLegacyStateMigrations(params) {
	...
	return {
		...
		...(pluginInstallIndex.notices?.length ?? 0) > 0 || (pluginPlans.notices?.length ?? 0) > 0 ? { notices: [...pluginInstallIndex.notices ?? [], ...pluginPlans.notices ?? []] } : {}
	};
}
/**
