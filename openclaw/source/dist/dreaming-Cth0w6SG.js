...
import { B as MANAGED_MEMORY_DREAMING_CRON_TAG, G as resolveMemoryDeepDreamingConfig, V as MEMORY_DREAMING_SYSTEM_EVENT_TEXT, W as resolveMemoryCorePluginConfig, Y as resolveMemoryDreamingWorkspaces, z as MANAGED_MEMORY_DREAMING_CRON_NAME } from "./dreaming-DqzMSXGC.js";
import { l as peekSystemEventEntries } from "./system-events-BfmWSF2P.js";
...
import { n as normalizeTrimmedString, t as includesSystemEventToken } from "./dreaming-shared-CCl2ex70.js";
...
async function runShortTermDreamingPromotionIfTriggered(params) {
	...
	const [{ writeDeepDreamingReport }, { appendFallbackNarrativeEntry, generateAndAppendDreamNarrative, runDetachedDreamNarrative }, { runDreamingSweepPhases }, { applyShortTermPromotions, repairShortTermPromotionArtifacts, rankShortTermPromotionCandidates }] = await Promise.all([
		import("./dreaming-markdown-D5bu2zLw.js"),
		import("./dreaming-narrative-8k4W1hzx.js"),
		import("./dreaming-phases-DDDb2vPm.js"),
		import("./short-term-promotion-ocOQOzwo.js")
	]);
