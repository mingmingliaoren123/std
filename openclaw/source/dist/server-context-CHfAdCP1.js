...
import { C as BrowserTabNotFoundError, E as toBrowserErrorResponse, F as resolveCdpReachabilityTimeouts, I as usesFastLoopbackCdpProbeClass, P as PROFILE_ATTACH_RETRY_TIMEOUT_MS, U as DEFAULT_BROWSER_LOCAL_CDP_READY_TIMEOUT_MS, a as fetchOk, b as BrowserProfileUnavailableError, i as fetchJson, j as CHROME_MCP_ATTACH_READY_WINDOW_MS, l as normalizeCdpHttpBaseForJsonEndpoints, n as assertCdpEndpointAllowed, t as appendCdpPath, w as BrowserTargetAmbiguousError, x as BrowserResetUnsupportedError, y as BrowserProfileNotFoundError } from "./cdp.helpers-B9jipAGQ.js";
...
import { a as getBrowserProfileCapabilities, i as getPwAiModule, n as resolveCdpReachabilityPolicy, r as resolveTargetIdFromTabs, t as resolveCdpControlPolicy } from "./cdp-reachability-policy-BLdT5iz3.js";
import { m as listChromeMcpTabs } from "./chrome-mcp-BZM3Tb7R.js";
...
function getExtensionRelayModule() {
	modPromise ??= import("./relay-lifecycle-CprULlMw.js");
	return modPromise;
}
//#endregion
...
async function getChromeMcpModule() {
	return await import("./chrome-mcp-DG-qO7ba.js");
}
//#endregion
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const ensureExtensionRelay = async () => {
		...
		const { ensureExtensionRelayForProfile, pruneRemovedExtensionRelays } = await getExtensionRelayModule();
		const current = state();
		await pruneRemovedExtensionRelays(current, (name) => current.resolved.profiles[name]?.driver === "extension");
...
//#endregion
export { loadBrowserConfigForRuntimeRefresh as i, listKnownProfileNames as n, getExtensionRelayModule as r, createBrowserRouteContext as t };
