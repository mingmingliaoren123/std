...
import { a as resolveClaudeFable5ModelIdentity, d as supportsClaudeNativeMaxEffort, f as supportsClaudeNativeXhighEffort, l as resolveClaudeSonnet5ModelIdentity, o as resolveClaudeModelIdentity, s as resolveClaudeMythos5ModelIdentity, u as supportsClaudeAdaptiveThinking } from "./src-nWM4ct0V.js";
...
import { s as upsertAuthProfileWithLock } from "./profiles-DyU-YCq2.js";
import { n as listProfilesForProvider } from "./profile-list-XT2LKXsd.js";
import { n as suggestOAuthProfileIdForLegacyDefault } from "./repair-BOGHSorR.js";
import "./number-runtime-DBLVDypr.js";
import "./string-coerce-runtime-ZbuYDJgZ.js";
import { n as NATIVE_ANTHROPIC_REPLAY_HOOKS, u as cloneFirstTemplateModel } from "./provider-model-shared-BK8T_tBM.js";
import { n as validateAnthropicSetupToken, t as buildTokenProfileId } from "./provider-auth-token-CH0Wu93I.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-BsZMtsg2.js";
...
import { n as readClaudeCliCredentialsForSetup, r as readClaudeCliCredentialsForSetupNonInteractive, t as readClaudeCliCredentialsForRuntime } from "./cli-auth-seam-3wVUOXh2.js";
import { n as CLAUDE_CLI_DEFAULT_ALLOWLIST_REFS, r as CLAUDE_CLI_DEFAULT_MODEL_REF, t as CLAUDE_CLI_BACKEND_ID } from "./cli-constants-jYb9bkfI.js";
import { n as CLAUDE_CLI_OFF_THINKING_PROFILE } from "./cli-shared-HJEnVB75.js";
import { t as buildAnthropicCliBackend } from "./cli-backend-C4iY7FFY.js";
import { t as buildClaudeCliCatalogEntries } from "./cli-catalog-BHXWN2Z1.js";
import { t as buildAnthropicCliMigrationResult } from "./cli-migration-C_1fI0oH.js";
...
import { t as anthropicMediaUnderstandingProvider } from "./media-understanding-provider-CDxSAtdD.js";
import { l as wrapAnthropicProviderStream } from "./stream-wrappers-DByRcHlM.js";
import { n as fetchAnthropicUsage, r as resolveAnthropicUsageAuth } from "./usage-CHmXXU09.js";
...
const ANTHROPIC_EXACT_1M_CONTEXT_TOKENS = 1e6;
...
function resolveAnthropicFixedContextWindow(modelId) {
	if (isAnthropicMandatoryClaude5Model(modelId) || isAnthropicSonnet5Model(modelId)) return ANTHROPIC_EXACT_1M_CONTEXT_TOKENS;
	return isAnthropicGa1MModel(modelId) ? ANTHROPIC_GA_1M_CONTEXT_TOKENS : void 0;
}
function isAnthropic128kOutputModel(modelId) {
	if (isAnthropicMandatoryClaude5Model(modelId) || isAnthropicSonnet5Model(modelId)) return true;
...
function applyAnthropicSonnet5Cost(params) {
	...
	if (params.model.cost.input === cost.input && params.model.cost.output === cost.output && params.model.cost.cacheRead === cost.cacheRead && params.model.cost.cacheWrite === cost.cacheWrite) return;
	return {
		...params.model,
		cost
	};
...
function buildAnthropicProvider() {
	...
	return {
		...
		resolveThinkingProfile: ({ provider, modelId, params }) => {
			...
			return isAnthropicMandatoryClaude5Model(contractModelId) && normalizeLowercaseStringOrEmpty(provider) !== PROVIDER_ID ? CLAUDE_CLI_OFF_THINKING_PROFILE : resolveClaudeThinkingProfile(contractModelId, void 0, { includeNativeMax: [PROVIDER_ID, CLAUDE_CLI_BACKEND_ID].includes(normalizeLowercaseStringOrEmpty(provider)) });
		},
