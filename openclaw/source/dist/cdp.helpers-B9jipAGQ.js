...
import { S as findExistingAncestor, u as pathScope } from "./fs-safe-RNq3oO57.js";
...
import { i as hasProxyEnvConfigured } from "./proxy-env-Bf6oQCTF.js";
import { _ as resolvePinnedHostnameWithPolicy, d as isPrivateNetworkAllowedByPolicy, t as SsrFBlockedError } from "./ssrf-BayeDjCv.js";
import { r as fetchWithSsrFGuard } from "./fetch-guard-6VNcgVVc.js";
import { n as registerManagedProxyBrowserCdpBypass } from "./proxy-lifecycle-C1EZFvXz.js";
...
import "./ssrf-runtime-internal-BxdjSky6.js";
...
function openCdpWebSocket(wsUrl, opts) {
	...
	return withManagedProxyForCdpUrl(stripUrlCredentials(wsUrl), () => new WebSocket$1(wsUrl, {
...
//#endregion
export { CHROME_LAUNCH_READY_WINDOW_MS as A, DEFAULT_BROWSER_DEFAULT_PROFILE_NAME as B, BrowserTabNotFoundError as C, CDP_JSON_NEW_TIMEOUT_MS as D, toBrowserErrorResponse as E, resolveCdpReachabilityTimeouts as F, DEFAULT_BROWSER_SCREENSHOT_TIMEOUT_MS as G, DEFAULT_BROWSER_EVALUATE_ENABLED as H, usesFastLoopbackCdpProbeClass as I, DEFAULT_OPENCLAW_BROWSER_ENABLED as J, DEFAULT_BROWSER_SNAPSHOT_TIMEOUT_MS as K, DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS as L, CHROME_STDERR_HINT_MAX_CHARS as M, CHROME_STOP_TIMEOUT_MS as N, CHROME_BOOTSTRAP_EXIT_TIMEOUT_MS as O, PROFILE_ATTACH_RETRY_TIMEOUT_MS as P, ensureAbsoluteDirectory as Q, DEFAULT_AI_SNAPSHOT_MAX_CHARS as R, BrowserResourceExhaustedError as S, BrowserValidationError as T, DEFAULT_BROWSER_LOCAL_CDP_READY_TIMEOUT_MS as U, DEFAULT_BROWSER_DOWNLOAD_TIMEOUT_MS as V, DEFAULT_BROWSER_LOCAL_LAUNCH_TIMEOUT_MS as W, assertManagedProxyAllowsCdpUrl as X, DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME as Y, withNoProxyForCdpUrl as Z, BrowserConflictError as _, fetchOk as a, BrowserProfileUnavailableError as b, isWebSocketUrl as c, scopeCdpPolicyToConfiguredEndpoint as d, withCdpSocket as f, BrowserCdpEndpointBlockedError as g, resolveBrowserRateLimitMessage as h, fetchJson as i, CHROME_MCP_ATTACH_READY_WINDOW_MS as j, CHROME_BOOTSTRAP_PREFS_TIMEOUT_MS as k, normalizeCdpHttpBaseForJsonEndpoints as l, withExactHostnamePolicy as m, assertCdpEndpointAllowed as n, getHeadersWithAuth as o, normalizeBrowserTimerDelayMs as p, DEFAULT_OPENCLAW_BROWSER_COLOR as q, fetchCdpChecked as r, isDirectCdpWebSocketEndpoint as s, appendCdpPath as t, openCdpWebSocket as u, BrowserError as v, BrowserTargetAmbiguousError as w, BrowserResetUnsupportedError as x, BrowserProfileNotFoundError as y, DEFAULT_BROWSER_ACTION_TIMEOUT_MS as z };
