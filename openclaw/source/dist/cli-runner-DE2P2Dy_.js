...
import { S as withAgentRunLifecycleGeneration, n as captureAgentRunLifecycleGeneration, t as assertAgentRunLifecycleGenerationCurrent } from "./agent-events-CRggPZCM.js";
import { s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-BmIrGlLG.js";
import { h as setReplyPayloadMetadata } from "./reply-payload-BK_jICQ3.js";
import { t as SessionManager } from "./session-manager-BC-U4J87.js";
import { i as buildUsageWithNoCost, n as buildAssistantMessage } from "./stream-message-shared-CdbBqwfX.js";
import { i as classifyFailoverReason, v as isFailoverErrorMessage } from "./errors-XbAR6hS3.js";
import { d as resolveFailoverStatus, o as isFailoverError, t as FailoverError } from "./failover-error-B2zFYEnG.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-DKI4eGAu.js";
import { n as appendExactAssistantMessageToSessionTranscript } from "./transcript-uom_ZjhV.js";
import { i as buildGenericCliContextEngineHostSupport } from "./host-compat-BibWlia2.js";
import { a as finalizeHarnessContextEngineTurn, d as runAgentEndSideEffects, l as waitForDeferredTurnMaintenanceForSession, n as bootstrapHarnessContextEngine, s as runHarnessContextEngineMaintenance, u as awaitAgentEndSideEffects } from "./context-engine-lifecycle-Bv52xohg.js";
...
import { a as runAgentHarnessLlmInputHook, o as runAgentHarnessLlmOutputHook, s as buildAgentHookContext } from "./lifecycle-hook-helpers-BwL6869q.js";
...
import { r as hashCliReseedPrompt } from "./cli-session-history-ypfDGcc6.js";
import { i as loadCliSessionHistoryMessages, l as claudeCliSessionTranscriptHasContent, r as loadCliSessionContextEngineMessages, s as buildAgentHookConversationMessages } from "./session-history-BSeSX8Re.js";
...
async function runCliAgentInternal(params) {
	...
	if (params.cleanupCliLiveSessionOnRunEnd === true) try {
		const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-B7UOJUvs.js");
		...
		return {
			...
			meta: {
				...
				agentMeta: {
					...
					provider: params.provider,
					model: context.modelId,
					...resolveReusableCliSessionId(context.reusableCliSession) ? { clearCliSessionBinding: true } : {}
				}
			},
