import { o as ProviderUsageSnapshot, s as UsageProviderId } from "./provider-usage.types-wjE6UjsI.js";
...
declare const PROVIDER_LABELS: Readonly<Record<string, string>>;
