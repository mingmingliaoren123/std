...
import { a as channelToNpmTag } from "./update-channels-CIHQjIuI.js";
import { t as readPackageManagerSpec } from "./package-json-D62iRsOj.js";
...
async function fetchNpmPackageTargetStatusFromRegistry(params) {
	let res;
	try {
		res = await fetchWithTimeout(npmRegistryTargetUrl({
...
//#endregion
export { formatGitInstallLabel as a, detectPackageManager$1 as c, fetchNpmTagVersion as i, compareSemverStrings as n, resolveExtendedStablePackage as o, fetchNpmPackageTargetStatus as r, resolveNpmChannelTag as s, checkUpdateStatus as t };
