...
import { At as boolean, Bt as discriminatedUnion, Et as array, Nn as record, Qn as url, Rn as string, Si as NEVER, Tn as object, Xn as union, Zn as unknown, dn as literal, un as lazy, wn as number, yt as _enum } from "./schemas-CBJjibl3.js";
import { n as ZodIssueCode } from "./compat-Ci0Yc9vr.js";
import { A as TranscribeAudioSchema, D as SecretsConfigSchema, F as TypingModeSchema, I as VisibleRepliesSchema, M as TtsConfigSchema, V as createAllowDenyChannelRulesSchema, _ as ModelsConfigSchema, b as QueueSchema, c as GroupChatSchema, d as HumanDelaySchema, n as BlockStreamingCoalesceSchema, p as InboundDebounceSchema, r as CliBackendSchema, t as BlockStreamingChunkSchema, u as HexColorSchema, v as NativeCommandsSettingSchema, w as SecretInputSchema } from "./zod-schema.core-DviqqtPj.js";
...
import { a as AgentSandboxSchema, c as MemorySearchSchema, d as AgentModelSchema, f as AgentToolModelSchema, i as AgentRunRetriesConfigSchema, n as AgentEntrySchema, o as ElevatedAllowFromSchema, r as AgentModelRuntimeEntrySchema, s as HeartbeatSchema, t as AgentContextLimitsSchema, u as ToolsSchema } from "./zod-schema.agent-runtime-C02vY4RT.js";
import { a as ApprovalsSchema, n as ChannelsSchema } from "./zod-schema.channels-config-ORTHga0n.js";
...
const MarketplaceVerificationSchema = object({ mode: literal("unsigned") }).strict();
const MarketplaceFeedProfileSchema = object({
...
const MarketplaceSourceProfileSchema = union([
	object({ type: literal("npm") }).strict(),
	object({ type: literal("clawhub") }).strict(),
	object({ type: literal("git") }).strict()
]);
const MarketplacesSchema = object({
...
const OpenClawSchema = object({
	...
	cron: object({
		...
		triggers: object({
			enabled: boolean().optional(),
			minIntervalMs: number().int().positive().optional()
		}).strict().optional(),
		retry: object({
