...
import { a as isExecApprovalChannelRuntimeTerminalStartError } from "./approval-native-runtime-DvqMBUp9.js";
import { n as createChannelApprovalHandlerFromCapability } from "./approval-handler-runtime-Df5be6z1.js";
...
import { n as withPluginHttpRouteRegistry } from "./http-registry-zKPuPEkI.js";
			...
			tasks: accountIds.map((id) => async () => {
				...
				try {
					...
					const trackedPromise = Promise.resolve().then(async () => {
						...
						if (channelRunDurationMs !== void 0 && channelRunDurationMs >= CHANNEL_STABLE_RUN_MS) restartAttempts.delete(rKey);
