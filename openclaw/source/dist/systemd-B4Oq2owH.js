...
import { a as normalizeEnvVarKey } from "./host-env-security-CWC2ZCy4.js";
import { i as readStateDirDotEnvFromStateDir, r as isUnresolvedShellReference } from "./state-dir-dotenv-COuz1wV3.js";
...
import { i as runExec, r as runCommandWithTimeout } from "./exec-DaeiOqVs.js";
...
async function findMarkerOwnedSystemSystemdUnit() {
	const { findSystemGatewayServices } = await import("./inspect-jLgDWqvN.js");
	let services;
	try {
...
async function removeNodeSystemdManagedEnvironmentKeys(env) {
	...
	const managedKeys = /* @__PURE__ */ new Set([normalizeSystemdEnvironmentKey("OPENCLAW_GATEWAY_TOKEN")]);
...
//#endregion
export { isEnvironmentFileOnlySource as C, hasInlineEnvironmentSource as S, writeManagedServiceEnvKeysToEnvironment as T, enableSystemdUserLinger as _, isSystemdUnitActive as a, formatManagedServiceEnvKeys as b, readSystemdServiceExecStart as c, restartSystemdService as d, stageSystemdService as f, classifySystemdUnavailableDetail as g, uninstallSystemdService as h, isSystemdServiceEnabled as i, readSystemdServiceRuntime as l, uninstallLegacySystemdUnits as m, installSystemdService as n, isSystemdUserServiceAvailable as o, stopSystemdService as p, isNonFatalSystemdInstallProbeError as r, parseSystemdShow as s, findInstalledSystemdGatewayScope as t, resolveSystemdUserUnitPath as u, readSystemdUserLingerStatus as v, readManagedServiceEnvKeysFromEnvironment as w, hasEnvironmentFileSource as x, collectInlineManagedServiceEnvKeys as y };
