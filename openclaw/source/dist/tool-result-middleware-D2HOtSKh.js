...
import { p as resolvePluginControlPlaneFingerprint } from "./current-plugin-metadata-snapshot-CmOpmveB.js";
import "./defaults-mDjiWzE5.js";
import { u as resolveProviderRuntimePlugin } from "./provider-hook-runtime-yfrzDCD-.js";
import { o as normalizeProviderId } from "./model-selection-normalize-Y5vjde6P.js";
import "./model-selection-B9dihan1.js";
import { gt as generateSummary$1 } from "./sessions-D8qGY7uC.js";
import { a as buildStageSplitPlan, i as buildOversizedFallbackPlan, l as sanitizeCompactionMessages, o as buildSummaryChunks, r as buildHistoryPrunePlan, s as computeAdaptiveChunkRatio } from "./compaction-planning-BUmAeNf7.js";
...
import { f as isGoogleModelApi } from "./embedded-agent-helpers-DZZ4Y-Tw.js";
import { a as isMessagingToolSendAction } from "./embedded-agent-messaging-AJZX3UxO.js";
import { r as isDeliveredMessagingToolResult, t as hasMessagingDeliveryReceipt } from "./embedded-agent-message-tool-source-reply-DCkkwTMd.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-BsZPH_qG.js");
...
//#endregion
export { computeAdaptiveChunkRatioWithWorker as a, shouldAllowProviderOwnedThinkingReplay as c, buildHistoryPrunePlanWithWorker as i, resolveContextWindowTokens as n, providerRequiresSignedThinking as o, summarizeInStages as r, resolveTranscriptPolicy as s, createAgentToolResultMiddlewareRunner as t };
