...
import { r as TRAJECTORY_RUNTIME_FILE_MAX_BYTES, s as safeTrajectorySessionFileName } from "./paths-B4qcz6gV.js";
...
import { n as redactSupportString } from "./diagnostic-support-redaction-CoIT5wwp.js";
...
import { a as writeSupportBundleDirectory, i as textSupportBundleFile, n as jsonlSupportBundleFile, r as supportBundleContents, t as jsonSupportBundleFile } from "./diagnostic-support-bundle-CjmCKt4p.js";
import { n as resolveTrajectoryRuntimeFile, t as isRegularNonSymlinkFile } from "./runtime-file-bCIpZ7ha.js";
...
async function readSessionBranch(filePath) {
	const { entries: fileEntries, warnings: parseWarnings, rowByEntry } = parseSessionFileEntriesWithWarnings(await fs.readFile(filePath, "utf8"));
