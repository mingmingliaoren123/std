...
import { n as getCommandPathWithRootOptions } from "./argv-APLDYHWW.js";
...
const CHUNK_UNSAFE_PATTERN_SOURCES = /* @__PURE__ */ new Set([TELEGRAM_BOT_TOKEN_REDACT_PATTERN, TELEGRAM_TOKEN_REDACT_PATTERN]);
...
function redactSensitiveText(text, options) {
	...
	return redactText(exactRedacted, resolved.patterns, { redactFormBodies: resolved.redactFormBodies });
}
...
function redactSensitiveFieldValueWithOptions(key, value, options, path = [key]) {
	...
	const redacted = redactText(exactRedacted, resolved.patterns, { redactFormBodies: resolved.redactFormBodies });
...
//#endregion
export { testRegexWithBoundedInput as S, shouldSkipMutatingLoggingConfigRead as _, redactSensitiveFieldValue as a, compileSafeRegexDetailed as b, redactSensitiveText as c, redactToolPayloadTextWithConfig as d, resolveRedactOptions as f, readLoggingConfig as g, registerSecretValueForRedaction as h, redactSecrets as i, redactToolDetail as l, redactRegisteredSecretValues as m, getDefaultRedactPatterns as n, redactSensitiveFieldValueWithConfig as o, isSecretValueRegisteredForRedaction as p, isSensitiveFieldKey as r, redactSensitiveLines as s, computeSensitiveRedactionBitmap as t, redactToolPayloadText as u, compileConfigRegexes as v, hasNestedRepetition as x, compileSafeRegex as y };
