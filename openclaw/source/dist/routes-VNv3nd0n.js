...
import { u as pathScope } from "./fs-safe-RNq3oO57.js";
import { m as resolveUserPath } from "./utils-CRO4LGEB.js";
import { i as getRuntimeConfig } from "./io-By0s-a_s.js";
import { _ as resizeToJpeg, f as isImageProcessorUnavailableError, o as buildImageResizeSideGrid, r as IMAGE_REDUCE_QUALITY_STEPS, u as getImageMetadata } from "./media-services-n09-22kU.js";
import { a as ensureMediaDir, u as saveMediaBuffer } from "./store-VcV5Hs9C.js";
import "./number-runtime-DBLVDypr.js";
import "./string-coerce-runtime-ZbuYDJgZ.js";
import "./text-utility-runtime-CEmCehV8.js";
import { n as redactCdpUrl, t as parseBrowserHttpUrl } from "./browser-config-DCrASvM0.js";
...
import { C as BrowserTabNotFoundError, E as toBrowserErrorResponse, G as DEFAULT_BROWSER_SCREENSHOT_TIMEOUT_MS, L as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, R as DEFAULT_AI_SNAPSHOT_MAX_CHARS, T as BrowserValidationError, _ as BrowserConflictError, b as BrowserProfileUnavailableError, f as withCdpSocket, n as assertCdpEndpointAllowed, p as normalizeBrowserTimerDelayMs, v as BrowserError, w as BrowserTargetAmbiguousError, y as BrowserProfileNotFoundError } from "./cdp.helpers-B9jipAGQ.js";
import { a as DEFAULT_DOWNLOAD_DIR, c as resolveExistingUploadPaths, i as resolveProfile, o as DEFAULT_TRACE_DIR, r as resolveManagedBrowserHeadlessMode } from "./config-DpWXcVmn.js";
import "./config-CdXAXOwp.js";
import "./errors-BSZ3n2MU.js";
import { i as isValidProfileName, n as deleteBrowserProfileConfig, t as createBrowserProfileConfig } from "./config-mutations-C1EW6ctD.js";
import { r as resolveBrowserExecutableForPlatform } from "./chrome.executables-DP_XzlNl.js";
import { t as movePathToTrash } from "./trash-fHzBC5m1.js";
import { n as normalizeString } from "./record-shared-BXFJBdq0.js";
import "./sdk-setup-tools-DvUR7fn4.js";
import { a as getBrowserProfileCapabilities, c as shouldUsePlaywrightForScreenshot, i as getPwAiModule$1, o as resolveDefaultSnapshotFormat, r as resolveTargetIdFromTabs, s as shouldUsePlaywrightForAriaSnapshot, t as resolveCdpControlPolicy } from "./cdp-reachability-policy-BLdT5iz3.js";
import { C as takeChromeMcpScreenshot, T as uploadChromeMcpFile, _ as pressChromeMcpKey, c as evaluateChromeMcpScript, f as getChromeMcpPid, h as navigateChromeMcpPage, i as closeChromeMcpTab, l as fillChromeMcpElement, n as clickChromeMcpElement, o as dragChromeMcpElement, p as hoverChromeMcpElement, t as clickChromeMcpCoords, u as fillChromeMcpForm, w as takeChromeMcpSnapshot, y as resizeChromeMcpPage } from "./chrome-mcp-BZM3Tb7R.js";
import { a as scaleAnnotations, c as getRoleSnapshotStats, d as normalizeBrowserFormField, m as normalizeBrowserEvaluateFunctionSource, p as matchBrowserUrlPattern, t as appendSnapshotUrls } from "./snapshot-urls-CSy_q5ul.js";
import { E as withBrowserNavigationPolicy, S as assertBrowserNavigationAllowed, _ as INTERACTIVE_ROLES, a as resolveOpenClawUserDataDir, b as resolveBrowserNavigationProxyMode, g as CONTENT_ROLES, h as snapshotRoleViaCdp, m as snapshotAria, t as getChromeWebSocketUrl, u as captureScreenshot, v as STRUCTURAL_ROLES, w as assertBrowserNavigationResultAllowed, y as ensureOutputDirectory } from "./chrome-DDq_K3xu.js";
			...
			run: async ({ profileCtx, cdpUrl, tab, resolveTabUrl }) => {
				...
				if (isExistingSession) {
					...
					switch (action.kind) {
						...
						case "close":
							await closeChromeMcpTab(profileName, tab.targetId, profileCtx.profile, existingSessionCallOptions);
							return await jsonOk();
...
//#endregion
export { normalizeBrowserScreenshot as i, DEFAULT_BROWSER_SCREENSHOT_MAX_BYTES as n, DEFAULT_BROWSER_SCREENSHOT_MAX_SIDE as r, registerBrowserRoutes as t };
