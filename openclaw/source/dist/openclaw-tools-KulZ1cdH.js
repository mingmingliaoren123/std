...
import { D as resolveIntegerOption, O as resolveNonNegativeIntegerOption, p as finiteSecondsToTimerSafeMilliseconds } from "./number-coercion-CJQ8TR--.js";
import { i as resolveOsHomeDir, t as expandHomePrefix } from "./home-dir-CJKEsOtx.js";
...
import { C as FsSafeError, S as trySafeFileURLToPath, v as hasEncodedFileUrlSeparator } from "./path-DILYn_gk.js";
...
import { c as isRecord$1, i as clampNumber, m as resolveUserPath } from "./utils-CRO4LGEB.js";
import { r as sha256Base64UrlPrefix } from "./crypto-digest-CNeb2i19.js";
...
import { a as resolveAgentModelTimeoutMsValue, i as resolveAgentModelPrimaryValue, r as resolveAgentModelFallbackValues } from "./model-input-B5RmygIK.js";
import { o as resolveAgentEffectiveModelPrimary, s as resolveAgentExecutionContract, v as resolveSessionAgentId, y as resolveSessionAgentIds } from "./agent-scope-B2Pk_xhT.js";
import { a as isSubagentSessionKey, c as parseAgentSessionKey, d as parseThreadSessionSuffix, i as isCronSessionKey, r as isCronRunSessionKey, u as parseSessionDeliveryRoute } from "./session-key-utils-A-JGvyXu.js";
import { n as normalizeAccountId } from "./account-id-C7N4Rwku.js";
import { b as toAgentStoreSessionKey, i as buildAgentMainSessionKey, l as isValidAgentId, p as resolveAgentIdFromSessionKey, t as DEFAULT_AGENT_ID, u as normalizeAgentId } from "./session-key-VWT_xzM9.js";
import { a as resolveAgentDir, n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-BxAUeF6t.js";
...
import { o as resolveManifestContractOwnerPluginId } from "./plugin-registry-8E8D2Hou.js";
import { t as privateFileStore } from "./private-file-store-BSksaLX_.js";
import { a as resolvePluginMetadataSnapshot } from "./plugin-metadata-snapshot-rpSrEgGf.js";
import { t as loadBundledPluginPublicArtifactModuleFromCandidatesSync } from "./public-surface-loader-Cc3INdMh.js";
import { l as decodeWindowsTextFileBuffer } from "./windows-command-C7JEh9zV.js";
import { t as logDebug } from "./logger-D7QYAmug.js";
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-By0s-a_s.js";
...
import { s as resolveActionDeliveryTargetAlias } from "./channel-target-BBHWW9s4.js";
...
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-CxA7qokj.js";
import { t as SsrFBlockedError } from "./ssrf-BayeDjCv.js";
...
import "./operator-scopes-CpPJIv7P.js";
import { s as resolveLeastPrivilegeOperatorScopesForMethod } from "./method-scopes-CwW_Szsp.js";
import { p as scheduleGatewaySigusr1Restart } from "./restart-BF68zBs3.js";
import { i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane, s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-DttyoZZA.js";
import { o as normalizeChannelId } from "./registry-BUWrOy2m.js";
import { w as listRegisteredPluginAgentPromptGuidance } from "./command-registration-tKF3dsKu.js";
import { d as listMediaGenerationProviderModels, f as synthesizeMediaGenerationCatalogEntries } from "./registry-B8eQDFB4.js";
import { g as registerAgentRunContext, i as clearAgentRunContext } from "./agent-events-CRggPZCM.js";
...
import { a as imageMimeFromFormat, n as detectMime } from "./mime-BaK8UYea.js";
import { n as assertSandboxPath } from "./sandbox-paths-BM7tDEKD.js";
import "./local-file-access-CBe_wA_B.js";
import { a as toRelativeWorkspacePath, n as resolveWorkspaceRoot, t as normalizeWorkspaceDir } from "./workspace-dir-CgYmgqVr.js";
import { $ as parseSessionThreadInfo, S as loadSessionStore, v as updateSessionStore } from "./store-BJJhlPrk.js";
...
import { a as resolveSessionFilePath, d as resolveStorePath, o as resolveSessionFilePathOptions } from "./paths-C2C4lJH6.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-CCU9J1Ai.js";
import { n as resolveSessionConversationRef } from "./session-conversation-Sco2Iyil.js";
...
import { L as resolveSessionEntryCandidateTarget, w as patchSessionEntryWithKey } from "./session-accessor-D7yi6P1i.js";
...
import "./model-ref-shared-UP3ck3u3.js";
import { a as normalizeModelRef, i as modelKey$1, n as findNormalizedProviderValue } from "./model-selection-normalize-Y5vjde6P.js";
import { r as ensureOpenClawModelsJson } from "./models-config-CtSKvpKC.js";
import { n as resolveThinkingDefaultWithRuntimeCatalog, t as resolveThinkingDefault } from "./model-thinking-default-Bjh5mzPy.js";
import { c as resolveDefaultModelForAgent, d as resolvePersistedSelectedModelRef, i as normalizeStoredOverrideModel } from "./model-selection-B9dihan1.js";
...
import { s as resolveProviderTransportSsrFPolicy, t as complete } from "./stream-BcRkg2P0.js";
import { s as unwrapSecretSentinelsForProviderEgress } from "./provider-local-service-DrSIrOxn.js";
import { Tt as writePrivateTempFile, V as createReadTool, Y as createEditTool, nt as formatFullOutputFooter, z as createWriteTool } from "./sessions-D8qGY7uC.js";
import { C as readSnakeCaseParamRaw, _ as readStringArrayParam, b as scheduleToolProgress, f as readFiniteNumberParam, h as readPositiveIntegerParam, l as normalizeToolModelOverride, m as readNumberParam, n as ToolInputError, p as readNonNegativeIntegerParam, r as asToolParamsRecord, w as resolveSnakeCaseParamKey, y as readStringParam } from "./common-DWyiui3y.js";
import { t as formatByteSize } from "./format-CYxrpfaD.js";
import "./src-BjBEohZA.js";
import { u as getImageMetadata } from "./media-services-n09-22kU.js";
import { r as resolveImageSanitizationLimits } from "./image-sanitization-CxLP0YN-.js";
import { r as sanitizeToolResultImages } from "./tool-images-Rr7Njheg.js";
import { n as textResult, t as jsonResult } from "./tool-results-BCM3fdVS.js";
import { u as saveMediaBuffer } from "./store-VcV5Hs9C.js";
import { c as resolveMediaReferenceSandboxPath, n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-Cswh9n78.js";
import { o as getApiKeyForModel, r as applySecretRefHeaderSentinels, s as getCustomProviderApiKey } from "./model-auth-CJEm9SNp.js";
import { n as isRequesterParentOfBackgroundAcpSession } from "./session-interaction-mode-OIH_Dwbr.js";
import { S as describeUpdatePlanTool, _ as describeSessionStatusTool, b as describeSessionsSendTool, d as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, f as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, g as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY, h as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, m as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, p as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, u as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, v as describeSessionsHistoryTool, x as describeSessionsSpawnTool, y as describeSessionsListTool } from "./tool-catalog-C8xbUFNe.js";
import "./tool-policy-BHUGxE3p.js";
...
import { n as hasInboundMetadataSentinel, r as stripInboundMetadata } from "./strip-inbound-meta-DMvJPx9F.js";
import { n as resolveChannelDefaultBindingPlacement, r as resolveInboundConversationResolution } from "./conversation-binding-context-Do24GZhQ.js";
...
import { d as listFreshTasksForOwnerKey, h as listTasksForOwnerKey } from "./task-registry-Cws4vLl0.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-Cl7I06QA.js";
import "./runtime-internal-CF360ro3.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, l as recordTaskRunProgressByRunId, n as completeTaskRunByRunId } from "./detached-task-runtime-B93mVzDV.js";
import { t as resolveRequiredCompletionDeliveryFailureTerminalResult } from "./task-completion-contract-BaGoOhG8.js";
...
import { d as getSessionGoal, l as createSessionGoal, m as updateSessionGoalStatus, s as MODEL_UPDATABLE_SESSION_GOAL_STATUSES } from "./sessions-oDygYVdy.js";
...
import { d as readSessionTitleFieldsFromTranscriptAsync } from "./session-transcript-readers-BMjfbAlq.js";
...
import { b as resolveSessionModelIdentityRef, f as pruneLegacyStoreKeys, g as resolveGatewaySessionStoreTarget, r as deriveSessionTitle } from "./session-utils-DD3pe_2A.js";
import { d as writeRestartSentinel, i as formatDoctorNonInteractiveHint, n as clearRestartSentinel, t as buildRestartSuccessContinuation } from "./restart-sentinel-CEN_sCi1.js";
import { u as retireSessionMcpRuntimeForSessionKey } from "./agent-bundle-mcp-runtime--G82BMQs.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-6B2U2Rti.js";
import { o as resolvePluginTools } from "./tools-V54L2wjJ.js";
...
import { r as getActiveSecretsRuntimeConfigSnapshot } from "./runtime-state-CPERULut.js";
import { t as ensureContextEnginesInitialized } from "./init-B7EVAsOz.js";
import { n as discoverModels, t as discoverAuthStorage } from "./agent-model-discovery-BuQHUPIv.js";
import { n as resolveModelAsync } from "./model-wpoKGSDF.js";
import { c as resolveBundledStaticCatalogModel, t as bundledStaticCatalogProviderUsesRuntimeAugment } from "./model.static-catalog-CWVm-Y_6.js";
import { a as resolveSubagentCapabilities, c as findAcpUnsupportedInheritedToolAllow, d as formatAcpInheritedToolDenyError, f as inheritedToolAllowPatch, h as normalizeInheritedToolDenylist, l as findAcpUnsupportedInheritedToolDeny, m as normalizeInheritedToolAllowlist, p as inheritedToolDenyPatch, s as getSubagentDepthFromSessionStore, u as formatAcpInheritedToolAllowError } from "./subagent-capabilities-tqhxY1k6.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-B3_LYAnc.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-DeOnAqhX.js";
import { O as isEmbeddedMode, p as wrapToolWithBeforeToolCallHook } from "./agent-tools.before-tool-call-C95DXQXZ.js";
import { a as proposeCreateSkill, d as resolvePendingSkillProposal, f as reviseSkillProposal, n as inspectSkillProposal, o as proposeUpdateSkill, r as listSkillProposals, s as quarantineSkillProposal, t as applySkillProposal, u as rejectSkillProposal } from "./service-B3AwqWsa.js";
import { A as wrapToolParamValidation, D as normalizeFileToolPathParam, E as getToolParamsRecord, O as normalizeFileToolPathParamsFromKeys, S as isToolWrappedWithBeforeToolCallHook, T as assertRequiredParams, a as wrapToolWithGatewayCallerIdentity, c as setToolTerminalPresentation, d as listChannelSupportedActions, l as listAllChannelSupportedActions, n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool, w as REQUIRED_PARAM_GROUPS } from "./gateway-CvsJ0gY0.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-9wjcXNyC.js";
import { a as optionalPositiveIntegerSchema, i as optionalNonNegativeIntegerSchema, n as channelTargetsSchema, o as optionalStringEnum, r as optionalFiniteNumberSchema, s as stringEnum, t as channelTargetSchema } from "./typebox-DnTTOzWO.js";
import "./delivery-context-v0-gU4Pa.js";
import { n as createTranscriptsTool, r as resolveTranscriptsConfig } from "./transcripts-tool-B4cRl5xP.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-CmS_1rXy.js";
import { a as resolveRequesterOriginForChild, n as resolveSubagentModelAndThinkingPlan, o as resolveSubagentAllowedTargetIds, r as splitModelRef, s as resolveSubagentTargetPolicy, t as resolveConfiguredSubagentRunTimeoutSeconds } from "./subagent-spawn-plan-CsAYyEim.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-CUl4zBv3.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-CsMNowOZ.js";
import { t as createCrestodianTool } from "./crestodian-tool-Bcq7P1GG.js";
import { r as gatewayCallOptionSchemaProperties, t as createCronTool } from "./cron-tool-C9qaFGtt.js";
import { t as normalizeConfigPatchReplacePaths } from "./patch-replace-paths-DLvXobiX.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-CbRG8Jjk.js";
import { a as recordCapabilityCandidateFailure, f as throwCapabilityGenerationFailure, h as resolveCapabilityModelRefForProviders, i as normalizeDurationToClosestMax, m as findCapabilityProviderById, n as buildNoCapabilityModelConfiguredMessage, o as resolveCapabilityModelCandidates, p as hasMediaNormalizationEntry, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-DSD2Xmqz.js";
import { n as listRuntimeImageGenerationProviders, r as resolveImageGenerationMaxInputImages, t as generateImage } from "./runtime-Da0CzszU.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-DpuUhxLd.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-BKuXD1bl.js";
...
import { r as getDefaultLocalRoots } from "./local-media-access-olAlkTss.js";
import { n as loadWebMedia, r as loadWebMediaRaw } from "./web-media-ByjukLMW.js";
import { a as loadSessionEntryByKey, d as formatAgentInternalEventsForPrompt, i as loadRequesterSessionEntry, m as mediaUrlsFromGeneratedAttachments, n as deliverSubagentAnnouncement, p as formatGeneratedAttachmentLines, t as resolveAnnounceOrigin } from "./subagent-announce-origin-DPSebzOW.js";
import { i as routeToDeliveryFields, n as routeFromBindingRecord } from "./route-projection-DG0kMPIb.js";
...
import { n as resolveChannelInboundAttachmentRootsForChannel } from "./channel-inbound-roots-COUzIGD_.js";
import { a as hasProviderAuthForTool, c as resolveOpenAiImageMediaCandidate, n as coerceToolModelConfig, o as hasToolModelConfig$1, r as hasAuthForProvider, s as resolveDefaultModelRef, t as buildToolModelConfigFromCandidates } from "./model-config.helpers-BS3FWcoO.js";
import { a as runWithImageModelFallback, n as resolveImageFallbackCandidates, r as resolveImageFallbackDefaultProvider } from "./model-fallback-BPQMpbqN.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-CNe-BSMJ.js";
import { r as extractAssistantText } from "./embedded-agent-utils-CjKqpAOm.js";
import { i as readResponseBodySnippet, n as isMinimaxVlmProvider } from "./minimax-vlm-CvP1HtmK.js";
import { a as resolveConfiguredImageModelRefs, n as coerceImageModelConfig, o as resolveProviderVisionModelFromConfig, r as decodeDataUrl } from "./image-tool.helpers-COuozezb.js";
import { n as normalizeMediaProviderId } from "./provider-id-DSbuCFIb.js";
import { i as resolveDocumentMediaModel, n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-UWgpYiW0.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime--DV-ur61.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS, u as buildMediaUnderstandingRegistry } from "./defaults.constants-a1NGOUtu.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-BK3bTOCE.js";
import { c as resolveTimeoutMs } from "./resolve-DpuaVxmy.js";
import "./media-understanding-D3MbMDvO.js";
import { c as postJsonRequest, m as resolveProviderHttpRequestConfigWithOriginTrust } from "./shared-CFpa8hBG.js";
...
import { t as resolveEnabledBundledManifestContractPlugins } from "./bundled-manifest-contract-plugins-B6lpqvCG.js";
import { d as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-FYfRsgRi.js";
...
import { a as SHARED_POLL_CREATION_PARAM_NAMES, i as POLL_CREATION_PARAM_DEFS, n as runMessageAction, r as stripFormattedReasoningMessage, t as getToolResult } from "./message-action-runner-BnKuX7pN.js";
import { a as resolveAllowedMessageActions, s as shouldApplyCrossContextMarker } from "./outbound-policy-CfXcSEaQ.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-CESBo_Td.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-C6FasDKb.js";
import { a as writeScreenRecordToFile, c as parseCameraClipPayload, d as writeCameraPayloadToFile, i as screenSnapshotTempPath, l as parseCameraSnapPayload, n as parseScreenSnapshotPayload, o as writeScreenSnapshotToFile, r as screenRecordTempPath, s as cameraTempPath, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-DOp3XUQe.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-CSjC3s70.js";
import { w as extractPdfContent } from "./runner.entries-Ci_g3yUf.js";
import { s as resolveAnthropicMessagesUrl, t as registerProviderStreamForModel } from "./provider-stream-CqSx37Uy.js";
...
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-BwV5KyRM.js";
import { n as createModelVisibilityPolicy } from "./model-visibility-policy-Ci2v9hwh.js";
import { r as stripToolMessages } from "./chat-history-text-CsHxZuo9.js";
import { i as resolveNestedAgentLaneForSession, t as AGENT_LANE_SUBAGENT } from "./lanes-CI0_P-yC.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot, t as isRecoverableAgentWaitError } from "./run-wait-B_tzKx76.js";
import { f as ANNOUNCE_SKIP_TOKEN, g as isReplySkip, h as isNonDeliverableSessionsReply, m as isAnnounceSkip, p as REPLY_SKIP_TOKEN } from "./subagent-session-cleanup-BEPym0Sy.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, f as supportsAutomaticThreadBindingSpawn, n as formatThreadBindingSpawnDisabledError, o as resolveThreadBindingIdleTimeoutMsForChannel, t as formatThreadBindingDisabledError, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-ZPTJOYzU.js";
...
import { i as resolveThreadBindingThreadName, r as resolveThreadBindingIntroText } from "./thread-bindings-messages-CCmMIfGL.js";
import { i as resolveSpawnedWorkspaceInheritance, n as normalizeSpawnedRunMetadata, t as mapToolContextToSpawnedRunMetadata } from "./spawned-context-QGy9i1y8.js";
import { t as forkSessionEntryFromParent } from "./session-fork-B_4CoW5e.js";
...
import { a as listControlledSubagentRuns, o as resolveSubagentController, t as MAX_RECENT_MINUTES } from "./subagent-control-CXT-voKm.js";
import { a as wrapExternalContent, o as wrapWebContent } from "./external-content-CycSUXwl.js";
import { k as textToSpeech } from "./tts-runtime-DGW70YBV.js";
import "./tts-CYR90HER.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, n as listRuntimeVideoGenerationProviders, r as listSupportedVideoGenerationModes, t as generateVideo } from "./runtime-C7MX3ET3.js";
import { r as parseVideoGenerationModelRef } from "./provider-registry-C8V34L3J.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-BlnHfD9f.js";
import { a as truncateText, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-66--VfEH.js";
import { a as readResponseText, c as resolveTimeoutSeconds, i as readCache, o as resolveCacheTtlMs, r as normalizeCacheKey, u as writeCache } from "./web-shared-Bm_qLCdN.js";
import { a as runWebSearch } from "./runtime-CtFv4IyR.js";
import "./web-search-provider-common-ht9WrcAG.js";
...
function collectChangedConfigPaths(currentValue, nextValue, basePath = "", out = /* @__PURE__ */ new Set()) {
	...
	if (Array.isArray(currentValue) || Array.isArray(nextValue)) {
		...
		const ids = /* @__PURE__ */ new Set([...currentEntries.entries.keys(), ...nextEntries.entries.keys()]);
	...
	if (isRecord(currentValue) && isRecord(nextValue)) {
		const keys = /* @__PURE__ */ new Set([...Object.keys(currentValue), ...Object.keys(nextValue)]);
	...
	return {
		...
		execute: async (_toolCallId, args) => {
			...
			if (action === "restart") {
				...
				const reason = rawReason ? truncateUtf16Safe(rawReason, 200) : void 0;
...
const MEDIA_DIRECT_FALLBACK_DELIVERY_REASONS = /* @__PURE__ */ new Set([
...
function scheduleMediaGenerationTaskCompletion(params) {
	params.scheduleBackgroundWork(async () => {
		...
		try {
			...
			if (params.handle) {
				const mediaUrls = Array.from(/* @__PURE__ */ new Set([...executed.mediaUrls ?? [], ...mediaUrlsFromGeneratedAttachments(executed.attachments)]));
...
async function tryDeliverMediaGenerationDirect(params) {
	...
	try {
		const { sendMessage } = await import("./task-registry-delivery-runtime-B9sUJMRK.js");
		await sendMessage({
			cfg: params.config,
...
async function loadImageWebMediaRuntime() {
	return await import("./web-media-B0yEK4CX.js");
}
...
function buildChannelTargetSchema() {
	return {
		...
		userId: Type.Optional(Type.String({ description: "User id for member-info and channel-specific moderation or participant actions. For member-info, pass userId directly; the action does not accept target." })),
...
const USER_PREFIXED_DIRECT_TARGET_CHANNELS = /* @__PURE__ */ new Set([
	"discord",
	"mattermost",
	"msteams",
	"slack"
...
async function runPdfPrompt(params) {
	...
	const result = await runWithImageModelFallback({
		...
		modelOverride: params.modelOverride,
		run: async (provider, modelId) => {
			const model = applySecretRefHeaderSentinels(resolveModelFromRegistry({
				modelRegistry,
				provider,
				modelId
			}), effectiveCfg);
		...
		execute: async (_toolCallId, args) => {
			...
			for (const entry of sessions) {
				...
				const row = {
					...
					pinnedAt: typeof entry.pinnedAt === "number" ? entry.pinnedAt : void 0,
					sessionId,
...
let agentStepDeps = {
	agentCommandFromIngress: (async (...args) => {
		const { agentCommandFromIngress } = await import("./agent-D4uWiKcR.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-okjt5RtM.js"));
...
const SkillWorkshopToolSchema = Type.Object({
	action: stringEnum(SKILL_WORKSHOP_ACTIONS, { description: "create = new skill; update = existing live skill; revise = existing pending proposal; list/inspect discover pending proposals (not filesystem search); apply/reject/quarantine are explicit lifecycle actions." }),
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-D0iCnyst.js"));
...
async function spillWebFetchContent(value, wrapped, maxChars, sourceTruncated = false) {
	...
	const fullOutputPath = await writePrivateTempFile("openclaw-web-fetch", wrapWebContent(content, "web_fetch"));
	const spillCapped = value.length > WEB_FETCH_SPILL_MAX_CHARS;
	const spillTruncated = sourceTruncated || spillCapped;
	const spillNote = sourceTruncated ? " Spilled available content from truncated response." : spillCapped ? ` Spilled first ${spilledChars} chars.` : "";
...
async function normalizeProviderWebFetchPayload(params) {
	...
	return {
		...
		...wrapped.spilledChars !== void 0 ? { spilledChars: wrapped.spilledChars } : {},
