...
import { x as isTimeoutErrorMessage } from "./sanitize-user-facing-text-D-sR-1VY.js";
import { E as isUnclassifiedNoBodyHttpSignal, a as classifyFailoverSignal, d as inferSignalStatus, s as extractFailoverSignalDetails } from "./errors-XbAR6hS3.js";
...
function isNonProviderRuntimeCoordinationError(err) {
	if (!hasSessionWriteLockContention(err) && !hasEmbeddedAttemptSessionTakeover(err) && !hasMissingToolResultFailure(err)) return false;
