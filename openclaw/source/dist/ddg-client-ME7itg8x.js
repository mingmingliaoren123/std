...
import { h as readProviderTextResponse } from "./provider-http-errors-HGLTiqMh.js";
...
import { g as resolveSearchCount, v as resolveSiteName, x as withTrustedWebSearchEndpoint } from "./web-search-provider-common-ht9WrcAG.js";
...
function isDecodableCodePoint(cp) {
	return Number.isInteger(cp) && cp >= 0 && cp <= 1114111 && (cp < 55296 || cp > 57343);
}
