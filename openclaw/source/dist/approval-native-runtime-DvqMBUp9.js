...
import { i as isApprovalMethod } from "./method-scopes-CwW_Szsp.js";
import "./message-channel-CB9y2CYk.js";
import { t as createApprovalNativeRouteReporter } from "./approval-native-route-coordinator-Ch67p2cH.js";
import { t as buildChannelApprovalNativeTargetKey } from "./approval-native-target-key-QkHNZRcL.js";
import { t as createOperatorApprovalsGatewayClient } from "./operator-approvals-client-CzweFEZT.js";
...
function createChannelNativeApprovalRuntime(adapter) {
	...
	const routeReporter = createApprovalNativeRouteReporter({
		...
		requestGateway: async (method, params) => {
			const { callGatewayLeastPrivilege } = await import("./call-BZWJ3eG1.js");
