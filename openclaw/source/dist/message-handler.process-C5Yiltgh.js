...
import { a as shouldLogVerbose, r as logVerbose, t as danger } from "./globals-0FRK183t.js";
import { c as isReplyPayloadNonTerminalToolErrorWarning, o as getReplyPayloadTtsSupplement } from "./reply-payload-BK_jICQ3.js";
import { d as resolveStorePath } from "./paths-C2C4lJH6.js";
import { f as stripReasoningTagsFromText } from "./assistant-visible-text-oprKkPEf.js";
...
import { i as shouldAckReaction } from "./ack-reactions-Pw4-TsUB.js";
import { D as toInboundMediaFacts, E as toHistoryMediaEntries, h as hasFinalChannelTurnDispatch, y as buildChannelInboundEventContext } from "./kernel-BMsNZe7F.js";
import { t as recordInboundSession } from "./session-B32E3ea4.js";
import { n as resolveChannelSourceReplyDeliveryMode, t as createChannelReplyPipeline } from "./reply-pipeline-JiXbL-bQ.js";
...
import { n as getSessionEntry, s as readSessionUpdatedAt } from "./session-store-runtime-DDagY4fL.js";
import { t as resolveChannelContextVisibilityMode } from "./context-visibility-BVlvSMUZ.js";
import "./reply-chunking-DEg6TUQL.js";
import { r as dispatchChannelInboundReply } from "./inbound-reply-dispatch-C8SZBmZG.js";
import { a as resolveChannelDraftStreamingChunking, i as createChannelProgressDraftCompositor } from "./channel-outbound-DkdAAOhG.js";
import { n as createFinalizableDraftLifecycle } from "./draft-stream-controls-Cf_yIQ6N.js";
...
import { a as DEFAULT_TIMING, c as createStatusReactionController } from "./channel-feedback-ChYFAgPX.js";
import { i as readLatestAssistantTextByIdentity } from "./session-transcript-runtime-CqRUDYiQ.js";
import { f as resolveDiscordMaxLinesPerMessage } from "./accounts-B2tNBeEr.js";
import { n as resolveDiscordChannelId } from "./target-parsing-ngi8FE5G.js";
import { Lt as ChannelType, Ut as MessageFlags, at as editChannelMessage, et as createChannelMessage, rt as deleteChannelMessage } from "./discord-rKQUcEtb.js";
import { I as createDiscordRestClient, L as createDiscordRuntimeAccountContext, _ as resolveDiscordMessageFlags, d as resolveDiscordTargetChannelId } from "./send.shared-DiK5ZyE1.js";
...
import { a as normalizeDiscordSlug, r as normalizeDiscordAllowList } from "./allow-list-CudPziLJ.js";
import { d as editMessageDiscord, i as removeReactionDiscord, n as reactMessageDiscord } from "./send-DF8yT20O.js";
import { t as discordTextHasBroadcastMention } from "./mentions-B-bu0H-y.js";
import "./targets-Dh-_ehX6.js";
import { t as beginDiscordInboundEventDeliveryCorrelation } from "./inbound-event-delivery-D1PePyhr.js";
...
import { t as DISCORD_TEXT_CHUNK_LIMIT } from "./outbound-adapter-BkXPSQET.js";
import { t as resolveDiscordPreviewStreamMode } from "./preview-streaming-lVHtFIQw.js";
import { r as resolveDiscordMessageText, s as resolveReferencedReplyMediaList } from "./message-utils-9ydF7JzE.js";
import { c as resolveDiscordThreadStarter, r as resolveDiscordAutoThreadReplyPlan } from "./threading-mw30O75h.js";
import { t as createDiscordReplyTypingFeedback } from "./reply-typing-feedback-CjXEevEO.js";
import { n as buildDiscordInboundAccessContext, r as createDiscordSupplementalContextAccessChecker } from "./inbound-context-CQOjiNbb.js";
import { a as resolveReplyContext, i as buildGuildLabel, n as sanitizeDiscordFrontChannelReplyPayloads, r as buildDirectLabel, t as deliverDiscordReply } from "./reply-delivery-TPJ8kXkM.js";
...
async function processDiscordMessageInner(ctx, observer) {
	...
	const { cfg, discordConfig, accountId, token, runtime, guildHistories, historyLimit, textLimit, replyToMode, ackReactionScope, message, messageChannelId, isGuildMessage, isDirectMessage, isGroupDm, messageText, shouldRequireMention, canDetectMention, effectiveWasMentioned, shouldBypassMention, channelConfig, threadBindings, route, abortSignal, replyTypingFeedback, preparedMedia: mediaList } = ctx;
	...
	const deliverDiscordPayload = async (payload, info, options) => {
		...
		if (draftStream && isFinal && draftPreview.isProgressMode && draftPreview.hasProgressDraftStarted && !deliverablePayload.isError && draftStream) {
	...
	try {
		...
		if (statusReactionsActive) if (dispatchAborted) if (removeAckAfterReply) statusReactions.clear();
			...
			if (removeAckAfterReply) (async () => {
				await sleep(dispatchError || finalDeliveryFailed ? statusReactionTiming.errorHoldMs : statusReactionTiming.doneHoldMs);
