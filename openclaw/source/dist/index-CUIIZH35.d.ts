import { A as ToolResultMessage, C as TextContent, a as AssistantMessageEventStreamContract, c as Context, f as Model, i as AssistantMessageEvent, l as ImageContent, n as Api, v as SimpleStreamOptions } from "./types-CFIUY_La.js";
import { n as PluginMetadataSnapshot } from "./plugin-metadata-snapshot.types-D_Y2Gl1D.js";
import { Kn as AgentOptions, a as TruncationResult, d as CompactionPreparation, f as CompactionResult, p as CompactionSettings } from "./index-gVeC7XQ4.js";
import { D as ToolExecutionMode, E as ThinkingLevel, T as StreamFn, b as CustomMessage, c as AgentState, f as AgentToolResult, i as AgentEvent, l as AgentTool, p as AgentToolUpdateCallback, s as AgentMessage } from "./types-D0CdrmU4.js";
import { t as Agent } from "./index-1ma_YhF9.js";
import { n as UserTurnTranscriptRecorder } from "./user-turn-transcript.types-DPSAsexh.js";
import { S as SettingsManager, l as PathMetadata, t as SourceInfo } from "./source-info-BzS4w6_z.js";
import { _ as SessionManager, d as SessionEntry, l as ReadonlySessionManager, n as CompactionEntry, t as BranchSummaryEntry } from "./session-manager-RXl7XED7.js";
import { i as OAuthLoginCallbacks$1, l as OAuthProviderInterface, r as OAuthCredentials$1, s as OAuthProviderId } from "./provider-oauth-runtime-B-tSEXFb.js";
...
declare class AgentSession {
   ...
   */
  steer(text: string, images?: ImageContent[], userTurnTranscriptRecorder?: UserTurnTranscriptRecorder): Promise<void>;
  /**
