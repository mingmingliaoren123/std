...
import { i as withProgressTotals } from "./progress-DXZjrYcT.js";
...
import { d as updateConfig, i as formatTokenK, r as formatMs } from "./shared-D0zComE5.js";
...
async function fetchOpenRouterModels(fetchImpl, timeoutMs) {
	let res;
	try {
		res = await withTimeout(timeoutMs, (signal) => fetchImpl(OPENROUTER_MODELS_URL, {
