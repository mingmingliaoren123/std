...
import { a as getActivePluginGatewayNodePolicyRegistry } from "./runtime-D0xGMZdc.js";
import { d as resolvePluginApprovalTimeoutMs } from "./plugin-approvals-D2muXfhg.js";
import { Ct as validateNodePairApproveParams, Dt as validateNodePairRequestParams, Et as validateNodePairRemoveParams, Nt as validateNodeRenameParams, Ot as validateNodePairVerifyParams, St as validateNodeListParams, Tt as validateNodePairRejectParams, _t as validateNodeDescribeParams, bt as validateNodeInvokeParams, kt as validateNodePendingAckParams, vt as validateNodeEventParams, wt as validateNodePairListParams, xt as validateNodeInvokeResultParams } from "./src-CToKmqGn.js";
import { Gn as errorShape, Wn as ErrorCodes } from "./schema-BuOFpc7K.js";
import { a as rejectNodePairing, c as renamePairedNode, f as verifyNodeToken, i as listNodePairing, l as requestNodePairing, s as removePairedNode, t as approveNodePairing } from "./node-pairing-C0KBZUMJ.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo } from "./remote-CUhvVY5E.js";
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-CQtFV9Fn.js";
import { i as isNodeCommandAllowed, o as normalizeDeclaredNodeCommands, r as isForegroundRestrictedPluginNodeCommand, s as resolveNodeCommandAllowlist, t as DEFAULT_DANGEROUS_NODE_COMMANDS } from "./node-command-policy-CO8bCAnE.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-DNOcv5eI.js";
import { a as getPairedDevice, c as listApprovedPairedDeviceRoles, l as listDevicePairing, p as removePairedDeviceRole } from "./device-pairing-Dw7KWdQ7.js";
import { i as buildSystemRunApprovalBinding, l as toSystemRunApprovalMismatchError, o as matchSystemRunApprovalBinding, r as resolveSystemRunCommandRequest, s as missingSystemRunApprovalBinding } from "./system-run-command-Bd_agqvl.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-B9ONWoZl.js";
import { c as sendApnsBackgroundWake, d as shouldClearStoredApnsRegistration, f as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as resolveApnsAuthConfigFromEnv, s as sendApnsAlert, t as clearApnsRegistrationIfCurrent } from "./push-apns-CJvPes3P.js";
import { i as pairedDeviceHasNonOperatorRole, n as deniesCrossDeviceManagement, o as resolveDeviceManagementAuthz, t as emitDeviceManagementSecurityEvent } from "./device-management-security-pCamj2Kg.js";
import { n as getKnownNode, r as listKnownNodes, t as createKnownNodeCatalog } from "./node-catalog-B4NGBTCI.js";
import { d as resolveApprovalRequestRecipientConnIds } from "./approval-shared-BKEyXMsJ.js";
...
function clientHasOperatorAdminScope(client) {
	return (Array.isArray(client?.connect?.scopes) ? client.connect.scopes : []).includes(BROWSER_PROXY_REQUIRED_SCOPE);
}
...
const nodeHandlers = {
	...
	"node.describe": async ({ params, respond, client, context }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			...
			const node = catalogNode && canReadPendingNodePairing(client) ? catalogNode : catalogNode ? safeNodeReadProjection(catalogNode, nodeReadCallerDeviceId(client)) : null;
			if (!node) {
				respond(false, void 0, errorShape(ErrorCodes.INVALID_REQUEST, "unknown nodeId"));
				return;
			}
	...
	"node.invoke": async ({ params, respond, context, client, req }) => {
		...
		if (command === "browser.proxy" && !clientHasOperatorAdminScope(client)) {
			respond(false, void 0, errorShape(ErrorCodes.INVALID_REQUEST, `missing scope: ${BROWSER_PROXY_REQUIRED_SCOPE}`));
			return;
		}
		await respondUnavailableOnThrow(respond, async () => {
			const cfg = context.getRuntimeConfig();
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BhpBsWJm.js");
