...
import { s as resolveConfigPath, u as resolveGatewayLockDir, v as resolveStateDir } from "./paths-BMBAvkNf.js";
import { o as sha256HexPrefix } from "./crypto-digest-CNeb2i19.js";
import { Rn as string, Tn as object, wn as number } from "./schemas-CBJjibl3.js";
import { t as safeParseJsonWithSchema } from "./zod-parse-Bip-sZi_.js";
import { n as isPidAlive } from "./pid-alive-C4bVUgUC.js";
import { a as isGatewayArgv, i as readWindowsProcessArgsSync, o as parseProcCmdline } from "./windows-port-pids-jYst3qTE.js";
...
async function resolveGatewayOwnerStatus(pid, payload, platform, port, readCmdline, opts = {}) {
	if (port != null) {
...
async function readActiveGatewayLockPort(opts = {}) {
	const { lockPath } = resolveGatewayLockPath(opts.env ?? process.env, opts.lockDir);
	const payload = await readLockPayload(lockPath);
	if (!payload?.port) return;
	return await resolveGatewayOwnerStatus(payload.pid, payload, opts.platform ?? process.platform, void 0, opts.readProcessCmdline, { trustUnknownCmdlineOwner: false }) === "alive" ? payload.port : void 0;
}
...
//#endregion
export { acquireGatewayLock as n, readActiveGatewayLockPort as r, GatewayLockError as t };
