...
import { a as resolvePluginSetupRegistry, i as resolvePluginSetupProvider } from "./setup-registry-C5GsPAV1.js";
...
import { i as removeProviderAuthProfilesWithLock, r as promoteAuthProfileInOrder, s as upsertAuthProfileWithLock } from "./profiles-DyU-YCq2.js";
import { n as listProfilesForProvider } from "./profile-list-XT2LKXsd.js";
import { n as clearAuthProfileCooldown } from "./usage-CXFpqZhT.js";
...
import { a as loadValidConfigOrThrow, d as updateConfig, s as resolveKnownAgentId } from "./shared-D0zComE5.js";
import { t as isRemoteEnvironment } from "./remote-env-n-Ucnq3R.js";
import { a as restorePriorAgentsDefaultsModelUnlessOptIn, i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-CPGbpMwP.js";
...
async function runProviderAuthMethod(params) {
	...
	const result = await params.method.run({
		...
		openUrl: params.openUrl ?? (async (url) => {
			const { openUrl } = await import("./onboard-helpers-DFkWZq9G.js");
			await openUrl(url);
		}),
