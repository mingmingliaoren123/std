...
import { t as ExitError } from "./runtime-Bz6o617W.js";
import { t as getGatewayRunRuntimeHooks } from "./runtime-hooks-Dp2OHV46.js";
import { t as enforceGatewayRunFutureConfigGuard } from "./future-config-guard-Dsfo4DuW.js";
...
async function pinGatewayRunRuntimePaths() {
	const [{ pinRuntimePaths }, { pinConfigDir }] = await Promise.all([import("./paths-C6ahtu79.js"), import("./utils-DE-8o42N.js")]);
...
async function isSameGatewayRunConfigSnapshot(expected, current, options = {}) {
	const { hashRuntimeConfigValue } = await import("./runtime-snapshot-BGzWnQrW.js");
...
async function guardGatewayRunSelectedConfig(params) {
	...
	const [path, { applyConfigEnvVars, isConfigRuntimeEnvVarAllowed }, { loadGlobalRuntimeDotEnvFiles }, { normalizeEnv }, { normalizeStateDirEnv, resolveStateDir }, { resolveConfigDir }] = await Promise.all([
		import("node:path"),
		import("./env-vars-CxBOhHoc.js"),
		import("./dotenv-global-BWJcNSxD.js"),
		import("./env-BDmU26qh.js"),
		import("./paths-C6ahtu79.js"),
		import("./utils-DE-8o42N.js")
	]);
...
//#endregion
export { applyFinalGatewayRunConfigEnv, clearGatewayRunConfigEnvironment, prepareGatewayRunBootstrap, recheckGatewayRunBootstrap, recheckGatewayRunReset, reloadTrustedGatewayRunEnvironment, selectGatewayRunEnvironment };
