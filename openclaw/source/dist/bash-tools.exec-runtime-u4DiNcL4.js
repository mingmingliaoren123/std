...
import { o as sanitizeBinaryOutput, r as getShellConfig } from "./shell-utils-D5xjUWUG.js";
...
import { F as resolveExecApprovalAllowedDecisions, r as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-BIKWP8_V.js";
import { i as scopedHeartbeatWakeOptionsForPolicy, t as resolveEventSessionKeyForPolicy } from "./event-session-routing-Tqx9dDCC.js";
import "./bash-tools.schemas-DSAIk_o8.js";
import { c as readEnvInt, i as clampWithDefault, r as chunkString, t as buildDockerExecArgs } from "./bash-tools.shared-B6kKIpaT.js";
import { d as markExited, n as appendOutput, p as tail, r as createSessionSlug, t as addSession } from "./bash-process-registry-17q1dHVV.js";
...
async function runExecProcess(opts) {
	...
	const promise = managedRun.wait().then(async (exit) => {
		...
		markExited(session, exit.exitCode, exit.exitSignal, outcome.status, exit.reason, exit.noOutputTimedOut);
