...
import { d as requireTranscriptionText, p as resolveProviderHttpRequestConfig, t as buildAudioTranscriptionFormData, u as postTranscriptionRequest } from "./shared-CFpa8hBG.js";
import "./string-coerce-runtime-ZbuYDJgZ.js";
import "./provider-http-CwvZqS_e.js";
import { t as XAI_BASE_URL } from "./model-definitions-Dr79kPs5.js";
...
async function transcribeXaiAudio(params) {
	...
	try {
		...
		return {
			text: requireTranscriptionText((await readProviderJsonResponse(response, "xai.stt")).text, "xAI transcription response missing text"),
			...model ? { model } : {}
		};
	} finally {
		await release();
