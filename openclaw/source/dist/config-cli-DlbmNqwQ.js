...
import { d as isValidEnvSecretRefId, g as resolveSecretInputRef, s as coerceSecretRef } from "./types.secrets-OocW4TQ1.js";
...
import { a as isValidFileSecretRefId, i as isValidExecSecretRefId, l as secretRefKey, o as isValidSecretProviderAlias, r as formatExecSecretRefIdValidationMessage, u as validateExecSecretRefId } from "./ref-contract-oqYbBqsB.js";
import { a as isPluginIntegrationSecretProviderConfig, r as resolveSecretRefValue, s as resolveSecretProviderIntegrationConfig } from "./resolve-ZNWkJyct.js";
import { n as normalizeAgentModelRefForConfig, t as normalizeAgentModelMapForConfig } from "./model-input-B5RmygIK.js";
import { T as SecretProviderSchema } from "./zod-schema.core-DviqqtPj.js";
...
import { c as resolveConfigSecretTargetByPath, n as discoverConfigSecretTargets } from "./target-registry-CXQ2ov4X.js";
import { n as info, o as success, s as warn, t as danger } from "./globals-0FRK183t.js";
import { J as AUTO_MANAGED_CONFIG_META_PATHS, S as collectUnsupportedSecretRefPolicyIssues, T as validateConfigObjectRawWithPlugins, u as readConfigFileSnapshot } from "./io-By0s-a_s.js";
import { n as formatConfigIssueLines, o as normalizeConfigIssues } from "./issue-format-fzg0yJxc.js";
...
import { s as formatStrictJsonParseFailure } from "./error-format-CcGxQmmN.js";
...
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-BPNN9ZQr.js";
import { n as setCommandJsonMode } from "./json-mode-jhvb894m.js";
...
async function runConfigUnset(opts) {
	...
	try {
		...
		const hint = configApplyHintForOperations([buildUnsetOperation(parsedPath)], currentConfigForApplyHint, normalizeConfigMutationModelRefs(structuredClone(next)));
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-C2-8ysGL.js");
...
//#endregion
export { registerConfigCli, runConfigGet, runConfigPatch, runConfigSet, runConfigUnset };
