...
import { T as freezeDiagnosticTraceContext } from "./diagnostic-events-JZsXee1S.js";
import { t as createSubsystemLogger } from "./subsystem-C3fiUGN1.js";
import { r as hasConfiguredModelFallbacks, y as resolveSessionAgentIds } from "./agent-scope-B2Pk_xhT.js";
...
import { S as withAgentRunLifecycleGeneration, d as getAgentEventLifecycleGeneration, f as getAgentRunContext, g as registerAgentRunContext, l as emitAgentItemEvent, n as captureAgentRunLifecycleGeneration, r as claimAgentRunContext, t as assertAgentRunLifecycleGenerationCurrent } from "./agent-events-CRggPZCM.js";
...
import { i as isMarkdownCapableMessageChannel } from "./message-channel-CB9y2CYk.js";
import { W as updateSessionEntry } from "./session-accessor-D7yi6P1i.js";
import { a as resolveProviderAuthProfileId } from "./provider-hook-runtime-yfrzDCD-.js";
import { b as prepareProviderRuntimeAuth } from "./provider-runtime-CLQOjLJ6.js";
...
import { n as markAuthProfileSuccess } from "./profiles-DyU-YCq2.js";
import { r as resolveSubscriptionAuthModeForProfiles } from "./profile-list-XT2LKXsd.js";
...
import { a as markAuthProfileFailure, s as resolveProfilesUnavailableReason } from "./usage-CXFpqZhT.js";
...
import { _ as shouldPreferExplicitConfigApiKeyAuth, n as applyLocalNoAuthHeaderOverride, o as getApiKeyForModel, t as applyAuthHeaderOverride } from "./model-auth-CJEm9SNp.js";
import { n as formatBillingErrorMessage, x as isTimeoutErrorMessage } from "./sanitize-user-facing-text-D-sR-1VY.js";
import { C as isRateLimitAssistantError, D as parseImageDimensionError, O as parseImageSizeError, S as isLikelyContextOverflowError, _ as isFailoverAssistantError, c as extractObservedOverflowTokenCount, f as isAuthAssistantError, h as isCompactionFailureError, i as classifyFailoverReason, l as formatAssistantErrorText, p as isBillingAssistantError, r as classifyAssistantFailoverReason, v as isFailoverErrorMessage, y as isGenericUnknownStreamErrorMessage } from "./errors-XbAR6hS3.js";
import { a as describeFailoverError, d as resolveFailoverStatus, i as coerceToFailoverError, t as FailoverError } from "./failover-error-B2zFYEnG.js";
import { r as createAgentRunDirectAbortError } from "./run-termination-DjANsN9j.js";
import { n as formatFastModeAutoProgressText, u as resolveFastModeForElapsed } from "./fast-mode-BhVbWk_p.js";
import { t as DEFAULT_AGENT_TIMEOUT_MS } from "./timeout-0Cw4kcol.js";
import { j as resolveCompactionTimeoutMs, k as compactContextEngineWithSafetyTimeout } from "./diagnostic-DhwkYT4X.js";
import "./runs-B0SQhu92.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-DKI4eGAu.js";
import "./sessions-oDygYVdy.js";
import { o as normalizeUsage, t as deriveContextPromptTokens } from "./usage-BJjt0RVM.js";
...
import { i as enqueueCommandInLane, s as getCommandLaneSnapshot } from "./command-queue-DqzpsN4m.js";
import { l as retireSessionMcpRuntime, u as retireSessionMcpRuntimeForSessionKey } from "./agent-bundle-mcp-runtime--G82BMQs.js";
...
import { c as runContextEngineMaintenance, f as buildContextEngineRuntimeSettings, l as waitForDeferredTurnMaintenanceForSession } from "./context-engine-lifecycle-Bv52xohg.js";
import { r as resolveCompactionSuccessorTranscript } from "./types-C3potJ_-.js";
...
import { a as resolveContextWindowInfo, i as formatContextWindowWarningMessage, n as evaluateContextWindowGuard, r as formatContextWindowBlockMessage } from "./context-window-guard-CWGwpEXd.js";
import { n as isRecoverableNativeHarnessBindingFailure, t as maybeCompactAgentHarnessSession } from "./compaction-DiGBGVZl.js";
import { n as resolveModelAsync } from "./model-wpoKGSDF.js";
import { A as EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE, B as resolveRunLivenessState, C as resolveReportedModelRef, D as mergeUsageIntoAccumulator, E as createUsageAccumulator, F as resolveAttemptReplayMetadata, G as createEmbeddedRunReplayState, H as shouldRetryMissingAssistantTurn, I as resolveEmptyResponseRetryInstruction, K as observeReplayMetadata, L as resolveIncompleteTurnPayloadText, M as formatEmbeddedRunStageSummary, N as shouldWarnEmbeddedRunStageSummary, P as hasAttemptTerminalState, R as resolveReasoningOnlyRetryInstruction, S as resolveRateLimitProfileRotationLimit, T as scrubAnthropicRefusalMagic, U as shouldRetrySilentErrorAssistantTurn, V as resolveSilentToolResultReplyPayload, W as shouldTreatEmptyAssistantReplyAsSilent, _ as resolveLatestCallUsage, a as runAgentHarnessAttempt, b as resolveOverloadFailoverBackoffMs, c as RUNTIME_AUTH_REFRESH_MIN_DELAY_MS, d as buildUsageAgentMetaFields, f as createCompactionDiagId, g as resolveFinalAssistantVisibleText, h as resolveFinalAssistantRawText, j as createEmbeddedRunStageTracker, l as RUNTIME_AUTH_REFRESH_RETRY_MS, m as resolveActiveErrorContext, o as selectAgentHarness, p as isAssistantForModelRef, s as RUNTIME_AUTH_REFRESH_MARGIN_MS, t as agentHarnessBuildsOpenClawTools, u as buildErrorAgentMeta, v as resolveMaxRunRetryIterations, w as resolveSameModelRateLimitRetryDelayMs, x as resolveOverloadProfileRotationLimit, y as resolveNextSameModelRateLimitRetryCount, z as resolveReplayInvalidFlag } from "./selection-JInn13lc.js";
import { h as hasOnlyAssistantReasoningContent } from "./openai-transport-stream-B0WkSqXp.js";
import { t as log$1 } from "./logger-rC_P-huq.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-DPPRzCBU.js";
import { N as rotateTranscriptFileAfterCompaction, P as shouldRotateCompactionTranscript, a as normalizeContextTokenBudget, i as mapThinkingLevelForProvider } from "./attempt.model-diagnostic-events-CfZQM0hs.js";
import "./tool-split-BONVLU1k.js";
import { n as resolveProcessToolScopeKey } from "./agent-tools-BD8WL7ny.js";
import { d as isStrictAgenticExecutionContractActive } from "./openclaw-tools-KulZ1cdH.js";
...
import { i as pickFallbackThinkingLevel } from "./embedded-agent-helpers-DZZ4Y-Tw.js";
import { c as resolveSessionSuspensionTarget, f as shouldSuppressRawErrorConsoleSuffix, h as shouldAllowCooldownProbeForReason, l as suspendSession, p as LiveSessionModelSwitchError, s as resolveSessionSuspensionReason, u as buildApiErrorObservationFields } from "./model-fallback-BPQMpbqN.js";
import { a as resolveStoredSessionKeyForSessionId, i as resolveSessionKeyForRequest } from "./session-HDnU4RDT.js";
import { n as resolveEmbeddedCompactionTarget, r as listActiveProcessSessionReferences, t as buildEmbeddedCompactionRuntimeContext } from "./compaction-runtime-context--DEAWi6X.js";
import { n as isExecLikeToolName } from "./tool-error-summary-DDV0ZoKC.js";
import { l as truncateOversizedToolResultsInSession, o as resolveLiveToolResultMaxChars, s as sessionLikelyHasOversizedToolResults } from "./tool-result-truncation-rzMcqvvu.js";
import { n as runAgentCleanupStep } from "./attempt.tool-run-context-CuQsIXnb.js";
import "./extra-params-cce1g0up.js";
import { m as resolveContextEngineCapabilities, r as forgetPromptBuildDrainCacheForRun } from "./attempt.prompt-helpers-kaS3UZwL.js";
import "./sandbox-info-DMlJwv6b.js";
...
import { t as DEFERRED_CONTEXT_ENGINE_COMPACTION_REASON } from "./compact-reasons-ByJlIe1a.js";
import { n as createAgentHarnessTaskRuntimeScope } from "./agent-harness-task-runtime-scope-AnHXK_PY.js";
import { t as resolveExternalCliAuthOverlayScopeFromSelection } from "./external-cli-auth-selection-CpZ9SFi_.js";
import { n as shouldSwitchToLiveModel, t as clearLiveModelSwitchPending } from "./live-model-switch-DQnYRJVV.js";
import { t as buildAgentRuntimeAuthPlan } from "./auth-DoAD_162.js";
import { r as buildAgentRuntimePlan } from "./build-Ddh53bqq.js";
...
import { t as buildEmbeddedRunPayloads } from "./payloads-1r4oLFNi.js";
...
function mergeAttemptToolMediaPayloads(params) {
	...
	if (payloadIndex >= 0) {
		...
		const mergedMediaUrls = Array.from(/* @__PURE__ */ new Set([...payload.mediaUrls ?? [], ...mediaUrls]));
...
function resolveEmbeddedRunLaneTimeoutMs(timeoutMs) {
	...
	return addTimerTimeoutGraceMs(Math.floor(timeoutMs), EMBEDDED_RUN_LANE_TIMEOUT_GRACE_MS) ?? defaultLaneTimeoutMs;
}
...
async function runEmbeddedAgentInternal(paramsInput) {
	...
	return enqueueSession(async () => {
		...
		return enqueueGlobal(async () => {
			...
			const modelSelectionChangedByHook = hookSelection.provider !== provider || hookSelection.modelId !== modelId;
			...
			const markAuthProfileSuccessAfterRun = () => {
				...
				const successProvider = resolveAuthProfileStateProvider(profileFailureStore, successProfileId, provider);
				...
				markAuthProfileSuccess({
					...
					if (durationMs >= POST_RUN_AUTH_PROFILE_SUCCESS_SLOW_MS) log$1.warn(`post-run auth-profile success bookkeeping completed after ${durationMs}ms: runId=${params.runId} sessionId=${params.sessionId} provider=${sanitizeForLog(successProvider)} profileId=${safeSuccessProfileId}`);
					else if (log$1.isEnabled("trace")) log$1.trace(`post-run auth-profile success bookkeeping completed: runId=${params.runId} sessionId=${params.sessionId} durationMs=${durationMs}`);
				}).catch((err) => {
					log$1.warn(`post-run auth-profile success bookkeeping failed: runId=${params.runId} sessionId=${params.sessionId} provider=${sanitizeForLog(successProvider)} profileId=${safeSuccessProfileId} error=${formatErrorMessage(err)}`);
				});
			};
			...
			try {
				...
				const runOwnsCompactionAfterHook = async (reason, compactResult, previousSessionId) => {
					...
					try {
						await hookRunner.runAfterCompaction({
							...
							sessionFile: resolveCompactionSuccessorTranscript(compactResult).sessionFile ?? activeSessionFile,
				...
				while (true) {
					...
					bootstrapPromptWarningSignaturesSeen = attempt.bootstrapPromptWarningSignaturesSeen ?? (attempt.bootstrapPromptWarningSignature ? Array.from(/* @__PURE__ */ new Set([...bootstrapPromptWarningSignaturesSeen, attempt.bootstrapPromptWarningSignature])) : bootstrapPromptWarningSignaturesSeen);
					...
					if (timedOut && !timedOutDuringCompaction && !timedOutDuringToolExecution && !timedOutByRunBudget) {
						const lastTurnPromptTokens = deriveContextPromptTokens({ lastCallUsage: lastRunPromptUsage });
					...
					if (contextOverflowError) {
						...
						const overflowTokenCountForCompaction = observedOverflowTokens ?? preflightEstimatedPromptTokens ?? (ctxInfo.tokens > 0 ? ctxInfo.tokens + 1 : void 0);
					...
					const assistantProfileFailureReason = resolveRunAuthProfileFailureReason(assistantProfileFailoverReason, {
						...
						transientRateLimit: assistantProfileFailoverReason === "rate_limit" && isShortWindowRateLimitMessage(attemptAssistant?.errorMessage)
					});
					const cloudCodeAssistFormatError = attempt.cloudCodeAssistFormatError;
					const imageDimensionError = parseImageDimensionError(attemptAssistant?.errorMessage ?? "");
					const genericUnknownReasoningError = assistantFailoverReason === "timeout" && isGenericUnknownStreamErrorMessage(attemptAssistant?.errorMessage ?? "") && Boolean(attemptAssistant && hasOnlyAssistantReasoningContent(attemptAssistant));
					...
					if (authFailure && await maybeRefreshRuntimeAuthForAuthError(attemptAssistant?.errorMessage ?? "", runtimeAuthRetry)) {
						authRetryPending = true;
						continue;
					}
					...
					const finalAssistantStopReason = (attemptAssistant?.stopReason ?? "").trim().toLowerCase();
					...
					const stopReason = attempt.clientToolCalls ? "tool_calls" : attempt.yieldDetected ? "end_turn" : attemptAssistant?.stopReason;
					...
					return {
						...
						meta: {
							...
							executionTrace: {
								...
								attempts: traceAttempts.length > 0 || attemptAssistant?.provider || attemptAssistant?.model ? [...traceAttempts, {
									provider: reportedModelRef.provider,
									model: reportedModelRef.model,
									result: "success",
									stage: "assistant"
