...
import { a as normalizeModelRef } from "./model-selection-normalize-Y5vjde6P.js";
...
import { t as complete } from "./stream-BcRkg2P0.js";
...
import { f as resolveApiKeyForProvider, o as getApiKeyForModel, r as applySecretRefHeaderSentinels } from "./model-auth-CJEm9SNp.js";
import { n as resolveModelAsync } from "./model-wpoKGSDF.js";
import { r as minimaxUnderstandImage, t as isMinimaxVlmModel } from "./minimax-vlm-CvP1HtmK.js";
import { i as hasImageReasoningOnlyResponse, t as coerceImageAssistantText } from "./image-tool.helpers-COuozezb.js";
...
import { o as resolveCopilotApiToken } from "./provider-auth-RO8h-UjC.js";
...
async function prepareResolvedImageRuntime(params, resolvedModel, authStorage) {
	...
	if (model.provider === "github-copilot") {
		const copilotToken = await resolveCopilotApiToken({ githubToken: unwrapSecretSentinelsForProviderEgress(apiKey, "GitHub Copilot image-auth exchange") });
