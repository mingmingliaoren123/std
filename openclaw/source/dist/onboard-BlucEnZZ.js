...
import { d as isValidEnvSecretRefId, g as resolveSecretInputRef } from "./types.secrets-OocW4TQ1.js";
...
import "./daemon-runtime-CHOL1Kuf.js";
...
import { r as formatInvalidPortOption } from "./error-format-CcGxQmmN.js";
import { r as resolveLocalControlUiProbeLinks } from "./control-ui-links-DU4RsFVC.js";
...
import { c as normalizeGatewayTokenInput, h as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-DajOrUWU.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-BSbSMamL.js";
import { n as applySkipBootstrapConfig, t as applyLocalSetupWorkspaceConfig } from "./onboard-config-BueUmvNG.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-BCl3B6K2.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	const inferredAuthChoice = opts.authChoice ? void 0 : (await import("./auth-choice-inference-CLqRv3r8.js")).inferAuthChoiceFromFlags(opts, {
		config: nextConfig,
		workspaceDir,
		env: process.env
	});
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-CCmUJ4A2.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-75IfcYMc.js");
...
async function runNonInteractiveMigrationImport(params) {
	...
	const { detectSetupMigrationSources, runSetupMigrationImport } = await import("./setup.migration-import-CwObL1wn.js");
...
*/
const CONVERSATIONAL_SAFE_ONBOARD_KEYS = /* @__PURE__ */ new Set([
	"workspace",
	"acceptRisk",
	"reset",
	"resetScope",
...
function wantsClassicInteractiveSetup(opts) {
	...
	for (const [key, value] of Object.entries(opts)) {
		if (CONVERSATIONAL_SAFE_ONBOARD_KEYS.has(key) || key === "installDaemon") continue;
