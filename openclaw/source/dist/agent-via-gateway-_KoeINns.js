...
import { _ as randomIdempotencyKey, b as readGatewayDispatchConfig, c as callGateway, g as isGatewayTransportError, h as isGatewayExplicitAuthRequiredError, m as isGatewayCredentialsRequiredError, x as readGatewayDispatchConfigWithShellEnvFallback } from "./call-Bj6Erfmh.js";
...
const defaultAgentSessionModuleLoader = () => import("./session-Mrxes3c_.js");
let agentSessionModuleLoader = defaultAgentSessionModuleLoader;
const embeddedAgentCommandLoader = createLazyPromiseLoader(() => import("./agent-D4uWiKcR.js").then((module) => module.agentCommand), { cacheRejections: true });
const agentSessionModuleCache = createLazyPromiseLoader(() => agentSessionModuleLoader(), { cacheRejections: true });
const runtimeConfigModuleLoader = createLazyPromiseLoader(() => import("./io-CXugYKHV.js"), { cacheRejections: true });
