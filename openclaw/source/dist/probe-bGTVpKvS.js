...
import { a as optionalPositiveIntegerSchema } from "./typebox-DnTTOzWO.js";
...
import { r as resolveTelegramTransport, t as resolveTelegramApiBase } from "./fetch-CIzSSo90.js";
import { a as isRecoverableTelegramNetworkError, p as isTelegramPollingNetworkError } from "./request-timeouts-B3dsnJN5.js";
import "./routing-D8zbLWGc.js";
import { c as buildExecApprovalPendingReplyPayload } from "./exec-approval-reply-DiCxsYva.js";
...
import { a as listTokenSourcedAccounts, i as createUnionActionGate, r as resolveReactionMessageId } from "./channel-actions-DLW94VY-.js";
import { t as extractToolSend } from "./tool-send-DlIp2cBO.js";
import { c as resolveTelegramPollActionGateState, o as resolveTelegramAccount, r as listTelegramAccountIds, t as createTelegramActionGate } from "./accounts-B2_AQ-Fk.js";
import { t as inspectTelegramAccount } from "./account-inspect-knxgsSIa.js";
import { t as isTelegramInlineButtonsEnabled } from "./inline-buttons-_oqBQ1k2.js";
import { a as isTelegramExecApprovalHandlerConfigured, i as isTelegramExecApprovalClientEnabled } from "./exec-approvals-Boc7P3w5.js";
...
const loadTelegramActionRuntime = createLazyRuntimeModule(() => import("./action-runtime-Cv7KsCc_.js"));
...
async function probeTelegram(token, timeoutMs, proxyOrOptions) {
	...
	try {
		...
		const meJson = JSON.parse((await readResponseWithLimit(meRes, TELEGRAM_BOT_API_MAX_RESPONSE_BYTES)).toString("utf8"));
		...
		if (includeWebhookInfo) try {
			...
			if (webhookRemainingBudgetMs > 0) {
				...
				const webhookJson = JSON.parse((await readResponseWithLimit(webhookRes, TELEGRAM_BOT_API_MAX_RESPONSE_BYTES)).toString("utf8"));
