...
import { S as createDiagnosticTraceContext, c as emitTrustedSecurityEvent, j as runWithDiagnosticTraceContext } from "./diagnostic-events-JZsXee1S.js";
import { a as isPrivateOrLoopbackAddress, c as isTrustedProxyAddress, f as resolveClientIp, h as resolveHostName, i as isLoopbackHost, n as isLocalishHost, o as isPrivateOrLoopbackHost, r as isLoopbackAddress } from "./net-BOKtNTf8.js";
import { a as AUTH_RATE_LIMIT_SCOPE_NODE_PAIRING, r as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, s as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, t as AUTH_RATE_LIMIT_SCOPE_BOOTSTRAP_TOKEN } from "./auth-rate-limit-DczU2XgX.js";
import { a as hasForwardedRequestHeaders, c as withSerializedRateLimitAttempt, i as authorizeWsControlUiGatewayConnect, l as checkBrowserOrigin, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect } from "./auth-B27MflKU.js";
...
import { a as normalizeDevicePublicKeyBase64Url, c as verifyDeviceSignature, t as deriveDeviceIdFromPublicKey } from "./device-identity-UW4cZXf5.js";
...
import { c as buildDeviceAuthPayloadV3, l as normalizeDeviceMetadataForAuth, s as buildDeviceAuthPayload } from "./src-DZzKBMa7.js";
...
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, t as isBrowserOperatorUiClient } from "./message-channel-CB9y2CYk.js";
import { n as verifyAgentRuntimeIdentityToken } from "./agent-runtime-identity-token-DKW8iHbQ.js";
import { n as isOperatorApprovalRuntimeToken } from "./operator-approval-runtime-token-C4_aKCYZ.js";
import { Ht as validateRequestFrame, R as validateConnectParams, t as formatValidationErrors } from "./src-CToKmqGn.js";
import { Gn as errorShape, Wn as ErrorCodes, pn as GATEWAY_SERVER_CAPS } from "./schema-BuOFpc7K.js";
import { t as rawDataToString } from "./ws-C3qhmaFC.js";
import { d as updatePairedNodeMetadata, h as sameNodePermissionSurface, l as requestNodePairing, m as sameNodeApprovalSurfaceSet, n as beginNodePairingConnect, o as releaseNodePairingCleanupClaim, p as normalizeNodeApprovalSurfaceList, r as finalizeNodePairingCleanupClaim } from "./node-pairing-C0KBZUMJ.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins } from "./remote-CUhvVY5E.js";
...
import { c as resolveNodePairingCommandAllowlist, n as filterLegacyNodeProtocolFeatures, o as normalizeDeclaredNodeCommands, s as resolveNodeCommandAllowlist } from "./node-command-policy-CO8bCAnE.js";
import { n as logWs, t as formatForLog } from "./ws-log-DlOPjxAD.js";
import { a as redeemDeviceBootstrapTokenProfile, d as isPairingSetupBootstrapProfile, l as verifyDeviceBootstrapToken, m as resolveBootstrapProfileScopesForRoles, n as getBoundDeviceBootstrapProfile, o as restoreDeviceBootstrapToken, p as resolveBootstrapProfileScopesForRole, r as getDeviceBootstrapTokenProfile, s as revokeDeviceBootstrapToken } from "./device-bootstrap-9NweVse9.js";
import { a as getPairedDevice, c as listApprovedPairedDeviceRoles, l as listDevicePairing, m as requestDevicePairing, n as approveDevicePairing, r as ensureDeviceToken, s as hasEffectivePairedDeviceRole, t as approveBootstrapDevicePairing, u as listEffectivePairedDeviceRoles, v as updatePairedDeviceMetadata, y as verifyDeviceToken } from "./device-pairing-Dw7KWdQ7.js";
import { t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-D1sSmmLl.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-DruWzfsQ.js";
import { r as loadVoiceWakeConfig, t as formatError } from "./server-utils-BGAdTqht.js";
import { r as upsertPresence } from "./system-presence-D0ief7yP.js";
import { a as incrementPresenceVersion, n as getHealthCache, r as getHealthVersion, t as buildGatewaySnapshot } from "./health-state-Bj_QhGa5.js";
import { n as parseGatewayRole, r as roleCanSkipDeviceIdentity } from "./role-policy-BQfpZQ2J.js";
...
function listControlUiPluginTabs(scopes) {
	return projectControlUiPluginTabs(getActivePluginRegistry()?.controlUiDescriptors ?? [], scopes);
}
//#endregion
	...
	const handleMessage = async (data) => {
		...
		try {
			...
			if (!client) {
				...
				if (hasSharedAuth || Boolean(connectParams.auth?.bootstrapToken) || Boolean(connectParams.auth?.deviceToken) || Boolean(device)) advanceHandshakePhase("auth_credentials_received");
				...
				if (device && devicePublicKey) {
					...
					const requirePairing = async (reason, existingPairedDevice = null) => {
						...
						for (const superseded of pairing.superseded ?? []) context.broadcast("device.pair.resolved", {
							requestId: superseded.requestId,
			...
			const dispatch = (async () => {
				const { handleGatewayRequest } = await import("./server-methods-NpEcZnvp.js");
