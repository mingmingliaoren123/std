...
import "./server-middleware-CQyb39Q7.js";
import "./bridge-server-DERz4ZMA.js";
import { z as DEFAULT_BROWSER_ACTION_TIMEOUT_MS } from "./cdp.helpers-B9jipAGQ.js";
import { n as resolveBrowserConfig } from "./config-DpWXcVmn.js";
import "./control-auth-D64Cie7O.js";
import "./chrome.executables-DP_XzlNl.js";
import "./trash-fHzBC5m1.js";
import "./sdk-setup-tools-DvUR7fn4.js";
import { S as withBaseUrl, b as fetchBrowserJson, x as buildProfileQuery } from "./session-tab-registry-B1SHveNU.js";
import "./routes-VNv3nd0n.js";
import { i as loadBrowserConfigForRuntimeRefresh } from "./server-context-CHfAdCP1.js";
import "./snapshot-urls-CSy_q5ul.js";
...
*/
const BROWSER_REQUEST_TIMEOUT_SLACK_MS = 5e3;
...
function resolveBrowserActRequestTimeoutMs(req) {
	...
	const candidateTimeouts = explicitTimeout === void 0 ? [DEFAULT_BROWSER_ACTION_TIMEOUT_MS] : [addTimerTimeoutGraceMs(explicitTimeout, BROWSER_REQUEST_TIMEOUT_SLACK_MS) ?? 1];
	if (req.kind === "wait") {
		const waitDuration = normalizePositiveTimeoutMs(req.timeMs);
		if (waitDuration !== void 0) candidateTimeouts.push(addTimerTimeoutGraceMs(waitDuration, BROWSER_REQUEST_TIMEOUT_SLACK_MS) ?? 1);
	}
	return Math.max(...candidateTimeouts);
}
function resolveBrowserOperationRequestTimeoutMs(timeoutMs) {
	return addTimerTimeoutGraceMs(normalizePositiveTimeoutMs(timeoutMs) ?? 12e4, BROWSER_REQUEST_TIMEOUT_SLACK_MS) ?? 1;
}
...
//#endregion
export { applyBrowserProxyPaths as a, browserPdfSave as c, browserArmFileChooser as d, browserDownload as f, browserWaitForDownload as h, resolveRequestedBrowserProfile as i, browserAct as l, browserScreenshotAction as m, isPersistentBrowserProfileMutation as n, persistBrowserProxyFiles as o, browserNavigate as p, normalizeBrowserRequestPath as r, browserConsoleMessages as s, runBrowserProxyCommand as t, browserArmDialog as u };
