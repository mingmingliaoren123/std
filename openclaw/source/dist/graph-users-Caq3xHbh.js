...
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, c as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-DKsCBaFj.js";
...
import { c as createMSTeamsHttpError, n as refreshMSTeamsDelegatedTokens } from "./oauth.token-DnwthC4R.js";
...
const loadSdkModules = createLazyRuntimeModule(() => Promise.all([import("./dist-DtVSQKwy.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-C9eZrdKb.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([apps, api]) => ({
	App: apps.App,
...
//#endregion
export { GRAPH_ROOT as A, normalizeContentType as B, describeBotFrameworkServiceUrlHost as C, resolveMSTeamsSdkCloudOptions as D, tryNormalizeBotFrameworkServiceUrl as E, extractInlineImageCandidates as F, safeFetchWithPolicy as G, resolveAttachmentFetchPolicy as H, inferPlaceholder as I, safeHostForUrl as K, isDownloadableAttachment as L, applyAuthorizationHeaderForUrl as M, encodeGraphShareId as N, validateMSTeamsProactiveServiceUrlBoundary as O, extractHtmlFromAttachment as P, isLikelyImageAttachment as R, ensureUserAgentHeader as S, normalizeBotFrameworkServiceUrl as T, resolveMediaSsrfPolicy as U, readNestedString as V, resolveRequestUrl as W, readAccessToken as _, fetchGraphJson as a, loadMSTeamsSdkWithAuth as b, normalizeQuery as c, postGraphJson as d, resolveGraphToken as f, saveDelegatedTokens as g, resolveMSTeamsCredentials as h, fetchGraphAbsoluteUrl as i, IMG_SRC_RE as j, ATTACHMENT_TAG_RE as k, patchGraphJson as l, loadDelegatedTokens as m, deleteGraphRequest as n, listChannelsForTeam as o, hasConfiguredMSTeamsCredentials as p, tryBuildGraphSharesUrlForSharedLink as q, escapeOData as r, listTeamsByName as s, searchGraphUsers as t, postGraphBetaJson as u, createMSTeamsExpressAdapter as v, isAllowedBotFrameworkServiceUrl as w, buildUserAgent as x, createMSTeamsTokenProvider as y, isUrlAllowed as z };
