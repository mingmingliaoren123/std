import { d as resolveGatewayPort, s as resolveConfigPath } from "./paths-BMBAvkNf.js";
...
import { c as resolveDefaultAgentId, t as listAgentEntries } from "./agent-scope-config-BxAUeF6t.js";
import { u as readConfigFileSnapshot } from "./io-By0s-a_s.js";
import "./config-DbyjySSE.js";
import { n as probeLocalCommand, t as probeGatewayUrl } from "./probes-BMBos227.js";
import { n as OPENCLAW_SOURCE_URL, r as resolveOpenClawReferencePaths, t as OPENCLAW_DOCS_URL } from "./docs-path-DunqWXDr.js";
...
async function loadCrestodianOverview(opts = {}) {
	...
	let gatewayError;
	try {
		const details = (deps.buildGatewayConnectionDetails ?? (await import("./call-BZWJ3eG1.js")).buildGatewayConnectionDetails)({
			config: cfg,
			configPath
		});
...
function formatCrestodianOverview(overview) {
	...
	return [
		...
		`AI: ${overview.defaultModel ? `conversation runs on ${overview.defaultModel}` : "no model configured; local Claude Code/Codex/Gemini logins are reused when present"}`,
...
//#endregion
export { loadCrestodianOverview as i, formatCrestodianOverview as n, formatCrestodianStartupMessage as r, formatCrestodianOnboardingWelcome as t };
