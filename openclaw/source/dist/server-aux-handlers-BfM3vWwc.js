...
import { g as resolveSecretInputRef } from "./types.secrets-OocW4TQ1.js";
import { t as createSubsystemLogger } from "./subsystem-C3fiUGN1.js";
import { r as resolveSecretRefValue } from "./resolve-ZNWkJyct.js";
import { o as resolveManifestContractOwnerPluginId } from "./plugin-registry-8E8D2Hou.js";
import { t as assertExpectedResolvedSecretValue } from "./secret-value-BBML_Bfe.js";
import { r as createResolverContext } from "./runtime-shared-D99zx8IE.js";
import { i as setPathExistingStrict, n as getPath } from "./path-utils-CvA6hCf7.js";
...
import { i as loadOrCreateProcessDeviceIdentity } from "./device-identity-UW4cZXf5.js";
...
import { t as resolveChannelApprovalAdapter } from "./plugins-CWbO0qGI.js";
...
import { i as getActiveSecretsRuntimeEnv, o as getActiveSecretsRuntimeSnapshot } from "./runtime-state-CPERULut.js";
import { a as diffConfigPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-BWsbDT0K.js";
import { c as buildPluginApprovalRequestMessage, o as approvalDecisionLabel, s as buildPluginApprovalExpiredMessage, u as resolvePluginApprovalRequestAllowedDecisions } from "./plugin-approvals-D2muXfhg.js";
import { I as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-BIKWP8_V.js";
import { n as collectCommandSecretAssignmentsFromSnapshot, t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-IDFOxCBz.js";
import { a as resolveBundledExplicitWebSearchProvidersFromPublicArtifacts } from "./web-provider-public-artifacts.explicit-C-crZoPf.js";
import { t as resolveRuntimeWebTools } from "./runtime-web-tools-BBMZbD4q.js";
...
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-BkvgprVl.js";
import { d as formatExecApprovalExpiresIn } from "./exec-approval-reply-DiCxsYva.js";
import { i as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-BpZj7eqi.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-BgG9iK4C.js";
import { l as listDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-Dw7KWdQ7.js";
import { d as shouldClearStoredApnsRegistration, f as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalAlert, o as resolveApnsAuthConfigFromEnv, r as loadApnsRegistrations, t as clearApnsRegistrationIfCurrent, u as sendApnsExecApprovalResolvedWake } from "./push-apns-CJvPes3P.js";
...
async function activateSecretsRuntimeSnapshot(snapshot) {
	(await import("./runtime-v3H-VKlD.js")).activateSecretsRuntimeSnapshot(snapshot);
}
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = createLazyPromise(() => import("./exec-approval-DRfKKxhu.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = createLazyPromise(() => import("./plugin-approval-C2VV4Mty.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder })), { cacheRejections: true });
	...
	const loadSecretsHandlers = createLazyPromise(() => import("./secrets-VXesZ1oE.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
