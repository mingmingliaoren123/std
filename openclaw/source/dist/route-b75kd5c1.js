...
import { a as getPositiveIntFlagValue, c as hasFlag, i as getFlagValue, j as isValueToken, r as getCommandPositionalsWithRootOptions, s as getVerboseFlag } from "./argv-APLDYHWW.js";
import { t as resolveCliArgvInvocation } from "./argv-invocation-DJKlVa-q.js";
import { r as defaultRuntime } from "./runtime-Bz6o617W.js";
import { S as tryParseLogLevel } from "./logger-DPps3u8A.js";
import { i as cliCommandCatalog, r as matchesCommandPath, t as resolveCliCommandPathPolicy } from "./command-path-policy-NzlS0DJF.js";
...
const configCliLoader = createLazyImportLoader(() => import("./config-cli-DlbmNqwQ.js"));
const agentsListCommandLoader = createLazyImportLoader(() => import("./agents.commands.list-m4wiNATp.js"));
const modelsListCommandLoader = createLazyImportLoader(() => import("./list.list-command-VvsnQYl4.js"));
const modelsStatusCommandLoader = createLazyImportLoader(() => import("./list.status-command-Drq9c0PM.js"));
const tasksJsonCommandLoader = createLazyImportLoader(() => import("./tasks-json-_TGLxTgD.js"));
...
const routedCommandDefinitions = {
	...
	status: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			if (args.json) {
				const { statusJsonCommand } = await import("./status-json-CDFQ7qzJ.js");
			...
			const { statusCommand } = await import("./status-C2L_RAUc.js");
	...
	"gateway-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runDaemonStatus } = await import("./status-DuSwGker.js");
	...
	sessions: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { sessionsCommand } = await import("./sessions-CRLZ6TJ_.js");
	...
	"channels-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsListCommand } = await import("./list-C_x5XZK7.js");
	...
	"channels-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsStatusCommand } = await import("./status-Bnczvft9.js");
