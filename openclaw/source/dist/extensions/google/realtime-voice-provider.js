...
import { Q as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, T as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, Z as REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ } from "../../session-log-runtime-BUZsJRws.js";
import { i as resamplePcm, n as mulawToPcm, t as convertPcmToMulaw8k } from "../../realtime-voice-DS5n5Pmp.js";
...
function buildFunctionDeclarations(tools) {
	...
	for (const tool of tools ?? []) try {
		...
		if (name === "openclaw_agent_consult") declaration.behavior = "NON_BLOCKING";
