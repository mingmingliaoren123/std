...
import "../../api-BV1blZRJ.js";
import { i as WorkboardStore, n as cleanupWorkboardRunWorktree, r as dispatchAndStartWorkboardCards, t as registerWorkboardGatewayMethods } from "../../runtime-api-BWc6b9BO.js";
...
async function handleWorkboardCommand(params) {
	...
	if (action === "dispatch") {
		...
		const result = await dispatchAndStartWorkboardCards({
			...
			options: { allowManagedWorktrees: params.gatewayClientScopes ? params.gatewayClientScopes.includes(ADMIN_SCOPE) : params.senderIsOwner === true }
		});
		return { text: [
...
var workboard_default = definePluginEntry({
	...
	register(api) {
		...
		api.registerCli(async ({ program }) => {
			const { registerWorkboardCli } = await import("../../cli-CCicVRof.js");
