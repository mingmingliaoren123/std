...
import { a as channelToNpmTag, l as normalizeUpdateChannel } from "./update-channels-CIHQjIuI.js";
import { n as compareSemverStrings, s as resolveNpmChannelTag, t as checkUpdateStatus } from "./update-check-BZM1fqQO.js";
import { t as CONTROL_PLANE_UPDATE_HANDOFF_STARTED_REASON } from "./update-control-plane-sentinel-D20TCpV7.js";
import { r as startManagedServiceUpdateHandoff } from "./update-managed-service-handoff-Bj9JhPT-.js";
		...
		if (shouldRunAutoUpdate && (channel === "stable" || channel === "beta")) {
			...
			if (!dueNow) params.log.info("auto-update deferred (stable rollout window active)", {
				...
				const outcome = await runAuto({
					...
					restartDrainTimeoutMs: resolveGatewayRestartDeferralTimeoutMs(getRuntimeConfig().gateway?.reload?.deferralTimeoutMs),
