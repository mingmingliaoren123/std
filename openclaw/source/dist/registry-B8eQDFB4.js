import { a as normalizeLowercaseStringOrEmpty, c as normalizeOptionalString$1, f as normalizeStringifiedOptionalString } from "./string-coerce-DW4mBlAt.js";
import { r as createLazyRuntimeModule } from "./lazy-runtime-BgpbKGBP.js";
import { o as isRecord } from "./record-coerce-DHZ4bFlT.js";
import { O as normalizeCommandDescriptorName, k as sanitizeCommandDescriptorDescription } from "./argv-APLDYHWW.js";
...
import { i as parseModelCatalogRef } from "./model-catalog-refs-wLetjjEO.js";
...
import { v as getPluginCompatRecord } from "./installed-plugin-index-N4jxqS0-.js";
import { f as normalizeChannelMeta } from "./bundled-ClxzUaje.js";
import { x as registerEmbeddingProvider, y as getRegisteredEmbeddingProvider } from "./gateway-startup-plugin-ids-COmsQTCi.js";
...
import { n as listChatChannels } from "./chat-meta-DFPCGvjr.js";
import { t as buildPluginApi } from "./api-builder-CX43eAAh.js";
import { a as registerAgentHarness, r as getRegisteredAgentHarness } from "./registry-DtLZ3rba.js";
...
import { E as pluginCommands, S as clearPluginCommandsForPlugin, g as isPromptInjectionHookName, h as isPluginHookName, i as registerPluginCommand, l as DEPRECATED_PLUGIN_HOOKS, m as isDeprecatedPluginHookName, o as validatePluginCommandDefinition, p as isConversationHookName, t as isReservedCommandName, y as stripPromptMutationFieldsFromLegacyHookResult } from "./command-registration-tKF3dsKu.js";
import { A as clearPluginRunContext, B as isPluginRegistryActivated, F as registerPluginSessionSchedulerJob, I as setPluginRunContext, L as buildPluginAgentTurnPrepareContext, M as getPluginRunContext, N as getPluginSessionSchedulerJobGeneration, O as createEmptyPluginRegistry, R as normalizePluginHostHookId, V as isPluginRegistryRetired, c as getActivePluginRegistry, j as deletePluginSessionSchedulerJob, p as getActivePluginSessionExtensionRegistry } from "./runtime-D0xGMZdc.js";
import { c as emitAgentEvent } from "./agent-events-CRggPZCM.js";
import { t as isPluginJsonValue } from "./host-hook-json-CRVrIqU9.js";
import { a as registerRegistryPluginInteractiveHandler, n as clearPluginInteractiveHandlersForPlugin } from "./interactive-registry-BnOxEacm.js";
import { _ as registerMemoryRuntimeForPlugin, f as registerMemoryFlushPlanResolverForPlugin, h as registerMemoryPromptSupplement, l as registerMemoryCapability, m as registerMemoryPromptSectionForPlugin, u as registerMemoryCorpusSupplement } from "./memory-state-DefveORB.js";
import { t as createChannelIngressQueue } from "./ingress-queue-lWy32rOT.js";
import { n as createPluginStateKeyedStore, r as createPluginStateSyncKeyedStore } from "./plugin-state-store-i0oVFZ17.js";
import { a as registerContextEngineForOwner, t as clearContextEnginesForOwner } from "./registry-CAWC0LBH.js";
import { r as createPluginGatewayMethodDescriptor } from "./registry-D61Kc28k.js";
import { f as registerInternalHook, h as unregisterInternalHook } from "./internal-hooks-CpcP-fFV.js";
...
import { a as normalizeAgentToolResultMiddlewareRuntimeIds, n as normalizePluginToolContractNames, o as normalizeAgentToolResultMiddlewareRuntimes, r as normalizePluginToolNames, t as findUndeclaredPluginToolNames } from "./tool-contracts-CY1rM48O.js";
import { n as detectMime, t as FILE_TYPE_SNIFF_MAX_BYTES, u as normalizeMimeType } from "./mime-BaK8UYea.js";
import { n as resolveWorkspaceRoot, r as resolvePathFromInput } from "./workspace-dir-CgYmgqVr.js";
import { at as normalizeSessionEntrySlotKey } from "./store-BJJhlPrk.js";
...
import { I as resolveSessionEntryAccessTarget, U as updateResolvedSessionEntry } from "./session-accessor-D7yi6P1i.js";
import { t as extractDeliveryInfo } from "./delivery-info-C49QS7yM.js";
import "./host-hook-cleanup-CGZpGJtq.js";
...
const loadSendMessage = createLazyRuntimeModule(() => import("./message-B9sUJMRK.js").then((module) => module.sendMessage));
const loadGetChannelPlugin = createLazyRuntimeModule(() => import("./plugins-BXFVeiru.js").then((module) => module.getChannelPlugin));
		...
		const runtime = new Proxy(registryParams.runtime, { get(target, prop, receiver) {
			...
			if (prop === "gateway") {
				...
				return {
					...
					request: (method, params, options) => runWithPluginScope(() => gateway.request(method, params, options))
				};
			}
			if (prop === "nodes") {
