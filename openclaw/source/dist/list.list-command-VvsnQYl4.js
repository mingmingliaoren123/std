...
import { v as loadPluginRegistrySnapshotWithMetadata } from "./plugin-registry-8E8D2Hou.js";
...
import { c as parseModelRef, i as modelKey } from "./model-selection-normalize-Y5vjde6P.js";
import { b as resolveProviderEnvAuthLookupMaps, y as listProviderEnvAuthLookupKeys } from "./model-auth-markers-BY1lCZu4.js";
...
import { d as hasUsableCustomProviderApiKey, u as hasSyntheticLocalProviderAuthConfig } from "./model-auth-CJEm9SNp.js";
import { n as requestExitAfterOneShotOutput } from "./one-shot-exit-DdMGi0bf.js";
import { i as formatTokenK, m as createModelCatalogProviderAliasCanonicalizer, n as ensureFlagCompatibility, p as canonicalizeModelCatalogProviderAlias } from "./shared-D0zComE5.js";
import { n as loadModelsConfigWithSource } from "./load-config-mhW1fUy4.js";
...
function createModelListAuthIndex(params) {
	...
	const hasEnvProviderAuth = (provider) => {
		...
		const hasAuth = Boolean(resolveEnvApiKey(provider, env, {
			aliasMap,
			candidateMap: skipSetupProviderFallback || hasPrecomputedCandidates ? envCandidateMap : void 0,
			authEvidenceMap: skipSetupProviderFallback || hasPrecomputedEvidence ? authEvidenceMap : void 0,
			skipSetupProviderFallback,
			config: params.cfg,
			workspaceDir: params.workspaceDir
		}));
...
const promotionsModuleLoader = createLazyImportLoader(() => import("./list.promotions-D28D1Ut_.js"));
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-DwoErezz.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-DmX051c6.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-DW391_X-.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-DTzeain0.js"),
		import("./agent-scope-w9VdIGfQ.js"),
		import("./workspace-xomQRDYz.js")
	]);
