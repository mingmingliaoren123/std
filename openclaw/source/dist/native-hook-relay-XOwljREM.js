...
import { r as hasGlobalHooks } from "./hook-runner-global-BmIrGlLG.js";
import { t as stableStringify } from "./stable-stringify-Cd9_EGsU.js";
import { m as normalizeToolName } from "./tool-policy-BHUGxE3p.js";
import { f as runBeforeToolCallHook, n as cancelDeferredPluginToolApproval, o as hasBeforeToolCallPolicy, u as requestDeferredPluginToolApproval } from "./agent-tools.before-tool-call-C95DXQXZ.js";
...
import { t as runAgentHarnessAfterToolCallHook } from "./hook-helpers-GgBV1rQp.js";
...
function registerNativeHookRelay(params) {
	...
	const handle = {
		...
		renew: (ttlMs) => {
			...
			if (bridge && bridge.server.listening) writeNativeHookRelayBridgeRecordForRegistration(current, bridge);
		},
