...
import { c as kindFromMime } from "./mime-BaK8UYea.js";
import { d as resolveStorePath } from "./paths-C2C4lJH6.js";
import { u as saveMediaBuffer } from "./store-VcV5Hs9C.js";
import { _ as isInsideCode, g as findCodeRegions } from "./assistant-visible-text-oprKkPEf.js";
...
import { a as resolveInboundLastRouteSessionKey, i as resolveAgentRoute } from "./resolve-route-EO7BJcsf.js";
...
import { c as resolveTextChunkLimit, o as chunkTextWithMode, s as resolveChunkMode } from "./chunk-eqDomQ-g.js";
import { i as deliverTextOrMediaReply, m as resolveSendableOutboundReplyParts } from "./reply-payload-C3J477-H.js";
...
import { a as settleReplyDispatcher, t as dispatchInboundMessage } from "./dispatch-DnzGTpPs.js";
import { n as buildMentionRegexes, r as matchesMentionPatterns } from "./mentions-BJW-vfhG.js";
import { i as createReplyDispatcherWithTyping } from "./reply-dispatcher.types-D287ft0v.js";
import "./routing-D8zbLWGc.js";
import { a as resolveEnvelopeFormatOptions, i as formatInboundFromLabel, r as formatInboundEnvelope } from "./envelope-CXHEh-mU.js";
import { D as toInboundMediaFacts, T as formatInboundMediaUnavailableText, b as filterChannelInboundQuoteContext, y as buildChannelInboundEventContext } from "./kernel-BMsNZe7F.js";
...
import "./transport-ready-runtime-BMM9XqFC.js";
...
import { c as createChannelInboundDebouncer, l as shouldDebounceTextInbound } from "./channel-inbound-CxUVIreR.js";
...
import { t as createIMessageRpcClient } from "./client-CDqr5c4k.js";
import { n as imessageRpcSupportsMethod, t as getCachedIMessagePrivateApiStatus } from "./private-api-status-DW3HEzoc.js";
import { c as parseIMessageTarget, o as normalizeIMessageHandle, r as isAllowedIMessageReplyContextSender, s as parseIMessageAllowTarget, t as formatIMessageChatTarget } from "./targets-BNnZ0Enu.js";
import { c as rememberIMessageReplyCache, d as getIMessageRuntime, o as isKnownFromMeIMessageMessageId } from "./monitor-reply-cache-CQTuBSH6.js";
import { n as resolveIMessageInboundConversationId, o as probeIMessage, t as sanitizeOutboundText } from "./sanitize-outbound-BpG3Cbra.js";
import { a as extractIMessageApprovalPromptBinding, c as maybeResolveIMessageApprovalReaction, f as resolveIMessageReactionContext, l as registerIMessageApprovalReactionTarget, o as handleIMessageApprovalReaction, s as listPendingIMessageApprovalReactionPollTargets } from "./normalize-CgJAS8NU.js";
import { n as resolveIMessageAttachmentRoots, r as resolveIMessageRemoteAttachmentRoots } from "./media-contract-DNv-c06H.js";
import { a as resolveCatchupConfig, i as performIMessageCatchup, n as advanceIMessageCatchupCursor } from "./catchup-XnSiXT0y.js";
import { i as hasPersistedIMessageEcho, s as stripLeadingEchoTextCorruptionMarkers } from "./persisted-echo-cache-BpSREDaK.js";
...
function combineIMessagePayloads(payloads) {
	...
	if (combinedText.length > 4e3) combinedText = `${sliceUtf16Safe(combinedText, 0, MAX_COALESCED_TEXT_CHARS)}…[truncated]`;
...
function resolveIMessageInboundMediaInput(params) {
	...
	const rawMediaAttachments = mediaCandidates.flatMap((attachment) => {
		const attachmentPath = attachment.original_path?.trim();
		if (!attachmentPath || attachment.missing) return [];
		if (!isInboundPathAllowed({
		...
		return [{
			path: attachmentPath,
			contentType: attachment.mime_type ?? void 0
		}];
	});
	const kind = kindFromMime(rawMediaAttachments[0]?.contentType ?? mediaCandidates[0]?.mime_type ?? void 0);
	const mediaPlaceholder = kind ? `<media:${kind}>` : mediaCandidates.length ? "<media:attachment>" : "";
	return {
...
function formatIMessageInboundMediaBody(params) {
	...
	const materializedPlaceholder = materializedKind ? `<media:${materializedKind}>` : params.mediaAttachments.length > 0 ? "<media:attachment>" : "";
	return formatInboundMediaUnavailableText({
		body: params.messageText || materializedPlaceholder || params.optimisticPlaceholder,
		mediaPlaceholder: params.mediaAttachments.length === 0 ? params.optimisticPlaceholder : void 0,
...
async function monitorIMessageProvider(opts = {}) {
	...
	async function handleMessageNowInner(rawMessage) {
		...
		const { messageText, bodyText, mediaPlaceholder, mediaCandidates, rawMediaAttachments, effectiveAttachmentRoots } = resolveIMessageInboundBodyText(message);
