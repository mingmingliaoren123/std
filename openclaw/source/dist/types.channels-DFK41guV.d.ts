...
import { E as ReplyToMode, R as SessionThreadBindingsConfig, S as MarkdownConfig, a as ChannelDeliveryStreamingConfig, d as ChannelStreamingProgressConfig, f as ContextVisibilityMode, g as DmPolicy, i as BlockStreamingCoalesceConfig, o as ChannelPreviewStreamingConfig, u as ChannelStreamingPreviewConfig, v as GroupPolicy, w as OutboundRetryConfig } from "./types.base-DD09OBJd.js";
import { a as GroupToolPolicyBySenderConfig, o as GroupToolPolicyConfig } from "./types.tools-CBCgJD1K.js";
import { I as MentionPatternsPolicyConfig, K as TtsConfig, _ as ChannelHealthMonitorConfig, j as DmConfig, o as SlackConfig, v as ChannelHeartbeatVisibilityConfig, w as NativeExecApprovalEnableMode, y as ChannelBotLoopProtectionConfig, z as ProviderCommandsConfig } from "./types.slack-Bjt70WfQ.js";
...
type SignalAccountConfig = CommonChannelMessagingConfig & {
  ...
  sendReadReceipts?: boolean; /** OpenClaw-side target aliases keyed by friendly name. */
  ...
  textChunkLimit?: number; /** Control native reply quoting when replies target an inbound Signal message. */
  replyToMode?: ReplyToMode; /** Optional per-chat-type native reply quoting overrides. */
  replyToModeByChatType?: Partial<Record<"direct" | "group", ReplyToMode>>; /** Reaction notification mode (off|own|all|allowlist). Default: own. */
