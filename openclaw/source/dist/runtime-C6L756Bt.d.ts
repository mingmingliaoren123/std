...
import { C as MarkdownTableMode, E as ReplyToMode } from "./types.base-DD09OBJd.js";
import { n as PollInput } from "./polls-CfHkU59X.js";
import { r as ChannelAccountSnapshot, v as ChannelMessageActionAdapter } from "./types.core-DzCkJQ0r.js";
...
import { a as TelegramBotInfo, r as probeTelegram } from "./probe-B2tzqKRo.js";
import { n as collectTelegramUnmentionedGroupIds, t as auditTelegramGroupMembership } from "./audit-Cgp7YkkF.js";
import { n as resolveTelegramToken } from "./token-56yRwgmu.js";
...
type TelegramSendOpts = {
  ...
  silent?: boolean; /** Override the prompt-context cache timestamp for transcript-aligned sends. */
  promptContextTimestampMs?: number; /** Message ID to reply to (for threading) */
