import { A as resolvePositiveTimerTimeoutMs, b as parseStrictPositiveInteger, j as resolveTimerTimeoutMs } from "./number-coercion-CJQ8TR--.js";
...
import { t as probePortUsage } from "./ports-probe-LgDMDUdi.js";
import { n as resolveLsofCommandSync } from "./ports-lsof-BmdLddJi.js";
import { n as parseWindowsNetstatListeners } from "./ports-netstat-QHOI7g2S.js";
...
function listPortListeners(port) {
	if (process.platform === "win32") try {
		const listeners = parseWindowsNetstatListeners(execFileSync(getWindowsSystem32ExePath("netstat.exe"), ["-ano"], { encoding: "utf-8" }), port);
