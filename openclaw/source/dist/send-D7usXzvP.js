...
import { d as parseThreadSessionSuffix, o as normalizeSessionKeyPreservingOpaquePeerIds } from "./session-key-utils-A-JGvyXu.js";
...
import { o as WRITE_SCOPE, t as ADMIN_SCOPE } from "./operator-scopes-CpPJIv7P.js";
...
import { a as maybeResolveIdLikeTarget } from "./target-resolver-C3zuFudK.js";
...
import { s as projectOutboundPayloadPlanForMirror, t as createOutboundPayloadPlan } from "./payloads-DYHv5qoG.js";
...
import { Bt as validatePollParams, Kt as validateSendParams, ht as validateMessageActionParams, t as formatValidationErrors } from "./src-CToKmqGn.js";
import { Gn as errorShape, Wn as ErrorCodes } from "./schema-BuOFpc7K.js";
import { l as resolveAttachmentMediaPolicy, r as hydrateAttachmentParamsForAction, t as dispatchChannelMessageAction } from "./message-action-dispatch-CZZYL7XG.js";
import { t as extractToolPayload } from "./tool-payload-DBiw68-o.js";
import { t as formatForLog } from "./ws-log-DlOPjxAD.js";
import { n as createOutboundSendDeps } from "./deps-Ohpw1HsI.js";
...
async function withMessageActionGatewayClientScopes(scopes, run) {
	const current = getPluginRuntimeGatewayRequestScope();
	if (!current?.client?.connect) return await run();
	const client = {
		...current.client,
		connect: {
		...
		await runGatewayInflightWork({
			...
			work: (async () => {
				...
				try {
					...
					const requesterAccountId = canSupplyTrustedRequester ? normalizeOptionalString(request.requesterAccountId) ?? void 0 : void 0;
					const requesterSenderId = canSupplyTrustedRequester ? normalizeOptionalString(request.requesterSenderId) ?? void 0 : void 0;
					const senderIsOwner = canSupplyTrustedRequester ? request.senderIsOwner === true : false;
					const hasTrustedRequesterProvenance = requesterAccountId !== void 0 || requesterSenderId !== void 0 || canSupplyTrustedRequester && request.senderIsOwner !== void 0;
					const dispatchGatewayClientScopes = canSupplyTrustedRequester && client?.connect?.client?.id === GATEWAY_CLIENT_NAMES.GATEWAY_CLIENT && client.connect.client.mode === GATEWAY_CLIENT_MODES.BACKEND && hasTrustedRequesterProvenance ? TRUSTED_MESSAGE_ACTION_BRIDGE_SCOPES : gatewayClientScopes;
					const handled = await withMessageActionGatewayClientScopes(dispatchGatewayClientScopes, async () => await dispatchChannelMessageAction({
						channel,
