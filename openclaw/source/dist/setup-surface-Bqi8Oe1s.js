...
import { o as isPrivateOrLoopbackHost } from "./net-BOKtNTf8.js";
import "./string-coerce-runtime-ZbuYDJgZ.js";
import { O as promptAccountId, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-D9YNI4xN.js";
import { t as promptChannelAccessConfig } from "./setup-group-access-Dz4Z8Sy-.js";
import "./setup-Ci5cm22i.js";
import { o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-DKsCBaFj.js";
...
import { r as resolveMatrixEnvAuthReadiness } from "./env-auth-BeGOFudU.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-BmRaB5bV.js";
import { r as moveSingleMatrixAccountConfigToNamedAccount, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-BU6Ry5oK.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-DZDSgSmi.js";
import { n as updateMatrixAccountConfig } from "./config-update-BJec2j3n.js";
import { n as validateMatrixHomeserverUrl, t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-D5T6i6Zz.js";
import { n as ensureMatrixSdkInstalled, r as isMatrixSdkAvailable } from "./deps-DxhWzKfF.js";
...
async function promptMatrixAllowFrom(params) {
	...
	while (true) {
		...
		if (pending.length > 0) {
			const { resolveMatrixTargets } = await import("./resolve-targets-CzhcRkib.js");
	...
	if (accessConfig) if (accessConfig.policy !== "allowlist") next = setMatrixGroupPolicy(next, accessConfig.policy, params.accountId);
		...
		if (accessConfig.entries.length > 0) try {
			...
			for (const entry of accessConfig.entries) {
				...
				const { listMatrixDirectoryGroupsLive } = await import("./directory-live-D0qo3gS6.js");
...
const matrixOnboardingAdapter = {
	...
	afterConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-D4LYsa8Q.js");
