...
import { d as matchesExactOrPrefix, l as normalizeProviderId, u as cloneFirstTemplateModel } from "./provider-model-shared-BK8T_tBM.js";
...
import { l as findCatalogTemplate, n as buildManifestModelProviderConfig } from "./provider-catalog-shared-B9-1TtFx.js";
import { a as getCachedLiveProviderModelRows, n as buildLiveModelProviderConfig } from "./provider-catalog-live-runtime-zLvzvTLp.js";
import { a as isOpenAICodexBaseUrl, i as isOpenAIApiBaseUrl, n as OPENAI_CODEX_RESPONSES_BASE_URL, o as resolveOpenAIDefaultBaseUrl } from "./base-url-BRDP2JCY.js";
import { a as OPENAI_DEFAULT_MODEL, c as applyOpenAIConfig, t as OPENAI_CODEX_DEFAULT_MODEL } from "./default-models-BrUuZm2O.js";
import { n as buildOpenAISyntheticCatalogEntry, t as buildOpenAIResponsesProviderHooks } from "./shared-BdJp-xt6.js";
...
import { n as buildOpenAICodexProviderHooks, t as buildOpenAIChatGPTAuthMethods } from "./openai-chatgpt-provider-BfBZlMyL.js";
...
function normalizeOpenAICodexCatalogModel(model) {
	...
	if (modelId === OPENAI_GPT_56_SOL_MODEL_ID || modelId === OPENAI_GPT_56_TERRA_MODEL_ID || modelId === OPENAI_GPT_56_LUNA_MODEL_ID) {
		const supportsNativeUltra = modelId === OPENAI_GPT_56_SOL_MODEL_ID || modelId === OPENAI_GPT_56_TERRA_MODEL_ID;
...
function buildOpenAIProvider() {
	...
	return {
		...
		resolveThinkingProfile: ({ provider, modelId, agentRuntime, compat }) => normalizeProviderId(provider) === PROVIDER_ID ? resolveUnifiedOpenAIThinkingProfile(modelId, agentRuntime, compat) : null,
