...
import { K as resolveMemoryDreamingConfig, X as resolveMemoryLightDreamingConfig, Z as resolveMemoryRemDreamingConfig } from "./dreaming-DqzMSXGC.js";
import { S as isUsageCountedSessionTranscriptFileName, u as resolveSessionTranscriptsDirForAgent } from "./paths-C2C4lJH6.js";
...
import { c as normalizeExtraMemoryPaths, s as listMemoryFiles } from "./internal-ss-Qpla0.js";
...
import { f as removeBackfillDiaryEntries, m as writeBackfillDiaryEntries } from "./dreaming-narrative-Cyd3gZOl.js";
import { n as previewGroundedRemMarkdown, t as previewRemHarness } from "./rem-harness-BXD4BMIU.js";
import { C as resolveShortTermRecallLockPath, S as repairShortTermPromotionArtifacts, b as recordShortTermRecalls, m as rankShortTermPromotionCandidates, o as applyShortTermPromotions, s as auditShortTermPromotionArtifacts, v as recordGroundedShortTermCandidates, w as resolveShortTermRecallStorePath, x as removeGroundedShortTermCandidates } from "./short-term-promotion-stx0l04M.js";
import { c as seedHistoricalDailyMemorySignals } from "./dreaming-phases-DCJr5DsV.js";
import { i as formatMemoryVectorDegradedWriteReason } from "./manager-DB4_iNu4.js";
...
async function runMemoryStatus(opts) {
	...
	for (const result of allResults) {
		...
		if (embeddingProbe) {
			...
			const stateColor = state === "skipped" ? theme.muted : embeddingProbe.ok ? theme.success : theme.warn;
