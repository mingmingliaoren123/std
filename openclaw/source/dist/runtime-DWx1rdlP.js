...
import { c as kindFromMime, l as mimeTypeFromFilePath } from "./mime-BaK8UYea.js";
...
import { d as getMediaUnderstandingProvider, n as DEFAULT_MAX_BYTES, u as buildMediaUnderstandingRegistry } from "./defaults.constants-a1NGOUtu.js";
import { i as resolveMediaRuntimeTimeoutMs } from "./resolve-DpuaVxmy.js";
import { c as normalizeImageDescriptionInput, i as normalizeDecisionReason, n as findDecisionReason } from "./runner.entries-Ci_g3yUf.js";
import { a as runCapability, o as createMediaAttachmentCache, s as normalizeMediaAttachments, t as buildProviderRegistry } from "./runner-Cpk4nBAC.js";
...
async function describePreparedImageWithModel(params) {
	const timeoutMs = resolveMediaRuntimeTimeoutMs(params.timeoutMs);
	return await (buildProviderRegistry(void 0, params.cfg).get(normalizeMediaProviderId(params.provider))?.describeImage ?? describeImageWithModel)({
