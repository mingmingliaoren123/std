...
import { d as parseThreadSessionSuffix } from "./session-key-utils-A-JGvyXu.js";
...
import { h as readPositiveIntegerParam, i as createActionGate, t as ToolAuthorizationError, y as readStringParam } from "./common-DWyiui3y.js";
import { n as sanitizeAssistantVisibleText } from "./assistant-visible-text-oprKkPEf.js";
import { l as createScopedDmSecurityResolver, t as adaptScopedAccountAccessor } from "./channel-config-helpers-BH5RG2Ab.js";
...
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-DXd2kIwS.js";
import "./channel-core-D4dtGEQQ.js";
import "./routing-D8zbLWGc.js";
import { _ as createAllowlistProviderOpenWarningCollector, w as projectAccountConfigWarningCollector } from "./channel-policy-HQ-6pbOn.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-Cvu56pBQ.js";
...
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers-5lT1az7-.js";
import "./approval-delivery-runtime-Z3byOu9m.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-DGYdpBVf.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-BlrHLy0b.js";
import { r as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-C3Eh-_ev.js";
import "./approval-native-runtime-O4jOs-2w.js";
import { w as createChannelMessageAdapterFromOutbound } from "./channel-outbound-DkdAAOhG.js";
import "./conversation-runtime-Dg1MGKiZ.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-DNhqI-OE.js";
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-Dy-C1WAt.js";
import "./channel-status-D0V3ybJh.js";
import "./channel-actions-DLW94VY-.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-3Uf4WD4J.js";
import { t as extractToolSend } from "./tool-send-DlIp2cBO.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-DRNO1z0M.js";
import { a as resolveMatrixAccountConfig } from "./account-config-63kzmTw0.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-BmRaB5bV.js";
import { n as normalizeMatrixUserId } from "./allowlist-BPZ1NLXr.js";
import { t as normalizeMatrixApproverId } from "./approval-ids-BALwoBkk.js";
import { a as isMatrixExecApprovalAuthorizedSender, c as shouldHandleMatrixApprovalRequest, d as matrixApprovalAuth, i as isMatrixApprovalClientEnabled, l as shouldSuppressLocalMatrixExecApprovalPrompt, n as getMatrixExecApprovalApprovers, o as isMatrixExecApprovalClientEnabled, r as isMatrixAnyApprovalClientEnabled, s as resolveMatrixExecApprovalTarget, t as getMatrixApprovalApprovers, u as getMatrixApprovalAuthApprovers } from "./exec-approvals-DCob_K2C.js";
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget, t as isMatrixQualifiedUserId } from "./target-ids-DCrsDJYP.js";
import { t as formatMatrixErrorMessage } from "./errors-Br49yrzd2.js";
import { n as matrixConfigAdapter, t as MatrixChannelConfigSchema } from "./config-schema-D6CA0P8M.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-BNlQIF_N.js";
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-5fW-wxVE.js";
import { d as setMatrixThreadBindingIdleTimeoutBySessionKey, p as setMatrixThreadBindingMaxAgeBySessionKey } from "./thread-bindings-shared-CBIZWnAn.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-CU-AV7VK.js";
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-BU6Ry5oK.js";
import { n as matrixSetupAdapter, t as createMatrixSetupWizardProxy } from "./setup-core-DU9HLbZy.js";
...
import { t as maybeCreateMatrixMigrationSnapshot } from "./migration-snapshot-backup-BYxPjFcp.js";
import { n as resolveMatrixInboundConversation } from "./thread-binding-api-DGv63o3R.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-CSnCPyMQ.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-DUZEZpte.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-BQjTBlpo.js"), "matrixChannelRuntime");
const loadMatrixDoctorModule = createLazyRuntimeModule(() => import("./doctor-CyW7ZdTr.js"));
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-C124lfVF.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
