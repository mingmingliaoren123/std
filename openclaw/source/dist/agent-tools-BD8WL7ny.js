...
import { r as mergeAbortSignals, t as createAbortError } from "./abort-signal-BWW6Tk6w.js";
import "./fs-safe-RNq3oO57.js";
import { a as root, o as PATH_ALIAS_POLICIES } from "./secure-temp-dir-DMUMnweR.js";
...
import { i as toRelativeSandboxPath, r as resolvePathFromInput } from "./workspace-dir-CgYmgqVr.js";
import { a as resolveGatewayMessageChannel } from "./message-channel-normalize-s5PUEeqJ.js";
import "./message-channel-CB9y2CYk.js";
import { P as createCodingTools, V as createReadTool } from "./sessions-D8qGY7uC.js";
...
import { c as mergeAlsoAllowPolicy, f as expandToolGroups, l as replaceWithEffectiveToolAllowlist, m as normalizeToolName, s as hasRestrictiveAllowPolicy } from "./tool-policy-BHUGxE3p.js";
import { t as isToolAllowedByPolicies } from "./tool-policy-match-CgU98OQh.js";
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT } from "./constants-5yTHqBiK.js";
...
import { t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-DeOnAqhX.js";
import { d as rewrapToolWithBeforeToolCallHook, p as wrapToolWithBeforeToolCallHook } from "./agent-tools.before-tool-call-C95DXQXZ.js";
import { s as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-core-DEpF95I7.js";
import { S as isToolWrappedWithBeforeToolCallHook, h as copyChannelAgentToolMeta, o as copyToolTerminalPresentation, u as listChannelAgentTools, x as copyBeforeToolCallHookMarker } from "./gateway-CvsJ0gY0.js";
import { t as resolveExecCommandHighlighting } from "./exec-command-highlighting-BvX6IkW5.js";
import { n as resolveEventSessionRoutingPolicy } from "./event-session-routing-Tqx9dDCC.js";
import { t as applyExecPolicyLayer } from "./exec-policy-CBUzYdh5.js";
import { i as resolveMergedSafeBinProfileFixtures } from "./exec-safe-bin-runtime-policy-BXwdBwWP.js";
import { n as GATEWAY_OWNER_ONLY_CORE_TOOLS } from "./dangerous-tools-1CBnzkwG.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-Djzo61sO.js";
import { C as wrapToolWorkspaceRootGuardWithOptions, S as wrapToolWorkspaceRootGuard, _ as createOpenClawReadTool, b as createSandboxedWriteTool, g as createHostWorkspaceWriteTool, h as createHostWorkspaceEditTool, m as resolveOpenClawPluginToolsForOptions, t as createOpenClawTools, v as createSandboxedEditTool, x as wrapToolMemoryFlushAppendOnlyWrite, y as createSandboxedReadTool } from "./openclaw-tools-KulZ1cdH.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-DSAIk_o8.js";
import "./codex-native-web-search-BOEASF6v.js";
import { S as filterLocalModelLeanTools, b as resolveToolSearchConfig, h as createToolSearchTools, i as TOOL_SEARCH_RAW_TOOL_NAME, n as TOOL_DESCRIBE_RAW_TOOL_NAME, r as TOOL_SEARCH_CODE_MODE_TOOL_NAME, t as TOOL_CALL_RAW_TOOL_NAME, w as resolveLocalModelLeanPreserveToolNames } from "./tool-search-B8B4Spes.js";
...
import { s as createToolFsPolicy, u as resolveToolFsConfig } from "./local-roots-CAoJyC6u.js";
import { S as resolveReadOnlyWorkspaceSkillMounts } from "./docker-Hq4HIYYD.js";
...
function wrapToolWithAbortSignal(tool, abortSignal) {
	...
	const wrappedTool = {
		...
		execute: async (toolCallId, params, signal, onUpdate) => {
			...
			try {
				if (combined.signal?.aborted) throwAbortError();
...
const bashToolsModuleLoader = createLazyImportLoader(() => import("./bash-tools-C56sYxmK.js"));
...
function createOpenClawCodingTools(options) {
	...
	const { agentId, globalPolicy, globalProviderPolicy, agentPolicy, agentProviderPolicy, profile, providerProfile, profilePolicy, providerProfilePolicy, profileAlsoAllow, providerProfileAlsoAllow, groupPolicy, senderPolicy, subagentPolicy, inheritedToolPolicy } = capabilityProfile.policy;
