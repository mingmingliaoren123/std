import { g as AcpSessionUpdateTag } from "./types-D85xy4rc.js";
...
import { D as SessionConfig, H as TypingMode, U as WebConfig, _ as DmScope, b as IdentityConfig, i as BlockStreamingCoalesceConfig, m as DiagnosticsConfig, n as AuditConfig, r as BlockStreamingChunkConfig, x as LoggingConfig, y as HumanDelayConfig } from "./types.base-DD09OBJd.js";
import { N as MemoryConfig, _ as MemorySearchConfig, k as ToolsConfig, t as AgentToolsConfig } from "./types.tools-CBCgJD1K.js";
import { A as CommandsConfig, E as BroadcastConfig, K as TtsConfig, L as MessagesConfig, M as GroupChatConfig, T as AudioConfig, b as ApprovalsConfig } from "./types.slack-Bjt70WfQ.js";
import { r as ChannelsConfig } from "./types.channels-DFK41guV.js";
import { _ as ModelsConfigInput, g as ModelsConfig } from "./types.models-BvJnk7Su.js";
...
type AgentDefaultsConfig = {
  ...
  thinkingDefault?: "off" | "minimal" | "low" | "medium" | "high" | "xhigh" | "adaptive" | "max" | "ultra"; /** Default verbose level when no /verbose directive is present. */
...
type AgentCompactionConfig = {
  /** Compaction summarization mode. */mode?: AgentCompactionMode; /** Embedded OpenClaw reserve target before floor and context-window caps. */
...
type BrowserConfig = {
  ...
  cdpUrl?: string; /** Remote CDP HTTP timeout and persistent tab-enumeration budget input (ms). Default: 1500. */
  remoteCdpTimeoutMs?: number; /** Remote CDP handshake timeout and tab-enumeration budget input (ms). Default: max(remoteCdpTimeoutMs * 2, 2000). */
...
type OpenClawConfig = {
  ...
  wizard?: {
    ...
    lastRunMode?: "local" | "remote"; /** ISO timestamp when the setup security acknowledgement was accepted on this config. */
...
//#endregion
export { GatewayNodePairingConfig as $, AgentCompactionMidTurnPrecheckConfig as $t, HookMappingConfig as A, BrowserProfileConfig as At, GatewayAuthRateLimitConfig as B, AgentRouteBinding as Bt, McpServerToolFilterConfig as C, AccessGroupsConfig as Cn, CronFailureDestinationConfig as Ct, MarketplacesConfig as D, CliBannerTaglineMode as Dt, MarketplaceSourceProfileConfig as E, SilentReplyConversationType as En, CommitmentsConfig as Et, HooksGmailTailscaleMode as F, AuthProfileConfig as Ft, GatewayHttpChatCompletionsImagesConfig as G, SkillsConfig as Gt, GatewayConfig as H, AgentRuntimeConfig as Ht, InternalHooksConfig as I, AgentAcpBinding as It, GatewayHttpResponsesConfig as J, SkillsLoadConfig as Jt, GatewayHttpConfig as K, SkillsInstallConfig as Kt, DiscoveryConfig as L, AgentBinding as Lt, HookMappingTransform as M, BrowserSsrFPolicyConfig as Mt, HooksConfig as N, BrowserTabCleanupConfig as Nt, HookConfig as O, CliConfig as Ot, HooksGmailConfig as P, AuthConfig as Pt, GatewayHttpSecurityHeadersConfig as Q, AgentCompactionMemoryFlushConfig as Qt, GatewayAuthConfig as R, AgentBindingMatch as Rt, McpServerConfig as S, AccessGroupConfig as Sn, CronFailureAlertConfig as St, MarketplaceFeedVerificationConfig as T, MessageSendersAccessGroup as Tn, CronRetryOn as Tt, GatewayControlUiConfig as U, AgentsConfig as Ut, GatewayBindMode as V, AgentRuntimeAcpConfig as Vt, GatewayHttpChatCompletionsConfig as W, SkillConfig as Wt, GatewayHttpResponsesImagesConfig as X, AgentCompactionConfig as Xt, GatewayHttpResponsesFilesConfig as Y, SkillsWorkshopConfig as Yt, GatewayHttpResponsesPdfConfig as Z, AgentCompactionIdentifierPolicy as Zt, NodeHostBrowserProxyConfig as _, SubagentDelegationMode as _n, TalkConfigResponse as _t, OpenClawConfigInput as a, AgentContextPruningConfig as an, GatewayReloadMode as at, McpConfig as b, AcpRuntimeConfig as bn, WideAreaDiscoveryConfig as bt, SecurityAuditSuppression as c, AgentModelEntryConfig as cn, GatewayTailscaleMode as ct, SurfaceConfigEntry as d, AgentStartupContextConfig as dn, GatewayToolsConfig as dt, AgentCompactionMode as en, GatewayNodesConfig as et, PluginEntryConfig as f, CliBackendConfig as fn, GatewayTrustedProxyConfig as ft, PluginsLoadConfig as g, PromptOverlaysConfig as gn, TalkConfig as gt, PluginsConfig as h, OptionalBootstrapFileName as hn, ResolvedTalkConfig as ht, OpenClawConfig as i, AgentContextLimitsConfig as in, GatewayReloadConfig as it, HookMappingMatch as j, BrowserSnapshotDefaults as jt, HookInstallRecord as k, BrowserConfig as kt, SecurityConfig as l, AgentModelListConfig as ln, GatewayTerminalConfig as lt, PluginSlotsConfig as m, Gpt5PromptOverlayConfig as mn, MdnsDiscoveryMode as mt, ConfigValidationIssue as n, AgentCompactionQualityGuardConfig as nn, GatewayPushApnsRelayConfig as nt, ResolvedSourceConfig as o, AgentDefaultsConfig as on, GatewayRemoteConfig as ot, PluginInstallRecord as p, EmbeddedAgentExecutionContract as pn, MdnsDiscoveryConfig as pt, GatewayHttpEndpointsConfig as q, SkillsLimitsConfig as qt, LegacyConfigIssue as r, AgentContextInjection as rn, GatewayPushConfig as rt, RuntimeConfig as s, AgentImageQualityPreference as sn, GatewayTailscaleConfig as st, ConfigFileSnapshot as t, AgentCompactionPostIndexSyncMode as tn, GatewayPushApnsConfig as tt, SourceConfig as u, AgentRunRetriesConfig as un, GatewayTlsConfig as ut, NodeHostConfig as v, AcpConfig as vn, TalkProviderConfig as vt, MarketplaceFeedProfileConfig as w, DiscordChannelAudienceAccessGroup as wn, CronRetryConfig as wt, McpServerCodexConfig as x, AcpStreamConfig as xn, CronConfig as xt, McpCodexToolApprovalMode as y, AcpDispatchConfig as yn, TalkRealtimeConfig as yt, GatewayAuthMode as z, AgentConfig as zt };