...
import { i as createChatChannelPlugin } from "./core-DXd2kIwS.js";
...
import { c as createNestedAllowlistOverrideResolver, o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter } from "./allowlist-config-edit-__fkJx_h.js";
...
import { c as resolveDiscordAccountAllowFrom, i as listEnabledDiscordAccounts, o as resolveDefaultDiscordAccountId, s as resolveDiscordAccount } from "./accounts-B2tNBeEr.js";
import "./channel-api-5lWY15Mx.js";
import { t as parseDiscordTarget } from "./target-parsing-ngi8FE5G.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-BcfxHLGB.js";
import { n as looksLikeDiscordTargetId, r as normalizeDiscordMessagingTarget } from "./normalize-BAvvbb7Q.js";
import { t as getDiscordRuntime } from "./runtime-n11XewvP.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-A-b55tZp.js";
import { t as getDiscordApprovalCapability } from "./approval-native-B_svJcCM.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-BZsE3Bq0.js";
import { t as discordMessageActions$1 } from "./channel-actions-BN4ku83z.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-DhRA3BHV.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-tFBF5rWa.js";
import { d as withAbortTimeout } from "./timeouts-BG9tJyKJ.js";
import { n as discordOutbound } from "./outbound-adapter-BkXPSQET.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-BeTB0WdV.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-C6vjE-oH.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-CXGGkC1a.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-6op69Z9M.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-HzAIV5dN.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-CMMYL5oi.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-tcq0RAjx.js"));
const loadDiscordProviderRuntime = createLazyRuntimeModule(() => import("./provider.runtime.js"));
const loadDiscordProbeRuntime = createLazyRuntimeModule(() => import("./probe.runtime-Cp3Ij1Pc.js"));
const loadDiscordAuditModule = createLazyRuntimeModule(() => import("./audit-jlYAkDYR.js"));
const loadDiscordSendModule = createLazyRuntimeModule(() => import("./send-5-VFDoxs.js"));
const loadDiscordDirectoryLiveModule = createLazyRuntimeModule(() => import("./directory-live-DMEFJrVV.js"));
//#endregion
