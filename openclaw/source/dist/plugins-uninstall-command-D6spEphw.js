...
import { a as tracePluginLifecyclePhase, o as tracePluginLifecyclePhaseAsync } from "./discovery-7zi_zNvu.js";
...
async function runPluginUninstallCommand(id, opts = {}, runtime = defaultRuntime) {
	...
	const { loadInstalledPluginIndexInstallRecords, removePluginInstallRecordFromRecords, withoutPluginInstallRecords, withPluginInstallRecords } = await import("./installed-plugin-index-records-CTA0CdYc.js");
	const { buildPluginSnapshotReport } = await import("./status-1zl9Bjo_.js");
	const { applyPluginUninstallDirectoryRemoval, formatUninstallActionLabels, formatUninstallSlotResetPreview, planPluginUninstall, resolveUninstallChannelConfigKeys, UNINSTALL_ACTION_LABELS } = await import("./uninstall-DpCjb_Mu.js");
	const { commitPluginInstallRecordsWithConfig } = await import("./plugins-install-record-commit-CT3DlGab.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-Bssx04qK.js");
	const { resolvePluginUninstallId } = await import("./plugins-uninstall-selection-AqMIlO11.js");
	const { PromptInputClosedError, promptYesNo } = await import("./prompt-BrZXP1Vg.js");
