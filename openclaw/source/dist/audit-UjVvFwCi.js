...
import { s as resolveConfigPath, v as resolveStateDir } from "./paths-BMBAvkNf.js";
...
import { c as emitTrustedSecurityEvent } from "./diagnostic-events-JZsXee1S.js";
import { i as normalizeProviderId } from "./provider-id-Dq06Bcx6.js";
import "./agent-scope-B2Pk_xhT.js";
import { t as DEFAULT_AGENT_ID } from "./session-key-VWT_xzM9.js";
...
import { o as listRiskyConfiguredSafeBins } from "./exec-safe-bin-trust-BiuDT-_9.js";
import { i as resolveSandboxConfigForAgent } from "./config-Dy4vED5-.js";
import { l as isInterpreterLikeAllowlistPattern } from "./risks-CnLHDNUX.js";
import { B as resolveExecApprovalsFromFile, _ as minSecurity, h as maxAsk, m as loadExecApprovals } from "./exec-approvals-BIKWP8_V.js";
...
import { r as collectCoreInsecureOrDangerousFlags } from "./dangerous-config-flags-current-CrOoyQT2.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-CbRG8Jjk.js";
import { n as resolveExecDefaults } from "./exec-defaults-BLH0Yltk.js";
import { r as materializeGatewayAuthSecretRefs, t as canMaterializeGatewayAuthSecretRefsWithoutExec } from "./auth-config-utils-Cey1ZEdV.js";
import { n as normalizeConfiguredTrustedSafeBinDirs, t as normalizeConfiguredSafeBins } from "./exec-safe-bin-config-D5OtMSwI.js";
import { t as resolveGatewayAuthTokenSourceConflict } from "./auth-token-source-conflict-BOxA6udN.js";
import { t as collectExecFilesystemPolicyDriftHits } from "./exec-filesystem-policy-CTlB-k7U.js";
...
const loadReadOnlyChannelPlugins = createLazyRuntimeModule(() => import("./read-only-v5IKyHgr.js"));
...
const loadPluginMetadataRegistryLoaderModule = createLazyRuntimeModule(() => import("./metadata-registry-loader-I5M1Ql8z.js"));
const loadPluginAutoEnableModule = createLazyRuntimeModule(() => import("./plugin-auto-enable-B6hAFy56.js"));
const loadChannelPluginIdsModule = createLazyRuntimeModule(() => import("./channel-plugin-ids-BL7ezb8J.js"));
const loadPluginRuntimeModule = createLazyRuntimeModule(() => import("./runtime-BBhdCnaD.js"));
const loadGatewayProbeDeps = createLazyRuntimeModule(() => Promise.all([
	import("./call-BZWJ3eG1.js"),
	import("./probe-auth-D3q-m3xO.js"),
	import("./probe-CaewtHAY.js")
...
async function collectAgentSkillMcpBoundaryFindings(params) {
	...
	if (globalMcporterRegistry) sources.push(globalMcporterRegistry);
