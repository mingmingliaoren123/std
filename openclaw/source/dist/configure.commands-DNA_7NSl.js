...
import { d as resolveGatewayPort, t as CONFIG_PATH } from "./paths-BMBAvkNf.js";
...
import { d as isValidEnvSecretRefId, l as isSecretRef } from "./types.secrets-OocW4TQ1.js";
...
import { l as resolvePluginContributionOwners } from "./plugin-registry-8E8D2Hou.js";
...
import { a as findTailscaleBinary } from "./tailscale-CIYHc4PM.js";
import { F as ConfigMutationConflictError, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, r as createConfigIO } from "./io-By0s-a_s.js";
...
import { o as formatPortRangeHint } from "./error-format-CcGxQmmN.js";
...
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, h as waitForGatewayReachable, m as validateGatewayPasswordInput, n as applyWizardMetadata, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-DajOrUWU.js";
...
import { n as promptAuthChoiceGrouped } from "./auth-choice-prompt-CaECP1Ik.js";
import { r as applyAuthChoice } from "./auth-choice-zc2-z5xg.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-Gpvh3Vt6.js";
import { i as setupChannels } from "./onboard-channels-BsIvPxyr.js";
...
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-DogyhEkx.js";
import { t as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-DBDwy5XT.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-B-Hnysol.js";
import { t as applyPrimaryModel } from "./provider-model-primary-D-BO3vDJ.js";
import { t as promptCustomApiConfig } from "./onboard-custom-Bhyw7BNG.js";
import { a as validateIPv4AddressInput, i as maybeAddTailnetOriginToControlUiAllowedOrigins, n as TAILSCALE_EXPOSURE_OPTIONS, r as TAILSCALE_MISSING_BIN_NOTE_LINES, t as TAILSCALE_DOCS_LINES } from "./gateway-config-prompts.shared-CgBYKnTN.js";
import { r as formatHealthCheckFailure } from "./health-format-ZE_adbMv.js";
import { c as healthCommand } from "./health-p6SutBnt.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-CXRzh3dL.js";
import { t as setupSkills } from "./onboard-skills-DhXO03HN.js";
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-DlSgUD9t.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-qgLpqH45.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search--eFR5kSD.js");
