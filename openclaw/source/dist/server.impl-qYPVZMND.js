...
import { n as createLazyPromise, r as createLazyPromiseLoader } from "./lazy-promise-10KxeiYV.js";
import { r as createLazyRuntimeModule } from "./lazy-runtime-BgpbKGBP.js";
import { i as logAcceptedEnvOption, n as isTruthyEnvValue, r as isVitestRuntimeEnv } from "./env-CKdem44B.js";
import { D as resolveIntegerOption, b as parseStrictPositiveInteger } from "./number-coercion-CJQ8TR--.js";
import { a as normalizeStateDirEnv, i as isNixMode } from "./paths-BMBAvkNf.js";
import { _ as uniqueStrings } from "./string-normalization-CRyoFBPt.js";
import "./utils-CRO4LGEB.js";
import { t as sleep } from "./sleep-DZm1epyW.js";
import { S as createDiagnosticTraceContext, f as isDiagnosticsEnabled, j as runWithDiagnosticTraceContext, y as setDiagnosticsEnabledForProcess } from "./diagnostic-events-JZsXee1S.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-C3fiUGN1.js";
import { n as loadInstalledPluginIndexInstallRecordsSync } from "./installed-plugin-index-record-reader-Dd35fnKn.js";
import { t as cleanupRetainedManagedNpmInstallGenerations } from "./managed-npm-retention-BTuFzcN9.js";
import { o as setCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-CmOpmveB.js";
import { t as clearPluginMetadataLifecycleCaches } from "./plugin-metadata-lifecycle-C3dWg4tn.js";
import { c as isDiagnosticsTimelineEnabled, s as emitDiagnosticsTimelineEvent } from "./plugin-metadata-snapshot-rpSrEgGf.js";
import { t as isContainerEnvironment } from "./container-environment-CNsJSTpY.js";
import { _ as resolveRequestClientIp, i as isLoopbackHost, m as resolveGatewayListenHosts } from "./net-BOKtNTf8.js";
import { c as buildRateLimitIdentityKey, l as createAuthRateLimiter, o as AUTH_RATE_LIMIT_SCOPE_NODE_REAPPROVAL } from "./auth-rate-limit-DczU2XgX.js";
import { o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as withSerializedKeyedAttempt } from "./auth-B27MflKU.js";
import { n as resolveGatewayAuth } from "./auth-resolve-NyPBrh8F.js";
import { A as applyConfigOverrides, i as getRuntimeConfig, s as promoteConfigSnapshotToLastKnownGood, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-By0s-a_s.js";
...
import { t as loadGatewayTlsRuntime$1 } from "./gateway-D7pGc7Ge.js";
import { n as createCoreGatewayMethodDescriptors, r as isCoreGatewayMethodClassified, s as listCoreGatewayMethodNames, t as STARTUP_UNAVAILABLE_GATEWAY_METHODS } from "./core-descriptors-DRUtdasO.js";
import { i as READ_SCOPE, n as APPROVALS_SCOPE, o as WRITE_SCOPE, r as PAIRING_SCOPE, t as ADMIN_SCOPE } from "./operator-scopes-CpPJIv7P.js";
import "./method-scopes-CwW_Szsp.js";
import { h as setPreRestartDeferralCheck, m as setGatewaySigusr1RestartPolicy } from "./restart-BF68zBs3.js";
import { n as readGatewayRestartHandoffSync } from "./restart-handoff-BnSdhKeI.js";
import { _ as pinActivePluginSessionExtensionRegistry, b as releasePinnedPluginHttpRouteRegistry, g as pinActivePluginHttpRouteRegistry, h as pinActivePluginChannelRegistry, x as releasePinnedPluginSessionExtensionRegistry, y as releasePinnedPluginChannelRegistry } from "./runtime-D0xGMZdc.js";
...
import { a as tryLoadActivatedBundledPluginPublicSurfaceModule } from "./facade-runtime-Dce8fe3v.js";
import { n as getLoadedChannelPluginEntryById, r as listLoadedChannelPlugins } from "./registry-loaded-C1Zaf4Uh.js";
import { a as enqueueSystemEvent } from "./system-events-BfmWSF2P.js";
import { d as getActiveEmbeddedRunCount, m as resolveActiveEmbeddedRunSessionId } from "./run-state-BteeOQT8.js";
import { C as stopDiagnosticHeartbeat, S as startDiagnosticHeartbeat } from "./diagnostic-DhwkYT4X.js";
import { i as withDiagnosticPhase } from "./diagnostic-phase-CHbBJf77.js";
import { s as resolveCronJobsStorePath } from "./store-ScQ9SjOe.js";
import "./sessions-oDygYVdy.js";
import { r as getActiveCronJobCount } from "./active-jobs-DCucn-SJ.js";
import { f as isGatewayDraining, u as getTotalQueueSize } from "./command-queue-DqzpsN4m.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-CaTZukRA.js";
import { n as clearSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeConfigSnapshot } from "./runtime-state-CPERULut.js";
import { u as setFallbackGatewayContextResolver } from "./server-plugins-XoQmHCe9.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-u0c3DDHI.js";
import { n as DEFAULT_CHANNEL_STALE_EVENT_THRESHOLD_MS, r as evaluateChannelHealth, t as DEFAULT_CHANNEL_CONNECT_GRACE_MS } from "./channel-health-policy-Bd5WQkSH.js";
...
import { a as createChatRunState, c as createToolEventRecipientRegistry } from "./server-chat-state-_DvSGu8D.js";
import { c as recordGatewayRestartTraceDetail, d as resumeGatewayRestartTraceFromHandoff, i as finishGatewayRestartTrace, l as recordGatewayRestartTraceSpan, n as collectGatewayProcessMemoryUsageMb, u as resumeGatewayRestartTraceFromEnv } from "./restart-trace-B8OzHXli.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-DeftfIPV.js";
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-kBlcxcew.js";
import { l as requestNodePairing, r as finalizeNodePairingCleanupClaim, u as reusePendingNodePairingForReconnect } from "./node-pairing-C0KBZUMJ.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-DWh8q3Ab.js";
...
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-DlOPjxAD.js";
import { t as createDeferred } from "./deferred-DJrEoFQk.js";
import { t as createDefaultDeps } from "./deps-Ohpw1HsI.js";
import { c as setDefaultSecurityHeaders, r as sendGatewayAuthFailure } from "./http-common-DGvb9gWN.js";
import { t as GatewayLockError } from "./gateway-lock-wbAyxxlZ.js";
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-djntgdpC.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-DOrBD-0Y.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-DruWzfsQ.js";
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-Bj_QhGa5.js";
import { t as resolveGatewayPluginConfig } from "./runtime-plugin-config-BF6GCba4.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-L_OppjbT.js";
...
import { t as findMatchingPluginNodeCapabilityRoute } from "./route-capability-BsZE2T52.js";
...
function createLazyGatewayCronState(params) {
	...
	let loaded = null;
	let stopped = false;
	const cronStateLoader = createLazyPromiseLoader(() => import("./server-cron-FVNt3Zec.js").then(({ buildGatewayCronService }) => {
		loaded = {
...
const getIdentityAvatarModule = createLazyRuntimeModule(() => import("./identity-avatar-gcyxzHxh.js"));
const getControlUiModule = createLazyRuntimeModule(() => import("./control-ui-CuoxgbYo.js"));
const getEmbeddingsHttpModule = createLazyRuntimeModule(() => import("./embeddings-http-CpZoEYqm.js"));
const getManagedImageAttachmentsModule = createLazyRuntimeModule(() => import("./managed-image-attachments-D82laySx.js"));
const getModelsHttpModule = createLazyRuntimeModule(() => import("./models-http-B_p7YKKU.js"));
const getOpenAiHttpModule = createLazyRuntimeModule(() => import("./openai-http-9urlXlOE.js"));
const getOpenResponsesHttpModule = createLazyRuntimeModule(() => import("./openresponses-http-DPyXZf-A.js"));
const getSessionHistoryHttpModule = createLazyRuntimeModule(() => import("./sessions-history-http-C3ODuibQ.js"));
const getSessionKillHttpModule = createLazyRuntimeModule(() => import("./session-kill-http-CfvDDxGv.js"));
const getToolsInvokeHttpModule = createLazyRuntimeModule(() => import("./tools-invoke-http-peEEDumG.js"));
const getPluginNodeCapabilityAuthModule = createLazyRuntimeModule(() => import("./plugin-node-capability-auth-D-vIK5z4.js"));
const getHttpAuthUtilsModule = createLazyRuntimeModule(() => import("./http-auth-utils-CGtXLF_J.js"));
const getPluginRouteRuntimeScopesModule = createLazyRuntimeModule(() => import("./plugin-route-runtime-scopes-CBDDYAn9.js"));
...
const loadGatewayPluginsHttpModule = async () => await import("./plugins-http-CTQS9d3-.js");
	...
	try {
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-Dsuv432E.js");
...
const loadGatewayModelCatalogModule = createLazyRuntimeModule(() => import("./server-model-catalog-BAl4fN1p.js"));
...
const loadGatewayStartupEarlyModule = createLazyRuntimeModule(() => import("./server-startup-early-DJ124qpI.js"));
const loadGatewayStartupPostAttachModule = createLazyRuntimeModule(() => import("./server-startup-post-attach-B3O9knW5.js"));
...
const getChannelRuntime = createLazyRuntimeModule(() => import("./runtime-channel-DwVDY2Aw.js").then(({ createRuntimeChannel }) => createRuntimeChannel()));
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-DQ4_3VO8.js");
...
const loadGatewayPluginBootstrapModule = createLazyRuntimeModule(() => import("./server-plugin-bootstrap-CtU_XTUf.js"));
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-mSclxKui.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-CkrmExcg.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	const { bootstrapGatewayNetworkRuntime } = await import("./server-network-runtime-Cpf6SZvj.js");
	...
	const startupConfigModulePromise = import("./server-startup-config-BpZjq4q6.js");
	const loadStartupPluginsModule = createLazyPromise(() => import("./server-startup-plugins-CaPrk84k.js"), { cacheRejections: true });
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-r5ejxORO.js");
	...
	const { createTerminalLaunchPolicy } = await import("./launch-CwyTDBrN.js");
	...
	const { createChannelManager } = await import("./server-channels-CJpFiZWS.js");
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-jbxtNSFm.js");
	...
	const { TerminalSessionManager, DEFAULT_TERMINAL_DETACH_SECONDS } = await import("./session-manager-DO5gZKeb.js");
	const terminalSessions = new TerminalSessionManager({
		emit: (connId, event, payload) => broadcastToConnIds(event, payload, /* @__PURE__ */ new Set([connId])),
	...
	const createCloseHandler = () => async (optsValue) => {
		...
		await createGatewayCloseHandler({
			...
			markMainSessionsAbortedForRestart: async ({ sessionKeys, sessionIds, activeRuns, reason, isActiveRun }) => {
				...
				const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-TYP8gbsd.js");
	...
	try {
		...
		const [{ startGatewayEventSubscriptions }, { startGatewayRuntimeServices }] = await startupTrace.measure("runtime.post-early-imports", () => Promise.all([import("./server-runtime-subscriptions-OlWMLbPY.js"), import("./server-runtime-startup-services-C7PB1U_D.js")]));
		...
		const { execApprovalManager, pluginApprovalManager, extraHandlers, coreGatewayHandlers } = await startupTrace.measure("gateway.handlers", async () => {
			const [{ createGatewayAuxHandlers }, { coreGatewayHandlers: coreGatewayHandlersLocal }] = await Promise.all([import("./server-aux-handlers-BfM3vWwc.js"), import("./server-methods-NpEcZnvp.js")]);
			return {
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table-Bvf1ZIhd.js"),
				loadGatewayPluginBootstrapModule(),
				import("./services-CIGmZCbX.js")
			]);
		...
		const gatewayRequestContext = await startupTrace.measure("gateway.request-context", async () => {
			const { createGatewayRequestContext } = await import("./server-request-context-CyBqotZW.js");
		...
		const [{ attachGatewayWsHandlers }, { listPluginNodeCapabilities }] = await startupTrace.measure("gateway.ws-imports", () => Promise.all([import("./server-ws-runtime-CXYLcFG-.js"), import("./route-capability-hOkmtBZl.js")]));
		...
		const loadScheduledServicesModule = createLazyPromise(() => import("./server-runtime-services-C-l6zrvk.js"), { cacheRejections: true });
		...
		activateScheduledServicesWhenReady();
		const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-peAeJAWO.js");
