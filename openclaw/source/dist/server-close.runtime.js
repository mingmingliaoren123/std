...
import { n as disposeRegisteredAgentHarnesses } from "./registry-DtLZ3rba.js";
import { a as closePluginStateDatabase } from "./plugin-state-store-i0oVFZ17.js";
...
import { n as createChatAbortMarker } from "./server-chat-state-_DvSGu8D.js";
import { a as isChatAbortControllerEntryAbortable, c as removeChatAbortControllerEntry, r as abortTrackedChatRunById } from "./chat-abort-CV5hBwE-.js";
import { n as abortQueuedChatTurns } from "./chat-queued-turns-BR9Fon2X.js";
import { n as collectGatewayProcessMemoryUsageMb, o as measureGatewayRestartTrace, s as recordGatewayRestartTrace } from "./restart-trace-B8OzHXli.js";
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-CV7slv6G.js";
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./agent-bundle-lsp-runtime-x3F63WyH.js");
	await disposeAllBundleLspRuntimes();
}
async function stopGmailWatcherOnDemand() {
	const { stopGmailWatcher } = await import("./gmail-watcher-Dj24WzE-.js");
