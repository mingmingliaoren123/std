...
import { s as resolveSandboxHostPathViaExistingAncestor } from "./network-mode-IZZOKBNF.js";
import { t as acquireSessionWriteLock } from "./session-write-lock-BZ_4P1vk.js";
import "./workspace-DkQ7irPD.js";
import { C as SANDBOX_REGISTRY_PATH, S as SANDBOX_CONTAINERS_DIR, _ as SANDBOX_AGENT_WORKSPACE_MOUNT, b as SANDBOX_BROWSER_REGISTRY_PATH, v as SANDBOX_BROWSERS_DIR, w as SANDBOX_STATE_DIR } from "./constants-5yTHqBiK.js";
import { n as sanitizeExplicitSandboxEnvVars, t as sanitizeEnvVars } from "./sanitize-env-vars-CequRb6L.js";
import { a as resolveWindowsSpawnProgram, r as materializeWindowsSpawnProgram } from "./windows-spawn-C5RDaB22.js";
import { r as validateSandboxSecurity } from "./validate-sandbox-security-DQe7hw6K.js";
...
//#endregion
export { updateRegistry as A, inspectLegacySandboxRegistryFiles as C, removeBrowserRegistryEntry as D, readRegistry as E, removeRegistryEntry as O, resolveReadOnlyWorkspaceSkillMounts as S, readBrowserRegistry as T, appendReadOnlyWorkspaceSkillMountArgs as _, execDocker as a, isExistingWorkspaceSkillMountSource as b, isDockerDaemonUnavailable as c, readDockerPort as d, resolveDockerEnvPolicyEpoch as f, slugifySessionKey as g, resolveSandboxWorkspaceLayoutPaths as h, ensureSandboxContainer as i, computeSandboxBrowserConfigHash as j, updateBrowserRegistry as k, readDockerContainerEnvVar as l, resolveSandboxAgentId as m, dockerContainerState as n, execDockerRaw as o, resolveDockerSpawnInvocation as p, ensureDockerImage as r, formatDockerDaemonUnavailableError as s, buildSandboxCreateArgs as t, readDockerContainerLabel as u, appendWorkspaceMountArgs as v, migrateLegacySandboxRegistryFiles as w, resolveMaterializedSandboxSkillsWorkspaceDir as x, formatReadOnlyWorkspaceSkillMountHashState as y };
