...
import { s as readLegacyNpmPluginDeclaration } from "./discovery-7zi_zNvu.js";
...
import { a as resolveDefaultPluginNpmDir, l as resolvePluginNpmPackageDir, o as resolvePluginInstallDir, r as resolveDefaultPluginExtensionsDir } from "./install-paths-DvIXYmsV.js";
import { t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-Dd35fnKn.js";
import { C as resolveOfficialExternalProviderPluginIdsForEnv, S as resolveOfficialExternalProviderPluginIds, b as resolveOfficialExternalPluginLabel, f as listOfficialExternalPluginCatalogEntries, v as resolveOfficialExternalPluginId, w as resolveOfficialExternalWebProviderContractPluginIdsForEnv, x as resolveOfficialExternalProviderContractPluginIds, y as resolveOfficialExternalPluginInstall } from "./official-external-plugin-catalog-ph3rbXr3.js";
import { t as sanitizeTerminalText } from "./safe-text-Bkz4mOfI.js";
import { i as loadInstalledPluginIndex } from "./installed-plugin-index-N4jxqS0-.js";
import { d as collectConfiguredModelRefs, t as collectConfiguredSpeechProviderIds } from "./gateway-startup-speech-providers-tDMeTcRJ.js";
...
import { s as resolveConfiguredChannelPresencePolicy } from "./channel-presence-policy-BqAeFQQ-.js";
import { t as collectConfiguredMemoryEmbeddingProviderIds } from "./gateway-startup-plugin-ids-COmsQTCi.js";
import { d as resolveNpmInstallRecordSpec, l as buildNpmResolutionInstallFields, s as writePersistedInstalledPluginIndexInstallRecords } from "./installed-plugin-index-records-C_n191FN.js";
import { n as resolveWebSearchInstallCatalogEntriesForEnv, r as resolveWebSearchInstallCatalogEntry } from "./web-search-install-catalog-Cp_1AMaI.js";
...
import { a as installPluginFromNpmSpec } from "./install-YXjfuIuN.js";
...
import { r as listRawChannelPluginCatalogEntries } from "./catalog-dIh-7kX9.js";
import { d as resolveRegistryUpdateChannel, l as normalizeUpdateChannel } from "./update-channels-CIHQjIuI.js";
import { n as resolveNpmInstallSpecsForUpdateChannel, t as resolveClawHubInstallSpecsForUpdateChannel } from "./install-channel-specs-C_uVEsCe.js";
import { a as updateNpmInstalledPlugins, t as isClawHubTrustSkippedOutcome } from "./update-DhHun9WV.js";
import { n as collectConfiguredRuntimePluginIds, t as CONFIGURED_RUNTIME_PLUGIN_INSTALL_CANDIDATES } from "./configured-runtime-plugin-installs-imhYJBeY.js";
import { n as resolveProviderInstallCatalogEntries } from "./provider-install-catalog-jUfsomek.js";
import { c as isLegacyPackageUpdateDoctorPass, f as shouldDeferConfiguredPluginInstallRepair, u as isPostCoreConvergencePass } from "./update-phase-DNlGDAAE.js";
...
function collectConfiguredProviderPluginIds(params) {
	...
	const selectedProviderIds = /* @__PURE__ */ new Set([...configuredProviderIds, ...configuredMediaProviderIds]);
...
const VERSION_BOUND_RUNTIME_PLUGIN_IDS = /* @__PURE__ */ new Set(["codex"]);
