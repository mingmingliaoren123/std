import { n as normalizeAgentModelRefForConfig } from "./model-input-B5RmygIK.js";
...
import { t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-UP3ck3u3.js";
...
import { n as openUrl } from "./browser-open-wAEXvs6S.js";
import { r as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-jUfsomek.js";
import { t as isRemoteEnvironment } from "./remote-env-n-Ucnq3R.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-CPGbpMwP.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-oeGaMyXU.js");
		...
		const { ensureCopilotRuntimePluginForModelSelection } = await import("./copilot-runtime-plugin-install-DL7W_qLd.js");
...
//#endregion
export { runProviderPluginAuthMethodUnpersisted as i, applyProviderPluginAuthMethodResultConfig as n, runProviderPluginAuthMethod as r, applyAuthChoiceLoadedPluginProvider as t };
