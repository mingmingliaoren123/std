...
import { i as clampNumber } from "./utils-CRO4LGEB.js";
import { r as resolveAgentConfig } from "./agent-scope-config-BxAUeF6t.js";
import { S as toCodeModeJsonSafe, b as createCodeModeNamespaceRuntime, x as describeCodeModeNamespacesForPrompt, y as createCodeModeApiVirtualFiles } from "./registry-B8eQDFB4.js";
import { n as ToolInputError, r as asToolParamsRecord } from "./common-DWyiui3y.js";
import { t as jsonResult } from "./tool-results-BCM3fdVS.js";
import { _ as isCodeModeControlTool, h as CODE_MODE_WAIT_TOOL_NAME, m as CODE_MODE_EXEC_TOOL_NAME, v as markCodeModeControlTool } from "./agent-tools.before-tool-call-C95DXQXZ.js";
import { o as optionalStringEnum } from "./typebox-DnTTOzWO.js";
import { a as ToolSearchRuntime, c as applyToolCatalogCompaction, o as addClientToolsToToolCatalog } from "./tool-search-B8B4Spes.js";
...
function headlessAbortError(signal) {
	return signal.reason instanceof CodeModeHeadlessTimeoutError ? signal.reason : new CodeModeHeadlessTimeoutError("code mode headless execution aborted");
}
...
async function runHeadlessWorkerLeg(params) {
	...
	const workerTimeoutMs = Math.max(1, Math.min(remainingMs, timeoutMs + 1e3));
...
async function runCodeModeScriptHeadless(params) {
	...
	try {
		...
		while (true) {
			...
			const requestedToolCalls = result.pendingRequests.filter((request) => request.method === "call" || request.method === "namespace").length;
		...
		return headlessFailure({
			...
			error: error instanceof CodeModeHeadlessTimeoutError ? error.message : codeModeFailureMessage(error),
			output,
			toolCallCount
		});
	} finally {
...
//#endregion
export { runCodeModeScriptHeadless as a, resolveCodeModeConfig as i, applyCodeModeCatalog as n, createCodeModeTools as r, addClientToolsToCodeModeCatalog as t };
