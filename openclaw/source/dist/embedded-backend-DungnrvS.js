...
import { a as resolveAgentDir, c as resolveDefaultAgentId, o as resolveAgentWorkspaceDir } from "./agent-scope-config-BxAUeF6t.js";
...
import { a as applySessionPatchProjection } from "./session-accessor-D7yi6P1i.js";
...
import { t as buildAllowedModelSet } from "./model-selection-B9dihan1.js";
...
import { c as clearSessionGoal, d as getSessionGoal, l as createSessionGoal, m as updateSessionGoalStatus, p as updateSessionGoalObjective, u as formatSessionGoalStatus } from "./sessions-oDygYVdy.js";
import { o as readSessionMessagesAsync } from "./session-transcript-readers-BMjfbAlq.js";
import { r as ensureContextWindowCacheLoaded } from "./context-_zWLdTOu.js";
import { a as getSessionDefaults, c as listSessionsFromStoreAsync, d as migrateAndPruneGatewaySessionStoreKey, g as resolveGatewaySessionStoreTarget, o as listAgentsForGateway, t as buildGatewaySessionInfo, u as loadSessionEntry, x as resolveSessionModelRef } from "./session-utils-DD3pe_2A.js";
import { D as setEmbeddedPluginApprovalBroker, E as clearEmbeddedPluginApprovalBroker, T as EmbeddedPluginApprovalBroker, k as setEmbeddedMode } from "./agent-tools.before-tool-call-C95DXQXZ.js";
...
import { t as loadGatewayModelCatalog } from "./server-model-catalog-DA09KJne.js";
import { a as parseGoalCommand } from "./commands-goal-Fg-ONVEj.js";
import { a as shouldSuppressAssistantEventForLiveChat, i as resolveMergedAssistantText, n as projectLiveAssistantBufferedText, r as resolveAssistantLiveChatInput, t as normalizeLiveAssistantBufferedText } from "./live-chat-projector-BfpgAbEg.js";
import { o as isChatStopCommandText } from "./chat-abort-CV5hBwE-.js";
import { c as performGatewaySessionReset } from "./session-reset-service-CV7slv6G.js";
...
import { c as resolveEffectiveChatHistoryMaxChars, r as augmentChatHistoryWithCanvasBlocks, s as projectRecentChatDisplayMessages } from "./session-transcript-path-EobUxjvp.js";
...
import { i as projectSessionsPatchEntry, n as createGatewaySession } from "./session-create-service-14oZxrT5.js";
...
var EmbeddedTuiBackend = class {
	...
	start() {
		...
		this.ready = (async () => {
			const { runSessionStartupMigration } = await import("./startup-migration-CrdsHXRn.js");
	...
	async runBtwTurn(params) {
		...
		const { runBtwSideQuestion } = await import("./btw-DkQ0dAzV.js");
