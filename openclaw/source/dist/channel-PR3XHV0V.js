...
import { v as updateSessionStore } from "./store-BJJhlPrk.js";
...
import { c as normalizeInteractiveReply, l as normalizeMessagePresentation, o as interactiveReplyToPresentation, p as resolveInteractiveTextFallback } from "./payload-C0zJd_02.js";
import { i as createHybridChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-BH5RG2Ab.js";
...
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-DXd2kIwS.js";
...
import { t as formatAllowFromLowercase } from "./allow-from-DJ-xE_D2.js";
import { E as projectConfigAccountIdWarningCollector, g as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-HQ-6pbOn.js";
...
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-D9YNI4xN.js";
...
import { d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-Dy-C1WAt.js";
...
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, n as inspectFeishuCredentials, p as isRecord$1, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-4bVnpxTp.js";
import { i as resolveReceiveIdType, n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-Ese_DJz7.js";
import { a as readNativeFeishuCardJson, n as createFeishuSendReceipt } from "./send-result-BkekdClJ.js";
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, o as resolveConfiguredFeishuGroupSessionScope, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-B-P3uZgY.js";
import { i as listFeishuDirectoryPeers, r as listFeishuDirectoryGroups, t as buildFeishuPresentationCard } from "./presentation-card-BIpVtGga.js";
import { t as messageActionTargetAliases } from "./security-audit-BaF-fe6b.js";
import { i as resolveFeishuGroupConfig, s as resolveFeishuGroupToolPolicy } from "./policy-hydoYQvK.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-Y6rgiYAk.js";
import { t as collectFeishuSecurityAuditFindings } from "./security-audit-shared-CmdjP9Z9.js";
import { t as resolveFeishuSessionConversation } from "./session-conversation-BhNQWwer.js";
...
const loadAppRegistrationModule = createLazyRuntimeModule(() => import("./app-registration-D-oqMP2f.js"));
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, accountId, configured }) => {
			...
			if (configured && account.configured) try {
				const { probeFeishu } = await import("./probe-DRxXXjfk.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-DDr9xG-i.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-BGJbtv6p.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-DKRd0zzH.js");
