...
import { b as resolveModelRefFromString, i as buildModelAliasIndex, u as inferUniqueProviderFromConfiguredModels } from "./model-selection-shared-iHJcI8fT.js";
...
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-COUzIGD_.js";
import { n as isMinimaxVlmProvider, t as isMinimaxVlmModel } from "./minimax-vlm-CvP1HtmK.js";
...
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-a1NGOUtu.js";
import { a as resolveModelEntries, s as resolveScopeDecision } from "./resolve-DpuaVxmy.js";
import { n as resolveOpenAiAudioAuthModelApi } from "./openai-audio-api-BEkNYRPi.js";
import { S as normalizeAttachments, _ as fileExists, a as runCliEntry, b as selectAttachments, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaAttachmentCache, y as isMediaUnderstandingSkipError } from "./runner.entries-Ci_g3yUf.js";
...
const loadHasAvailableAuthForProvider = createLazyRuntimeNamedExport(() => import("./model-auth-DuCq_7Oo.js"), "hasAvailableAuthForProvider");
const loadModelCatalogApi = createLazyRuntimeModule(async () => await import("./model-catalog-BAFTl1f7.js"));
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-JesAmay9.js");
...
async function resolveKeyEntry(params) {
	...
	const checkProvider = async (providerId, model) => {
		...
		const resolvedModel = capability === "image" ? await resolveAutoImageModelId({
			...
			explicitModel: model,
			workspaceDir
		}) : capability === "video" ? model ?? resolveDefaultMediaModelFromRegistry({
			providerId,
			capability: "video",
			providerRegistry
		}) : model;
