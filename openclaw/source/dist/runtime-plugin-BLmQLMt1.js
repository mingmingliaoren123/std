...
import { t as resolveManifestActivationPlan } from "./activation-planner-SUazSC2E.js";
...
async function ensureSelectedAgentHarnessPlugin(params) {
	...
	const { ensurePluginRegistryLoaded } = await import("./runtime-registry-loader-d7xui8oD.js");
