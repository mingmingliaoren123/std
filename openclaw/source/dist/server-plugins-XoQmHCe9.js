...
import { c as normalizeOperatorScopeList, t as ADMIN_SCOPE } from "./operator-scopes-CpPJIv7P.js";
import "./method-scopes-CwW_Szsp.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-B2g1v2k7.js";
import { s as loadOpenClawPlugins, t as clearActivatedPluginRuntimeState } from "./loader-D8d2EvVh.js";
...
import { r as createPluginRuntimeLoaderLogger } from "./load-context-BlqO0SBV.js";
import { a as normalizeModelRef, c as parseModelRef } from "./model-selection-normalize-Y5vjde6P.js";
...
function resolveRuntimeNodeInvokeSyntheticScopes(params) {
	if (!params.requestedScopes) return;
	if (!canTrustedOfficialPluginRequestScopes(params)) return;
...
//#endregion
export { dispatchGatewayMethodInProcessRaw as a, loadGatewayPlugins as c, setPluginSubagentOverridePolicies as d, dispatchGatewayMethodInProcess as i, setFallbackGatewayContext as l, createGatewayNodesRuntime as n, dispatchTrustedPluginGatewayMethod as o, createGatewaySubagentRuntime as r, hasInProcessGatewayContext as s, clearFallbackGatewayContext as t, setFallbackGatewayContextResolver as u };
