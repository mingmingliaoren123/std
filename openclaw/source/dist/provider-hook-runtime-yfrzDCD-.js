...
import { n as resolvePluginProviders, r as resolveProviderConfigApiOwnerHint, t as isPluginProvidersLoadInFlight } from "./providers.runtime-CnTLnp5P.js";
...
function resolveProviderDiscoveryProviderIdsForCatalogScope(params) {
	const providerIds = normalizeUniqueSingleOrTrimmedStringList([...params.providerRefs ?? [], ...(params.modelRefs ?? []).map(providerFromModelRef)]);
