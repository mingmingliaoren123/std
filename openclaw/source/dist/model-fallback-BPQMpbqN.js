...
import { c as redactSensitiveText, g as readLoggingConfig, n as getDefaultRedactPatterns } from "./redact-B9QQ4Wyz.js";
...
import { i as emitFailoverEvent } from "./diagnostic-events-JZsXee1S.js";
...
import { i as resolveAgentModelPrimaryValue, r as resolveAgentModelFallbackValues } from "./model-input-B5RmygIK.js";
import { p as resolvePluginControlPlaneFingerprint, r as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-CmOpmveB.js";
import { V as resolveCronMaxConcurrentRuns } from "./io-By0s-a_s.js";
...
import { r as getRegisteredAgentHarness } from "./registry-DtLZ3rba.js";
import { r as applySessionStoreEntryPatch } from "./store-BJJhlPrk.js";
import { t as isPluginProvidersLoadInFlight } from "./providers.runtime-CnTLnp5P.js";
import { r as externalCliDiscoveryForProviders } from "./external-cli-discovery-BA28IiyS.js";
...
import { _ as resolveConfiguredModelRef, b as resolveModelRefFromString, i as buildModelAliasIndex, n as buildConfiguredAllowlistKeys } from "./model-selection-shared-iHJcI8fT.js";
...
import { o as parseApiErrorInfo } from "./assistant-error-format-Ccvn1r0A.js";
import { o as getApiErrorPayloadFingerprint } from "./sanitize-user-facing-text-D-sR-1VY.js";
import { S as isLikelyContextOverflowError, o as classifyProviderRuntimeFailureKind } from "./errors-XbAR6hS3.js";
import { a as describeFailoverError, i as coerceToFailoverError, n as buildFailoverRemediationHint, o as isFailoverError, r as buildProviderReauthCommand, s as isNonProviderRuntimeCoordinationError, t as FailoverError } from "./failover-error-B2zFYEnG.js";
import { o as isAgentRunDirectAbortReason, s as isAgentRunRestartAbortReason } from "./run-termination-DjANsN9j.js";
import "./sessions-oDygYVdy.js";
import { n as isCliRuntimeAlias } from "./model-runtime-aliases-w4oRlOM0.js";
import { d as isCommandLaneTaskTimeoutError, g as setCommandLaneConcurrency } from "./command-queue-DqzpsN4m.js";
import "./embedded-agent-helpers-DZZ4Y-Tw.js";
import { n as isCronTerminalAbortReasonText } from "./execution-errors-BeXudclS.js";
import { a as resolveStoredSessionKeyForSessionId } from "./session-HDnU4RDT.js";
...
async function runFallbackCandidate(params) {
	try {
		...
		return {
			ok: false,
			error: coerceToFailoverError(err, {
				provider: params.provider,
				model: params.model,
...
async function resolveModelFallbackCandidateHarnessAuthPrecheck(params) {
	...
	if (isCliProvider(params.provider, params.cfg)) return result(true);
