...
import { D as resolveIntegerOption, j as resolveTimerTimeoutMs, o as asDateTimestampMs, p as finiteSecondsToTimerSafeMilliseconds } from "./number-coercion-CJQ8TR--.js";
...
import { T as hasSessionAutoModelFallbackProvenance, i as hasLegacyAutoFallbackWithoutOrigin, m as resolveAutoFallbackPrimaryProbe, p as resolveAgentSkillsFilter, t as clearAutoFallbackPrimaryProbeSelection, v as resolveSessionAgentId } from "./agent-scope-B2Pk_xhT.js";
import { a as isSubagentSessionKey, c as parseAgentSessionKey, n as isAcpSessionKey } from "./session-key-utils-A-JGvyXu.js";
import { d as normalizeMainKey, i as buildAgentMainSessionKey, u as normalizeAgentId } from "./session-key-VWT_xzM9.js";
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir, r as resolveAgentConfig, t as listAgentEntries } from "./agent-scope-config-BxAUeF6t.js";
import { t as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-default-ClCi3unQ.js";
...
import { o as resetRegisteredAgentHarnessSessions } from "./registry-DtLZ3rba.js";
import { t as getGlobalHookRunner, u as fireAndForgetHook } from "./hook-runner-global-BmIrGlLG.js";
import { d as markCommandReplyForDelivery } from "./reply-payload-BK_jICQ3.js";
...
import { P as resolveSessionStoreEntry, R as deriveSessionMetaPatch, V as resolveGroupSessionKey, X as resolveMaintenanceConfigFromInput, b as runExclusiveSessionStoreWrite, et as parseSessionThreadInfoFast } from "./store-BJJhlPrk.js";
import { a as normalizeDeliveryChannelRoute, n as deliveryContextFromSession, o as normalizeDeliveryContext, r as deliveryContextKey, s as normalizeSessionDeliveryFields } from "./delivery-context.shared-3o3tBaCD.js";
import "./message-channel-constants-BXOA4cxJ.js";
import { a as resolveSessionFilePath, d as resolveStorePath, o as resolveSessionFilePathOptions, s as resolveSessionTranscriptPath } from "./paths-C2C4lJH6.js";
...
import { u as commitReplySessionInitialization, v as loadReplySessionInitializationSnapshot, y as loadSessionEntry } from "./session-accessor-D7yi6P1i.js";
...
import { s as getMediaDir } from "./store-VcV5Hs9C.js";
import { i as generateSecureToken } from "./secure-random-Ds4AFLgz.js";
import { d as ensureAgentWorkspace, p as isWorkspaceBootstrapPending } from "./workspace-DkQ7irPD.js";
...
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-Eo9j6lAM.js";
import { t as hasControlCommand } from "./command-detection-DeOEqON9.js";
import { n as isInternalSourceReplyChannel } from "./source-reply-delivery-mode-Cl9ZnCi6.js";
import { a as enqueueSystemEvent } from "./system-events-BfmWSF2P.js";
import { n as resolveAgentTimeoutMs } from "./timeout-0Cw4kcol.js";
import { A as replyRunRegistry, E as isReplyRunStreamingForSessionId, I as waitForReplyRunEndBySessionId, M as resolveActiveReplyRunThreadId, T as isReplyRunActiveForSessionId, h as REPLY_RUN_IDLE_SETTLE_TIMEOUT_MS, j as resolveActiveReplyRunSessionId, y as abortReplyRunBySessionId } from "./run-state-BteeOQT8.js";
...
import { c as resolveSessionWorkStartError, i as hasTerminalMainSessionTranscriptNewerThanRegistry, o as isSessionWorkStartInvalidatedError, s as resolveSessionLifecycleTimestamps } from "./lifecycle-BS_t5emX.js";
...
import { n as annotateInterSessionPromptText, o as isInterSessionInputProvenance } from "./input-provenance-BkJA7lbx.js";
...
import { l as getQueueSize, r as clearCommandLane } from "./command-queue-DqzpsN4m.js";
import { l as retireSessionMcpRuntime } from "./agent-bundle-mcp-runtime--G82BMQs.js";
import "./agent-bundle-mcp-tools-CYL4t7pb.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-BiTZkkCF.js";
import { a as HEARTBEAT_TRANSCRIPT_PROMPT, d as stripHeartbeatToken } from "./heartbeat-Butmf3AR.js";
...
import { f as extractQueueDirective, m as takeDirectiveToken, p as skipDirectiveArgPrefix, t as resolveQueueSettings } from "./queue-C2HxHfMa.js";
import { n as runAgentHarnessBeforeMessageWriteHook } from "./hook-helpers-GgBV1rQp.js";
import { o as resolvePersistedUserTurnText, r as createUserTurnTranscriptRecorder, t as buildPersistedUserTurnMediaInputsFromFields } from "./user-turn-transcript-K2ELDNX3.js";
...
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-CLWKm8aG.js";
...
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-DMlJwv6b.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-BBAryBw6.js";
import { i as interruptSessionWorkAdmissions, s as runExclusiveSessionLifecycleMutation } from "./session-lifecycle-admission-DfdITEs1.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-tXGTgalp.js";
...
import { i as resolveEffectiveReplyRoute, r as isSystemEventProvider, t as createReplyTimingTracker } from "./reply-timing-tracker-Dljk1RE-.js";
import { n as shouldUseFromAsSenderFallback } from "./command-auth-De19E7rf.js";
import { n as shouldHandleTextCommands } from "./commands-text-routing-Bsb-jCdS.js";
import "./commands-registry-DNV4RD24.js";
import { c as takeCommandSessionMetadataChangesFromTargets } from "./commands-goal-Fg-ONVEj.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-BSozxK0B.js";
import { t as parseSoftResetCommand } from "./commands-reset-mode-CyVYz7U7.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-BJW-vfhG.js";
import { a as resolveGetReplyConfig, c as shouldUseReplyFastTestBootstrap, d as createReplySessionEntryHandle, i as initFastReplySessionState, l as shouldUseReplyFastTestRuntime, n as stageRemoteInboundMediaIfNeeded, o as shouldHandleFastReplyTextCommands, r as buildFastReplyCommandContext, s as shouldUseReplyFastDirectiveExecution, t as resolveRunTypingPolicy } from "./typing-policy-5BwWqkwV.js";
...
import { n as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-CX4ldnEg.js";
...
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-BavR4Si3.js";
import { a as buildSessionStartHookPayload, i as buildSessionEndHookPayload, r as noteActiveSessionForShutdown, t as forgetActiveSessionForShutdown } from "./active-sessions-shutdown-tracker-DWFd2epH.js";
import { n as clearSessionResetRuntimeState, t as resolveResetPreservedSelection } from "./reset-preserved-selection-B8mWIhXv.js";
import { a as resolveEnvelopeFormatOptions } from "./envelope-CXHEh-mU.js";
import { r as updateAmbientTranscriptWatermark } from "./ambient-transcript-watermark-pZlMospW.js";
import { t as normalizeGroupActivation } from "./group-activation-MKTJBUwi.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-DmzPZUOs.js";
import { n as buildCommandContext, t as isResetAuthorizedForContext } from "./reset-authorization-bNs1xKoZ.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-96eyd_gz.js";
...
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-D6iDvMCF.js";
...
import { i as resolveSkillCommandInvocation, r as listReservedChatSlashCommandNames } from "./chat-commands-CTkzfKoR.js";
import { t as persistReplySessionEntry } from "./session-entry-persistence-BgDxPHSt.js";
import { n as consumeSessionSkillSuggestion } from "./skill-suggestions-CyD-_P50.js";
import { a as buildInboundUserContextPrefix, c as resolveInboundUserContextPromptJoiner, d as resolveSilentReplySettings, i as buildInboundMetaSystemPrompt, l as resolveCurrentTurnImages, n as resolveTypingMode, o as formatActiveGoalContext, r as resolveActiveRunQueueAction } from "./typing-mode-C35PNSLH.js";
import { n as resolvePreparedReplyQueueState } from "./get-reply-run-queue-CJI8xCZG.js";
import { n as resolveEffectiveToolInventory } from "./tools-effective-inventory-D78fLEDu.js";
import { t as drainFormattedSystemEvents } from "./session-system-events-DypErYvT.js";
...
const directiveLevelsLoader = createLazyImportLoader(() => import("./directive-handling.levels-Fb-Ynq01.js"));
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-Jg7Ky6t3.js"));
const directiveFastLaneLoader = createLazyImportLoader(() => import("./directive-handling.fast-lane-C8qfQEkx.js"));
...
const skillToolDispatchRuntimeLoader = createLazyImportLoader(() => import("./tool-dispatch-CEP-8k2K.js"));
...
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-DrSndTBR.js"));
...
const sessionAccessorRuntimeLoader = createLazyImportLoader(() => import("./session-accessor-BJhUxmZV.js"));
...
function buildReplyPromptEnvelopeBase(params) {
	...
	return {
		...
		transcriptBody: params.isHeartbeat ? HEARTBEAT_TRANSCRIPT_PROMPT : params.isBareSessionReset ? softResetTail || `[OpenClaw session ${params.startupAction}]` : isRoomEvent ? resolveRoomEventTranscriptBody(params) : params.hasUserBody ? params.baseBody : "[User sent media without caption]",
...
async function runPreparedReply(params) {
	...
	const queuedFollowupAbortSignal = opts?.queuedFollowupLifecycle || inboundEventKind === "room_event" ? opts?.queuedFollowupAbortSignal ?? opts?.abortSignal : void 0;
...
const loadDeliverRuntime = createLazyPromiseLoader(() => import("./runtime-COSz3sE9.js"), { cacheRejections: true }).load;
...
async function initSessionStateAttemptLocked(params, attemptContext, staleSnapshotRetried, lifecycleMutationIdentity) {
	...
	const freshEntry = isSystemEvent && canReuseExistingEntry || (reconnectResumeRequested && canReuseExistingEntry || recoverTerminalVisibleEntry || (entryFreshness?.fresh ?? false) || softResetAllowed && canReuseExistingEntry) && !terminalMainTranscriptNewerThanRegistry;
		...
		if (opts?.isHeartbeat) {
			if (classifyHeartbeatPendingFinalDelivery(text, resolveHeartbeatAckMaxChars(cfg, agentId)).shouldClear) {
				...
				if (sessionKey && storePath) {
					const { updateSessionEntry } = await import("./session-accessor-BJhUxmZV.js");
