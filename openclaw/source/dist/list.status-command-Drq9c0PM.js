...
import { c as resolveAgentExplicitModelPrimary, d as resolveAgentModelFallbacksOverride } from "./agent-scope-B2Pk_xhT.js";
...
import { a as restoreCurrentPluginMetadataSnapshotState, o as setCurrentPluginMetadataSnapshot, r as getCurrentPluginMetadataSnapshot, t as captureCurrentPluginMetadataSnapshotState } from "./current-plugin-metadata-snapshot-CmOpmveB.js";
...
import { c as shouldEnableShellEnvFallback, n as getShellEnvAppliedKeys } from "./shell-env-DaE9Xx3-.js";
...
import { j as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-CLQOjLJ6.js";
import { n as evaluateStoredCredentialEligibility } from "./credential-state-BY-oz-QV.js";
import { i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-DH33UrUj.js";
import { i as resolveAuthProfileDisplayLabel } from "./auth-profiles-BFnI-y_7.js";
import "./profiles-DyU-YCq2.js";
...
import { _ as resolveConfiguredModelRef, b as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-iHJcI8fT.js";
import { i as modelKey, o as normalizeProviderId } from "./model-selection-normalize-Y5vjde6P.js";
import { b as resolveProviderEnvAuthLookupMaps, d as isNonSecretApiKeyMarker, f as isOAuthApiKeyMarker, y as listProviderEnvAuthLookupKeys } from "./model-auth-markers-BY1lCZu4.js";
...
import { g as resolveUsableCustomProviderApiKey, s as getCustomProviderApiKey } from "./model-auth-CJEm9SNp.js";
...
import { n as ensureFlagCompatibility, s as resolveKnownAgentId } from "./shared-D0zComE5.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-DlKuzdzL.js";
import { t as maskApiKey } from "./secret-mask-nHYqNjGp.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-T3MUOX0x.js"));
const progressRuntimeLoader = createLazyImportLoader(() => import("./progress-_D0rc7TD.js"));
const terminalTableRuntimeLoader = createLazyImportLoader(() => import("./terminal-core/table.js"));
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-ClrkxptP.js"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	try {
		...
		const listProviderProfileCandidates = (provider) => {
			...
			if (explicitOrder !== void 0) return Array.from(/* @__PURE__ */ new Set([...orderedProfiles, ...explicitOrder.filter(isEligibleOrHealthRescued)]));
			...
			if (configuredProfiles.length > 0) return Array.from(/* @__PURE__ */ new Set([...orderedProfiles, ...configuredProfiles.filter(isEligibleOrHealthRescued)]));
			...
			return Array.from(/* @__PURE__ */ new Set([...orderedProfiles, ...sameProviderProfiles]));
		};
		...
		if (missingProvidersInUse.length > 0) {
			const { buildProviderAuthRecoveryHint } = await import("./provider-auth-recovery-hint-j1NZVsoy.js");
			runtime.log("");
