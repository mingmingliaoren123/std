...
import { n as require_extend, t as require_package$1 } from "./package-CVD6zNz6.js";
 ...
 /**
		...
		*/
		static async #getProxyAgent() {
			this.#proxyAgent ||= (await import("./dist-CVCB8uRj.js").then((m) => /* @__PURE__ */ __toESM(m.default))).HttpsProxyAgent;
			return this.#proxyAgent;
		}
		static async #getFetch() {
			const hasWindow = typeof window !== "undefined" && !!window;
			this.#fetch ||= hasWindow ? window.fetch : (await import("./src-CVyrrf3o.js")).default;
			return this.#fetch;
		}
		/**
		* Merges headers.
