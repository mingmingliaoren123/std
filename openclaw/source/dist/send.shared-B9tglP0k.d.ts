...
//#endregion
export { APIGatewayBotInfo as $, MessageType as A, APIRole as At, APIGuildMemberAvatar as B, APIBaseMessage as C, ChannelType as Ct, APITextDisplayComponent as D, VideoQualityMode as Dt, APIMessageReference as E, ThreadChannelType as Et, APIFlaggedGuildMember as F, GuildExplicitContentFilter as G, APIGuildMemberUser as H, APIGuild as I, GuildVerificationLevel as J, GuildMFALevel as K, APIGuildIntegration as L, APIBaseGuild as M, _NonNullableFields as Mt, APIBaseGuildMember as N, Snowflake as Nt, APITextInputComponent as O, APIEmoji as Ot, APIBaseVoiceGuildMember as P, StickerFormatType as Q, APIGuildIntegrationType as R, APIAttachment as S, APIThreadMember as St, APIMessage as T, TextChannelType as Tt, APIUnavailableGuild as U, APIGuildMemberJoined as V, GuildDefaultMessageNotifications as W, APISticker as X, IntegrationExpireBehavior as Y, APIStickerItem as Z, ApplicationCommandOptionType as _, APIOverwrite as _t, MessagePayload as a, PresenceUpdateStatus as at, APIEntitlement as b, APITextChannel as bt, APIInteraction as c, APIGroupDMChannel as ct, APIApplicationCommandInteraction as d, APIGuildForumDefaultReactionEmoji as dt, GatewayActivity as et, ApplicationCommandType as f, APIGuildForumTag as ft, APIApplicationCommandInteractionDataOption as g, APINewsChannel as gt, APIApplicationCommandInteractionDataBasicOption as h, APIGuildVoiceChannel as ht, DiscordReplyReference as i, GatewayThreadMembersUpdate as it, TextInputStyle as j, _AddUndefinedToPossiblyUndefinedPropertiesOfInterface as jt, ComponentType as k, APIUser as kt, APIMessageComponentInteraction as l, APIGuildCategoryChannel as lt, APIApplicationCommandPermission as m, APIGuildStageVoiceChannel as mt, DiscordSendComponents as n, GatewayPresenceUpdate as nt, TopLevelComponents as o, APIAnnouncementThreadChannel as ot, InteractionContextType as p, APIGuildMediaChannel as pt, GuildSystemChannelFlags as q, DiscordSendEmbeds as r, GatewayThreadListSync as rt, APIApplication as s, APIChannel as st, DiscordAllowedMentions as t, GatewayGuildMembersChunkPresence as tt, APIApplicationCommand as u, APIGuildForumChannel as ut, APIInteractionDataResolvedChannel as v, APIPrivateThreadChannel as vt, APIEmbed as w, GuildChannelType as wt, APISubscription as x, APIThreadChannel as xt, InteractionResponseType as y, APIPublicThreadChannel as yt, APIGuildMember as z };