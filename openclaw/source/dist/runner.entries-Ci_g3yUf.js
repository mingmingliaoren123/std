...
import { r as writeExternalFileWithinRoot, v as pathExists } from "./fs-safe-RNq3oO57.js";
...
import { t as buildRandomTempFilePath } from "./temp-download-DmgDiVfB.js";
import { n as createConfigScopedPromiseLoader } from "./plugin-cache-primitives-BaxqicKH.js";
import { c as getOfficialExternalPluginCatalogManifest, p as listOfficialExternalProviderCatalogEntries } from "./official-external-plugin-catalog-ph3rbXr3.js";
...
import { c as kindFromMime, i as getFileExtension, n as detectMime, o as isAudioFileName } from "./mime-BaK8UYea.js";
...
import { a as mergeModelProviderRequestOverrides, d as sanitizeConfiguredProviderRequest, u as sanitizeConfiguredModelProviderRequest } from "./provider-request-config-FsDxTAaE.js";
import { n as CUSTOM_LOCAL_AUTH_MARKER } from "./model-auth-markers-BY1lCZu4.js";
import { s as convertHeicToJpeg, w as runFfmpeg } from "./media-services-n09-22kU.js";
...
import { i as readRemoteMediaBuffer, n as MediaFetchError } from "./fetch-DJgQj1Kz.js";
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-CH_uJYn5.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-CAoJyC6u.js";
import { n as resolveOfficialExternalPluginRepairHint } from "./official-external-plugin-repair-hints-FzM8MZrM.js";
import { n as normalizeMediaProviderId, t as normalizeMediaExecutionProviderId } from "./provider-id-DSbuCFIb.js";
import { t as describeImageWithModel } from "./image-runtime--DV-ur61.js";
import { c as DEFAULT_VIDEO_MAX_BASE64_BYTES, d as getMediaUnderstandingProvider, l as MIN_AUDIO_FILE_BYTES, n as DEFAULT_MAX_BYTES, s as DEFAULT_TIMEOUT_SECONDS, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-a1NGOUtu.js";
import { c as resolveTimeoutMs, n as resolveMaxBytes, o as resolvePrompt, r as resolveMaxChars } from "./resolve-DpuaVxmy.js";
import { n as resolveOpenAiAudioAuthModelApi } from "./openai-audio-api-BEkNYRPi.js";
import { n as providerOperationRetryConfig } from "./operation-retry-BUK-jRUn.js";
...
const loadModelAuth = createLazyRuntimeModule(async () => await import("./model-auth-DuCq_7Oo.js"));
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-JesAmay9.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio",
			workspaceDir: params.workspaceDir
