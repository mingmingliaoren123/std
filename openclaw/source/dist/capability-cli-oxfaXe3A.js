...
import { r as assertOkOrThrowHttpError } from "./provider-http-errors-HGLTiqMh.js";
...
import { s as getRuntimeConfigSourceSnapshot, v as setRuntimeConfigSnapshot } from "./runtime-snapshot-DOvWRYVz.js";
import "./config-DbyjySSE.js";
import { i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES } from "./client-info-CcqJJIan.js";
import { _ as randomIdempotencyKey, c as callGateway } from "./call-Bj6Erfmh.js";
...
import { E as listMemoryEmbeddingProviders } from "./registry-B8eQDFB4.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-BaK8UYea.js";
import { c as loadAuthProfileStoreForRuntime, m as updateAuthProfileStoreWithLock } from "./store-DH33UrUj.js";
import "./auth-profiles-BFnI-y_7.js";
import { n as listProfilesForProvider } from "./profile-list-XT2LKXsd.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-B9dihan1.js";
import { n as loadModelCatalog } from "./model-catalog-BfvH9gPq.js";
import { s as convertHeicToJpeg, u as getImageMetadata } from "./media-services-n09-22kU.js";
...
import { a as runWithImageModelFallback } from "./model-fallback-BPQMpbqN.js";
import { t as buildExplicitSessionIdSessionKey } from "./session-HDnU4RDT.js";
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-a1NGOUtu.js";
import { a as getCapabilityWebSearchCommandSecretTargets, c as getMemoryEmbeddingCommandSecretTargetIds, l as getModelsCommandSecretTargetIds, m as getTtsCommandSecretTargetIds, r as getCapabilityWebFetchCommandSecretTargets } from "./command-secret-targets-FYfRsgRi.js";
...
import { o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-BNt5w-Vy.js";
import { S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, d as listSpeechVoices, f as listTtsPersonas, g as resolveTtsConfig, k as textToSpeech, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, w as setTtsPersona } from "./tts-runtime-DGW70YBV.js";
import "./tts-CYR90HER.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-C7MX3ET3.js";
import { a as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-CtFv4IyR.js";
import { t as resolveMemorySearchConfig } from "./memory-search-08jhHZZR.js";
import { n as listEmbeddingProviders } from "./embedding-provider-runtime-2O0gEBoe.js";
import { i as resolveWebFetchDefinition, n as isWebFetchProviderConfigured, r as listWebFetchProviders } from "./runtime-BodTg4_d.js";
...
import { c as transcribeAudioFile, i as describeVideoFile, o as prepareImageDescriptionInput, r as describePreparedImageWithModel, t as describeImageFile } from "./runtime-DWx1rdlP.js";
import { t as createEmbeddingProvider } from "./memory-core-bundled-runtime-C9kxoHzH.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-CYdlJnXY.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-Drq9c0PM.js");
...
async function runVideoGenerate(params) {
	...
	const outputs = await Promise.all(result.videos.map(async (video, index) => {
		...
		if (!videoBuffer && video.url) {
			...
			if (!response.ok) await assertOkOrThrowHttpError(response, `${result.provider} generated video download failed`);
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-BWOx8z9c.js");
	...
	image.command("generate").description("Generate images").requiredOption("--prompt <text>", "Prompt text").option("--model <provider/model>", "Model override").option("--count <n>", "Number of images").option("--size <size>", "Size hint like 1024x1024").option("--aspect-ratio <ratio>", "Aspect ratio hint like 16:9").option("--resolution <value>", "Resolution hint: 1K, 2K, or 4K").option("--output-format <format>", "Output format hint: png, jpeg, or webp").option("--background <value>", "Background hint: transparent, opaque, or auto").option("--openai-background <value>", "OpenAI background hint: transparent, opaque, or auto").option("--openai-moderation <value>", "OpenAI moderation hint: low or auto").option("--quality <value>", "Quality hint: low, medium, high, or auto").option("--timeout-ms <ms>", "Provider request timeout in milliseconds").option("--output <path>", "Output path").option("--json", "Output JSON", false).action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
	...
	image.command("edit").description("Edit images with one or more input files").requiredOption("--file <path>", "Input file", collectOption, []).requiredOption("--prompt <text>", "Prompt text").option("--model <provider/model>", "Model override").option("--count <n>", "Number of images").option("--size <size>", "Size hint like 1024x1024").option("--aspect-ratio <ratio>", "Aspect ratio hint like 16:9").option("--resolution <value>", "Resolution hint: 1K, 2K, or 4K").option("--output-format <format>", "Output format hint: png, jpeg, or webp").option("--background <value>", "Background hint: transparent, opaque, or auto").option("--openai-background <value>", "OpenAI background hint: transparent, opaque, or auto").option("--openai-moderation <value>", "OpenAI moderation hint: low or auto").option("--quality <value>", "Quality hint: low, medium, high, or auto").option("--timeout-ms <ms>", "Provider request timeout in milliseconds").option("--output <path>", "Output path").option("--json", "Output JSON", false).action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
