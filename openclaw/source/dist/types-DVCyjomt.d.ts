...
import { G as TtsAutoMode } from "./types.slack-Bjt70WfQ.js";
...
import { t as Skill } from "./skill-contract-Dp8GlMhd.js";
...
type SessionEntry = {
  ...
  pinnedAt?: number; /** Timestamp (ms) when an operator client last marked the session read. */
  lastReadAt?: number; /** Timestamp (ms) when an operator explicitly marked the session unread; cleared on read. */
...
//#endregion
export { SessionChatType as a, SessionScope as c, RestartRecoveryRun as i, SessionSystemPromptReport as l, CliSessionBinding as n, SessionContextBudgetStatus as o, GroupKeyResolution as r, SessionEntry as s, AmbientTranscriptWatermark as t };