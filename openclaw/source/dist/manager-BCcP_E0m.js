...
import { c as parseAgentSessionKey, n as isAcpSessionKey } from "./session-key-utils-A-JGvyXu.js";
...
import { a as toAcpRuntimeError, n as AcpRuntimeError, o as withAcpRuntimeErrorBoundary, r as formatAcpErrorChain, t as ACP_ERROR_CODES } from "./errors-B427VheH.js";
...
import { a as buildRuntimeConfigOptionPairs, c as mergeRuntimeOptions, d as resolveRuntimeConfigOptionKey, f as resolveRuntimeOptionsFromMeta, g as validateRuntimeModeInput, i as resolveTurnTimeoutMs, l as normalizeRuntimeOptions, m as validateRuntimeConfigOptionInput, n as awaitTurnWithTimeout, o as buildRuntimeControlSignature, p as runtimeOptionsEqual, r as cleanupTimedOutTurn, s as inferRuntimeOptionPatchFromConfigOption, v as validateRuntimeOptionPatch } from "./manager.turn-timeout-BbStwjvS.js";
import { a as failTaskRunByRunId, d as startTaskRunByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-B93mVzDV.js";
import { n as resolveRequiredCompletionTerminalResult } from "./task-completion-contract-BaGoOhG8.js";
import { r as requireAcpRuntimeBackend, t as getAcpRuntimeBackend } from "./registry-yyGOxKx7.js";
import { n as readAcpSessionEntry, o as upsertAcpSessionMeta, t as listAcpSessionEntries } from "./session-meta-e1OOAdtW.js";
...
async function consumeAcpTurnEvents(params) {
	...
	for await (const event of params.events) {
		...
		if (event.type === "done") terminalStatus = event.status ?? (isCancellationStopReason(event.stopReason) ? "cancelled" : "completed");
