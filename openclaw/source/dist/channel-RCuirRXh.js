...
import { h as MarkdownConfigSchema, l as GroupPolicySchema, o as DmPolicySchema } from "./zod-schema.core-DviqqtPj.js";
import { n as buildCatchallMultiAccountChannelSchema, r as buildChannelConfigSchema, t as AllowFromListSchema } from "./config-schema-Bh8lZGlx.js";
import { y as readStringParam } from "./common-DWyiui3y.js";
import { t as jsonResult } from "./tool-results-BCM3fdVS.js";
import { b as sendPayloadWithChunkedTextAndMedia } from "./reply-payload-C3J477-H.js";
import { l as createScopedDmSecurityResolver, m as mapAllowFromEntries, s as createScopedChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-BH5RG2Ab.js";
...
import { d as stripTargetKindPrefix, i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-DXd2kIwS.js";
...
import { C as createOpenProviderGroupPolicyWarningCollector, o as buildOpenGroupPolicyRestrictSendersWarning, s as buildOpenGroupPolicyWarning } from "./channel-policy-HQ-6pbOn.js";
...
import { d as createDefaultChannelRuntimeState, o as buildTokenChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-Dy-C1WAt.js";
import "./channel-status-D0V3ybJh.js";
import { a as coerceStatusIssueAccountId, d as readStatusIssueFields } from "./extension-shared-DVPaxoou.js";
...
import { i as resolveZaloAccount, n as listZaloAccountIds, r as resolveDefaultZaloAccountId, t as listEnabledZaloAccounts } from "./accounts-C-ZPmqpb.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-SeJuqajq.js";
import { r as zaloSetupAdapter, t as createZaloSetupWizardProxy } from "./setup-core-CWTF5y3N.js";
//#region extensions/zalo/src/actions.ts
const loadZaloActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-DcdeGvvk.js"), "zaloActionsRuntime");
...
const loadZaloChannelRuntime = createLazyRuntimeModule(() => import("./channel.runtime-x5SHbwdY.js"));
const zaloSetupWizard = createZaloSetupWizardProxy(async () => (await import("./setup-surface-Bd14uX1P.js")).zaloSetupWizard);
