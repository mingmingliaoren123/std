...
import { i as installRequestBodyLimitGuard } from "./http-body-CHWaxK2e.js";
import { n as normalizeAccountId } from "./account-id-C7N4Rwku.js";
import { u as normalizeAgentId$1 } from "./session-key-VWT_xzM9.js";
...
import { s as formatChannelProgressDraftLineForEntry, u as isChannelProgressDraftWorkToolName } from "./streaming-CfpqgwBH.js";
import { g as sendMediaWithLeadingCaption, h as resolveTextChunksWithFallback, m as resolveSendableOutboundReplyParts } from "./reply-payload-C3J477-H.js";
...
import { D as toInboundMediaFacts, T as formatInboundMediaUnavailableText, y as buildChannelInboundEventContext } from "./kernel-BMsNZe7F.js";
...
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute, t as ensureConfiguredBindingRouteReady } from "./binding-routing-CR51Xysx.js";
...
import { n as createChannelPairingController } from "./channel-pairing-3Uf4WD4J.js";
import { c as readWebhookBodyOrReject, r as applyBasicWebhookRequestGuards } from "./webhook-request-guards-6tg5xzrX.js";
import "./webhook-ingress-D6RzsqkF.js";
import { _ as requestFeishuApi, d as extractReplyText, g as readString, h as parseCommentContentElements, l as resolveFeishuRuntimeAccount, m as normalizeString, p as isRecord$1, s as resolveFeishuAccount, u as encodeQuery, v as buildFeishuCommentTarget, y as normalizeCommentFileType } from "./accounts-4bVnpxTp.js";
import { i as resolveReceiveIdType } from "./targets-Ese_DJz7.js";
import { d as decodeFeishuCardAction, l as buildFeishuCardActionTextFallback, o as resolveFeishuCardTemplate, u as createFeishuCardInteractionEnvelope } from "./send-result-BkekdClJ.js";
import { o as resolveConfiguredFeishuGroupSessionScope, t as buildFeishuConversationId } from "./conversation-id-B-P3uZgY.js";
import { a as resolveFeishuGroupConversationIngressAccess, c as resolveFeishuReplyPolicy, i as resolveFeishuGroupConfig, n as normalizeFeishuAllowEntry, o as resolveFeishuGroupSenderActivationIngressAccess, r as resolveFeishuDmIngressAccess, t as hasExplicitFeishuGroupConfig } from "./policy-hydoYQvK.js";
import { t as getFeishuRuntime } from "./runtime-BP4XWQ9i.js";
import { a as getFeishuUserAgent, i as createFeishuWSClient, n as createEventDispatcher, r as createFeishuClient, u as resolveConfiguredHttpTimeoutMs } from "./client-BJWzRoZp.js";
import { i as createCommentTypingReactionLifecycle, s as getChatInfo, t as deliverCommentThreadText } from "./drive-D8pKbbrP.js";
import { t as createFeishuThreadBindingManager } from "./thread-bindings-DzdzLY28.js";
import "./runtime-api-ZDRkopXH.js";
import { t as readFeishuJsonResponse } from "./json-response-Z7VS8YEe.js";
import { _ as resolveFeishuIdentityEmoji, c as parsePostContent, d as isMentionForwardRequest, f as isFeishuGroupChatType, g as normalizeFeishuExternalKey, h as shouldSuppressFeishuTextForVoiceMedia, i as sendCardFeishu, l as extractMentionTargets, m as sendMediaFeishu, n as getMessageFeishu, o as sendMessageFeishu, p as saveMessageResourceFeishu, r as listFeishuThreadMessages, s as sendStructuredCardFeishu, u as isFeishuBroadcastMention } from "./send-BXhfbuso.js";
import { i as waitForAbortableDelay, r as raceWithTimeoutAndAbort } from "./probe-DfgHQjhn.js";
import { a as clearFeishuBotIdentityState, c as httpServers, d as wsClients, f as fetchBotIdentityForMonitor, i as botOpenIds, l as recordWebhookStatus, n as FEISHU_WEBHOOK_MAX_BODY_BYTES, o as closeTrackedFeishuHttpServer, r as botNames, s as feishuWebhookRateLimiter, t as FEISHU_WEBHOOK_BODY_TIMEOUT_MS, u as setFeishuBotIdentityState } from "./monitor.state-C0Go_2zC.js";
...
async function resolveDriveCommentEventCore(params) {
	...
	const context = await fetchDriveCommentContext({
		client: createClient ? createClient(account ?? { accountId }) : createFeishuClient((await import("./accounts-vj6ga_cx.js")).resolveFeishuAccount({
			cfg,
			accountId
		})),
		fileToken,
...
async function resolveReactionSyntheticEvent(params) {
	...
	const { resolveFeishuAccount } = await import("./accounts-vj6ga_cx.js");
