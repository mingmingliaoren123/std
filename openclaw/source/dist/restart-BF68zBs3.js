...
import { o as resolveTaskScriptPath } from "./schtasks-CgPnYTMr.js";
...
function resetGatewayRestartStateForInProcessRestart() {
	...
	import("./server-reload-handlers-peAeJAWO.js").then((mod) => {
...
async function emitPreparedGatewayRestart(hooks, reasonOverride, intent) {
	...
	if (!emitGatewayRestart(preferredReason ?? reasonOverride, preferredReason && intent ? {
		...intent,
		reason: preferredReason
	} : intent)) await preparedHooks?.afterEmitRejected?.().catch(() => void 0);
}
/**
