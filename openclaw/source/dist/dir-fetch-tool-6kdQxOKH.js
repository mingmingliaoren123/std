...
import { l as FILE_TRANSFER_SUBDIR, n as DIR_FETCH_HARD_MAX_BYTES, r as DIR_FETCH_TOOL_DESCRIPTOR, t as DIR_FETCH_DEFAULT_MAX_BYTES } from "./descriptors-CjaEmvvn.js";
import { t as consumeChildOutput } from "./child-output-CNOvMJ6_.js";
import { i as mimeFromExtension, t as IMAGE_MIME_INLINE_SET } from "./mime-BLZ4Zzpp.js";
import { t as appendFileTransferAudit } from "./audit-BEV1UgLN.js";
import { a as readClampedInt, i as readBoolean, n as readRequiredNodePath, r as humanSize, t as invokeNodeToolPayload } from "./node-tool-invoke-BAj_4PWB.js";
	...
	return new Promise((resolve) => {
		...
		consumeChildOutput(child.stdout, {
			...
			onError: (error) => {
				...
				finish({
					ok: false,
					reason: `${input.label} stdout error: ${String(error)}`
				});
			}
		});
