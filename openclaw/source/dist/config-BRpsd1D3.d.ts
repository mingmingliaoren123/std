import { i as OpenClawConfig, n as ConfigValidationIssue, t as ConfigFileSnapshot } from "./types.openclaw-CXjMEWAQ.js";
import { n as PluginMetadataSnapshot } from "./plugin-metadata-snapshot.types-D_Y2Gl1D.js";
import { n as ConfigWriteFollowUp, t as ConfigWriteAfterWrite } from "./runtime-snapshot-C_LhX1Wy.js";
import { _ as readConfigFileSnapshotForWrite, a as ConfigWriteOptions, o as ConfigWriteResult } from "./io-DqqR6bBK.js";
...
//#endregion
export { transformConfigFileWithRetry as A, ConfigTransformResult as C, mutateConfigFileWithRetry as D, mutateConfigFile as E, replaceConfigFile as O, ConfigReplaceResult as S, TransformConfigFileWithRetryParams as T, ConfigMutationCommitParams as _, applyConfigOverrides as a, ConfigMutationIO as b, setConfigOverride as c, isPluginPackagingRuntimeOutputInvalidConfigSnapshot as d, shouldAttemptLastKnownGoodRecovery as f, ConfigMutationCommit as g, ConfigMutationBase as h, validateConfigObjectWithPlugins as i, ConfigMutationConflictError as j, transformConfigFile as k, unsetConfigOverride as l, assertConfigWriteAllowedInCurrentMode as m, validateConfigObjectRaw as n, getConfigOverrides as o, NixModeConfigMutationError as p, validateConfigObjectRawWithPlugins as r, resetConfigOverrides as s, validateConfigObject as t, isPluginLocalInvalidConfigSnapshot as u, ConfigMutationCommitResult as v, TransformConfigFileParams as w, ConfigMutationResult as x, ConfigMutationContext as y };