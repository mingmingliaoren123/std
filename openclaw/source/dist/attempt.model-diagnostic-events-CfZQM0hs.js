...
import { d as redactToolPayloadTextWithConfig, o as redactSensitiveFieldValueWithConfig, r as isSensitiveFieldKey } from "./redact-B9QQ4Wyz.js";
...
import { i as formatErrorMessage, t as collectErrorGraphCandidates } from "./errors-sMD712F3.js";
...
import { T as freezeDiagnosticTraceContext, o as emitTrustedDiagnosticEvent, s as emitTrustedDiagnosticEventWithPrivateData, t as areDiagnosticsEnabledForProcess, w as formatDiagnosticTraceparent, x as createChildDiagnosticTraceContext } from "./diagnostic-events-JZsXee1S.js";
import { t as createSubsystemLogger } from "./subsystem-C3fiUGN1.js";
import "./boundary-file-read-CBe_wA_B.js";
import { a as readRootJsonObjectSync } from "./json-CI_xQ2Rw.js";
import "./json-files-Ce1pXdh3.js";
import { i as normalizeProviderId } from "./provider-id-Dq06Bcx6.js";
import { i as resolveEffectivePluginActivationState, r as normalizePluginsConfigWithResolver } from "./manifest-registry--UiRn6nq.js";
...
import { i as loadPluginMetadataSnapshot, n as isPluginMetadataSnapshotCompatible, s as emitDiagnosticsTimelineEvent } from "./plugin-metadata-snapshot-rpSrEgGf.js";
...
import { j as getCompactionProvider } from "./registry-B8eQDFB4.js";
import { l as fireAndForgetBoundedHook, t as getGlobalHookRunner } from "./hook-runner-global-BmIrGlLG.js";
...
import { at as redactTranscriptMessage, it as isTranscriptOnlyOpenClawAssistantModel, rt as isTranscriptOnlyOpenClawAssistantMessage$1 } from "./session-accessor-D7yi6P1i.js";
import { B as sanitizeProviderReplayHistoryWithPlugin, G as validateProviderReplayTurnsWithPlugin, w as resolveProviderCacheTtlEligibility } from "./provider-runtime-CLQOjLJ6.js";
...
import { a as sanitizeToolCallIdsForCloudCodeAssist, n as extractToolResultId, t as extractToolCallsFromAssistant } from "./tool-call-id-CtDzcfGi.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing, n as repairToolUseResultPairing, r as sanitizeToolCallInputs, t as makeMissingToolResult } from "./session-transcript-repair-BUFGXxrq.js";
import { i as streamSimple } from "./stream-BcRkg2P0.js";
import { at as SettingsManager, s as DefaultResourceLoader } from "./sessions-D8qGY7uC.js";
import { i as takeRuntimeUserTurnTranscriptRecorder, n as attachRuntimeUserTurnTranscriptRecorder, r as takeRuntimeUserTurnTranscriptContext } from "./user-turn-transcript-runtime-context-SnEnlher.js";
...
import { n as SUMMARIZATION_OVERHEAD_TOKENS } from "./compaction-planning-BUmAeNf7.js";
...
import { o as markDiagnosticRunProgress } from "./diagnostic-run-activity-Jf95dtVL.js";
import { i as isSilentReplyPayloadText, o as isSilentReplyText } from "./tokens-DKI4eGAu.js";
import { S as stripInternalMetadataForDisplay } from "./session-utils.fs-CR-Ydxz0.js";
import { a as makeZeroUsageSnapshot, n as derivePromptTokens, o as normalizeUsage } from "./usage-BJjt0RVM.js";
...
import { i as hasInterSessionUserProvenance, n as annotateInterSessionPromptText, r as applyInputProvenanceToUserMessage, s as normalizeInputProvenance } from "./input-provenance-BkJA7lbx.js";
import { t as estimateStringChars } from "./cjk-chars-0PtNN_-l.js";
import { y as loadEmbeddedAgentMcpConfig } from "./agent-bundle-mcp-runtime--G82BMQs.js";
...
import { a as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-yrw7ASmg.js";
import { t as cloneDiagnosticContentValue } from "./diagnostic-llm-content-CU_-DTjY.js";
import { r as finalizeToolTerminalPresentation, w as peekAdjustedParamsForToolCall } from "./agent-tools.before-tool-call-C95DXQXZ.js";
import { g as isReasoningOnlyLengthAssistantTurn } from "./openai-transport-stream-B0WkSqXp.js";
import { t as log$3 } from "./logger-rC_P-huq.js";
import { c as isAnthropicModelRef, s as isAnthropicFamilyCacheTtlEligible } from "./proxy-ndumgUwZ.js";
import { a as resolveEffectiveCompactionMode, r as applyAgentCompactionSettingsFromConfig } from "./agent-settings-axYuScuh.js";
...
import { m as normalizeAcceptedSessionSpawnResult } from "./delivery-evidence-Du4oIHR6.js";
import { i as mergePreparedUserTurnMessageForRuntime, s as restorePreparedUserTurnOperationalMetaForRuntime } from "./user-turn-transcript-K2ELDNX3.js";
import { c as sanitizeSessionMessagesImages, d as normalizeOpenAIResponsesToolCallIds, l as downgradeOpenAIFunctionCallReasoningPairs, n as validateAnthropicTurns, r as validateGeminiTurns, u as downgradeOpenAIReasoningBlocks, x as sanitizeGoogleTurnOrdering } from "./embedded-agent-helpers-DZZ4Y-Tw.js";
import { r as createBoundaryAwareStreamFnForModel } from "./provider-stream-CqSx37Uy.js";
import { a as createAnthropicVertexStreamFnForModel } from "./simple-completion-runtime-DNwDdfY4.js";
...
import { t as buildConfiguredAgentSystemPrompt } from "./system-prompt-config-DmMYFhnb.js";
import { d as truncateToolResultMessage, f as formatContextLimitTruncationNotice, o as resolveLiveToolResultMaxChars, t as DEFAULT_MAX_LIVE_TOOL_RESULT_CHARS } from "./tool-result-truncation-rzMcqvvu.js";
import { a as setRawSessionAppendMessage, c as readTranscriptFileState, i as getRawSessionAppendMessage, l as writeTranscriptFileAtomic, o as TranscriptFileState } from "./transcript-rewrite-BHL7q_3D.js";
import { r as recordPersistedRuntimeToolSchemaQuarantine, t as clearRecoveredPersistedRuntimeToolSchemaQuarantines } from "./tool-schema-quarantine-health-CTj5Br4S.js";
import { a as computeAdaptiveChunkRatioWithWorker, c as shouldAllowProviderOwnedThinkingReplay, i as buildHistoryPrunePlanWithWorker, n as resolveContextWindowTokens$1, o as providerRequiresSignedThinking, r as summarizeInStages, s as resolveTranscriptPolicy, t as createAgentToolResultMiddlewareRunner } from "./tool-result-middleware-D2HOtSKh.js";
import { o as isGooglePromptCacheEligible } from "./extra-params-cce1g0up.js";
import { n as resolveCronStyleNow } from "./current-time-B0TYU-XW.js";
import { n as isQueryStopWordToken, t as extractKeywords } from "./query-expansion-BbUuwiEK.js";
import "./query-PBh0_qYR.js";
...
function limitHistoryTurns(messages, limit) {
	...
	for (let i = tail.length - 1; i >= 0; i--) if (tail[i].role === "user") {
		userCount++;
...
function resolveEmbeddedAgentStreamFn(params) {
	...
	if (isDefaultOpenClawStreamFnForModel(params.model, params.currentStreamFn) || hasResolvedRuntimeApiKey(params.resolvedApiKey) || params.model.api === "anthropic-messages" && params.model.provider !== "anthropic") {
...
function boundedTimelineAttribute(value) {
	...
	return normalized ? normalized.slice(0, TIMELINE_ATTRIBUTE_MAX_LENGTH) : void 0;
}
...
//#endregion
export { consumeCompactionSafeguardCancelReason as A, stripStaleAssistantUsageBeforeLatestCompaction as B, buildEmbeddedMessageActionDiscoveryInput as C, hasMeaningfulConversationContent as D, buildEmbeddedExtensionFactories as E, dedupeDuplicateUserMessagesForCompaction as F, wrapAnthropicStreamWithRecovery as G, dropReasoningFromHistory as H, isCacheTtlEligibleProvider as I, createPreparedEmbeddedAgentSettingsManager as J, isZeroUsageEmptyStopAssistantTurn as K, readLastCacheTtlTimestamp as L, rotateTranscriptAfterCompaction as M, rotateTranscriptFileAfterCompaction as N, isRealConversationMessage as O, shouldRotateCompactionTranscript as P, logRuntimeToolSchemaQuarantine as R, validateReplayTurns as S, limitHistoryTurns as T, dropThinkingBlocks as U, assessLastAssistantMessage as V, stripThinkingBlocksFromMessage as W, prewarmSessionFile as _, normalizeContextTokenBudget as a, normalizeAssistantReplayContent as b, collectCoreBuiltinToolNames as c, applySystemPromptToSession as d, buildEmbeddedSystemPrompt as f, resolveEmbeddedAgentStreamFn as g, resolveEmbeddedAgentBaseStreamFn as h, mapThinkingLevelForProvider as i, setCompactionSafeguardCancelReason as j, readPostCompactionContext as k, collectRegisteredToolNames as l, resolveEmbeddedAgentApiKey as m, flushPendingToolResultsAfterIdle as n, AGENT_RESERVED_TOOL_NAMES as o, describeEmbeddedAgentStreamStrategy as p, consumeEmbeddedToolSendReceipt as q, mapThinkingLevel as r, collectAllowedToolNames as s, wrapStreamFnWithDiagnosticModelCallEvents as t, toSessionToolAllowlist as u, trackSessionManagerAccess as v, getHistoryLimitFromSessionKey as w, sanitizeSessionHistory as x, createEmbeddedAgentResourceLoader as y, guardSessionManager as z };
