...
import { i as getRuntimeConfig, r as createConfigIO } from "./io-By0s-a_s.js";
...
import { f as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-FYfRsgRi.js";
import { t as formatHelpExamples } from "./help-format-CAcwboTs.js";
import { t as runSecurityAudit } from "./audit-UjVvFwCi.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-RaLo4obq.js");
