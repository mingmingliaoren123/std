...
import { i as isMalformedApiKeyInput } from "./credential-state-BY-oz-QV.js";
...
import { r as resolveManifestProviderAuthChoice, t as resolveManifestDeprecatedProviderAuthChoice } from "./provider-auth-choices-By3LDBD0.js";
import { a as normalizeSecretInputModeInput } from "./provider-auth-input-D7tUZxiJ.js";
import { r as resolveProviderInstallCatalogEntry, t as resolveDeprecatedProviderInstallCatalogEntry } from "./provider-install-catalog-jUfsomek.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-BSbSMamL.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-Gpvh3Vt6.js";
import { t as normalizeApiKeyTokenProviderAuthChoice } from "./auth-choice.apply.api-providers-CkgxaCFj.js";
import { n as ensureCodexRuntimePluginForModelSelection, t as CODEX_RUNTIME_PLUGIN_ID } from "./codex-runtime-plugin-install-DaNk2-0i.js";
import { c as parseNonInteractiveCustomApiFlags, d as resolveCustomProviderId, n as applyCustomApiConfig, t as CustomApiError } from "./onboard-custom-config-CRNtYrH8.js";
...
async function applyNonInteractivePluginProviderChoice(params) {
	...
	if (codexInstall.installed) {
		const { offerPostInstallMigrations } = await import("./setup.post-install-migration-CSgOmN6W.js");
