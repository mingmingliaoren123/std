...
import { f as readProviderJsonArrayFieldResponse, m as readProviderJsonResponse } from "./provider-http-errors-HGLTiqMh.js";
...
import { o as saveResponseMedia } from "./fetch-DJgQj1Kz.js";
...
import { T as formatInboundMediaUnavailableText, _ as resolveChannelTurnDispatchCounts, h as hasFinalChannelTurnDispatch, y as buildChannelInboundEventContext } from "./kernel-BMsNZe7F.js";
...
import { o as dispatchReplyFromConfigWithSettledDispatcher } from "./inbound-reply-dispatch-C8SZBmZG.js";
import "./channel-outbound-DkdAAOhG.js";
import { n as logInboundDrop, r as logTypingFailure } from "./logging-gUWPKC5g.js";
import { t as createPersistentDedupeCache } from "./dedupe-runtime-Cpo1VwnM.js";
import "./ssrf-runtime-DBG77fRY.js";
import { a as resolveInboundSessionEnvelopeContext } from "./channel-inbound-CxUVIreR.js";
import { i as resolveStableChannelMessageIngress, t as channelIngressRoutes } from "./message-access-DucCKzfO.js";
...
import "./runtime-api-yPAjkwjO.js";
import { A as GRAPH_ROOT, B as normalizeContentType, D as resolveMSTeamsSdkCloudOptions, E as tryNormalizeBotFrameworkServiceUrl, F as extractInlineImageCandidates, G as safeFetchWithPolicy, H as resolveAttachmentFetchPolicy, I as inferPlaceholder, K as safeHostForUrl, L as isDownloadableAttachment, M as applyAuthorizationHeaderForUrl, N as encodeGraphShareId, P as extractHtmlFromAttachment, R as isLikelyImageAttachment, S as ensureUserAgentHeader, U as resolveMediaSsrfPolicy, V as readNestedString, W as resolveRequestUrl, a as fetchGraphJson, b as loadMSTeamsSdkWithAuth, h as resolveMSTeamsCredentials, j as IMG_SRC_RE, k as ATTACHMENT_TAG_RE, q as tryBuildGraphSharesUrlForSharedLink, v as createMSTeamsExpressAdapter, y as createMSTeamsTokenProvider, z as isUrlAllowed } from "./graph-users-Caq3xHbh.js";
import { c as resolveMSTeamsUserAllowlist, s as resolveMSTeamsChannelAllowlist } from "./resolve-allowlist-CSefiXIR.js";
import { i as resolveMSTeamsRouteConfig, r as resolveMSTeamsReplyPolicy, t as resolveMSTeamsAllowlistMatch } from "./policy-BHrcbPLi.js";
import { a as parseMSTeamsActivityTimestamp, c as wasMSTeamsBotMentioned, i as normalizeMSTeamsConversationId, n as extractMSTeamsConversationMessageId, o as stripMSTeamsMentionTags, r as extractMSTeamsQuoteInfo, s as translateMSTeamsDmConversationIdForGraph, t as resolveMSTeamsRouteSessionKey } from "./thread-session-BzDD6SmN.js";
import { n as formatMSTeamsSendErrorHint, r as formatUnknownError, t as classifyMSTeamsSendError } from "./errors-BUijkII6.js";
import { l as createMSTeamsPollStoreState, u as extractMSTeamsPollVote, v as createMSTeamsConversationStoreState } from "./polls-DYht7mPK.js";
import { i as createMSTeamsSsoTokenStoreFs } from "./sso-token-store-DdhBMJrV.js";
import { _ as buildFileInfoCard, c as renderReplyPayloadsToMessages, d as withRevokedProxyFallback, f as resolveGraphChatId, g as removePendingUploadFs, h as getPendingUploadFs, l as sendMSTeamsMessages, m as removePendingUpload, p as getPendingUpload, s as buildConversationReference, u as sendMSTeamsActivityWithReference, v as parseFileConsentInvoke, y as uploadToConsentUrl } from "./probe-eHJ7QJXT.js";
...
function countDistinctInlineCandidates(attachments, limits) {
	const seenUrls = /* @__PURE__ */ new Set();
	let dataCount = 0;
	for (const candidate of extractInlineImageCandidates(attachments, limits)) if (candidate.kind === "data") dataCount += 1;
...
function resolveMSTeamsInboundAttachmentPresentation(attachments, limits) {
	...
	const totalImages = fileAttachments.filter(isLikelyImageAttachment).length + inlinePlaceholderCount;
